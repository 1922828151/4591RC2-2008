/*
 * func-name: ?get_synch_request_item@Request_Ack@Message@Outpop@@QAE?AV?$Smart_Ptr@USSynchRequestAckItem@Request_Ack@Message@Outpop@@@Utility@3@I@Z
 * func-address: 0x10026e00
 * callers: 0x10024520, 0x10024cc0
 * callees: 0x10015df0, 0x10027830
 */

Outpop::Utility::Ref_Object **__thiscall Outpop::Message::Request_Ack::get_synch_request_item(
        _DWORD *this,
        ...
        int a3)
{
  ...
  v4 = (Outpop::Utility::Lock *)(this + 28);
  Outpop::Utility::Lock::lock((Outpop::Utility::Lock *)(this + 28));
  v13 = 1;
  v5 = (int)(this + 12);
  sub_10015DF0(this + 12, &v11, &a3);
  v6 = this[14];
  v7 = (Outpop::Utility::Ref_Object *)(this + 13);
  v8 = v11;
  if ( !v11 || v11 != v7 )
