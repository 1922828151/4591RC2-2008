 ...
 * callers: 0x10009da0, 0x10012b60, 0x1001dc30
 * callees: 0x10009af0, 0x1000a460, 0x1000a780, 0x1000b300, 0x1001e320, 0x100294f2, 0x10029d92
 */

_DWORD *__fastcall sub_1000A1E0(unsigned int a1, int a2, int *a3, int a4, _DWORD *a5)
{
  _DWORD *result; // eax
  unsigned int v8; // ecx
  int v9; // edx
  ...
  _DWORD *v20; // edi
  int v21; // ebx
  int v22[4]; // [esp+0h] [ebp-34h] BYREF
  ...
  if ( a1 )
  {
    ...
    if ( v8 >= a1 + v10 )
    {
      ...
      {
        v21 = v18 - v19;
        *(_DWORD *)(a2 + 8) = sub_1001E320(v18 - v19, v18);
        sub_1000A780(v21, v25);
      ...
      else
      {
        sub_1001E320(a5, v18);
        v28 = 2;
        sub_1000B300(*(_DWORD *)(a2 + 8), a1 - ((*(_DWORD *)(a2 + 8) - (int)a5) >> 3));
        v28 = -1;
        *(_DWORD *)(a2 + 8) += v30;
    ...
    else
    {
      ...
      v26 = (void *)sub_1000A460();
      v28 = 0;
      v14 = sub_1001E320(*(_DWORD *)(a2 + 4), a5);
      LOBYTE(v25) = 0;
      sub_1000B300(v14, a1);
      sub_1001E320(a5, *(_DWORD *)(a2 + 8));
      v28 = -1;
      v15 = *(_DWORD *)(a2 + 4);
      if ( v15 )
