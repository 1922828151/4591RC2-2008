/*
 * func-name: sub_1001D450
 * func-address: 0x1001d450
 * callers: 0x10010a20, 0x100150f0, 0x1001bc20, 0x10027970
 * callees: 0x100294f2
 */

_DWORD *__userpurge sub_1001D450@<eax>(_DWORD *a1@<edi>, _DWORD *a2, int a3, _DWORD *a4)
{
  ldiv_t v4; // rax
  unsigned int v5; // eax
  unsigned int i; // ebx
