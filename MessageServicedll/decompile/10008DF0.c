/*
 * func-name: sub_10008DF0
 * func-address: 0x10008df0
 * callers: 0x100040b0, 0x10007440
 * callees: 0x10009b90, 0x10009bf0, 0x10009da0, 0x1000a1c0, 0x1000a600, 0x100294f2, 0x10029d92
 */

unsigned int __stdcall sub_10008DF0(int a1, int a2)
{
  int v2; // esi
  int v3; // edx
  int v4; // ebx
  ...
  *(_DWORD *)(a1 + 12) = 0;
  ...
  v19[8] = a2 + 4;
  v19[6] = a1 + 4;
  sub_1000A600(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v22, a2 + 4, v10);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v25 = -1;
  v20 = **(_DWORD ***)(a1 + 8);
  v22 = **(_DWORD ***)(a2 + 8);
