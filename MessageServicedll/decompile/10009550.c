/*
 * func-name: sub_10009550
 * func-address: 0x10009550
 * callers: 0x100076b0
 * callees: 0x10009b90, 0x10009da0, 0x1000a000, 0x1000a1c0, 0x1000a700, 0x10029d92
 */

unsigned int __stdcall sub_10009550(int a1, int a2)
{
  int v2; // esi
  int v3; // edx
  int v4; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  ...
  v16[8] = a2 + 4;
  v16[6] = a1 + 4;
  sub_1000A700(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v19, a2 + 4, v7);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v22 = -1;
  v17 = **(_DWORD ***)(a1 + 8);
  v19 = **(_DWORD ***)(a2 + 8);
