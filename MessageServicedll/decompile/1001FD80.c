/*
 * func-name: sub_1001FD80
 * func-address: 0x1001fd80
 * callers: 0x1000cee0, 0x1000cf80, 0x1000d000, 0x1000d080, 0x1000d140, 0x1000d1a0, 0x1001eff0
 * callees: 0x10009da0, 0x1000b8c0, 0x1000b980
 */

int __stdcall sub_1001FD80(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v51 = sub_1000B8C0(a3, (int)v48, v48[1]);
  sub_1000B980(1u, (int)(v3 + 1));
  v48[1] = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
    invalid_parameter_noinfo();
