/*
 * func-name: sub_1001CC60
 * func-address: 0x1001cc60
 * callers: 0x1001bb10, 0x1001d9c0
 * callees: 0x100294f2
 */

_DWORD *__userpurge sub_1001CC60@<eax>(_DWORD *a1@<edi>, _DWORD *a2, int a3, _DWORD *a4)
{
  ldiv_t v4; // rax
  unsigned int v5; // eax
  unsigned int i; // ebx
