/*
 * func-name: ?cache_start_acceptor@Message_Facade@Message@Outpop@@SAXHIGABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@W4ETransmitType@Utility@3@I_N2HIIIHHHHHH22HHH@Z
 * func-address: 0x1000d4f0
 * callers: none
 * callees: 0x1000fa50, 0x100294e2
 */

void __cdecl Outpop::Message::Message_Facade::cache_start_acceptor(
        int a1,
        int a2,
        __int16 a3,
        int a4,
