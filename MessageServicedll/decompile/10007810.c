/*
 * func-name: sub_10007810
 * func-address: 0x10007810
 * callers: 0x10001610, 0x10006d40, 0x100175f0
 * callees: 0x10002c00, 0x1000ba80, 0x10022810
 */

int __stdcall sub_10007810(_DWORD *a1, int a2, _DWORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v51 = sub_10002C00((int)v48, v48[1], a3);
  sub_1000BA80(1, v3 + 1);
  v48[1] = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
