 ...
 * callers: 0x1000a600
 * callees: 0x10003070, 0x1000b3e0, 0x1000b5b0, 0x1000b610
 */

int __stdcall sub_1000AC30(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  int result; // eax
