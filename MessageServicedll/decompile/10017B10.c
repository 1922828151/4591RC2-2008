 ...
 * callers: 0x100175b0, 0x10017670, 0x100178c0, 0x10028370
 * callees: 0x10002c00, 0x10009da0, 0x1000ba80
 */

int __stdcall sub_10017B10(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  int *v59; // [esp+1Ch] [ebp-24h]
  int *v60; // [esp+20h] [ebp-20h]
  int *v61; // [esp+24h] [ebp-1Ch]
...
LABEL_49:
  ...
  v62 = v42;
  v58 = sub_10002C00((int)v42, v42[1], a3);
  sub_1000BA80(1u, (int)(v3 + 1));
  v42[1] = v58;
  *(_DWORD *)v58[1] = v58;
  if ( !v41 )
    invalid_parameter_noinfo();
