/*
 * func-name: sub_10007E30
 * func-address: 0x10007e30
 * callers: 0x10006e10
 * callees: 0x100030a0, 0x10009da0, 0x1000bbb0
 */

int __stdcall sub_10007E30(_DWORD *a1, int a2, _WORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  _DWORD *v58; // [esp+18h] [ebp-20h]
  int *v59; // [esp+1Ch] [ebp-1Ch]
  _DWORD *v60; // [esp+20h] [ebp-18h]
  ...
  if ( v4 <= a1[3] >> 2 )
  {
    ...
    else
    {
      ...
      v8 = 2 * v7 - 3;
      a1[8] = v8;
      sub_10009DA0(v8 + 2, (_BYTE)a1 + 4, a1[2]);
    }
    v10 = a1[5];
    v11 = a1[9] - (a1[8] >> 1) - 1;
    v56 = v11;
...
LABEL_49:
  ...
  v50 = sub_100030A0(v47, *(_DWORD *)(v47 + 4), (int)a3);
  sub_1000BBB0(1, v3 + 1);
  *(_DWORD *)(v47 + 4) = v50;
  *(_DWORD *)v50[1] = v50;
  if ( !v46 )
