/*
 * func-name: sub_10027B80
 * func-address: 0x10027b80
 * callers: 0x10027af0
 * callees: 0x10009da0, 0x1000b6e0, 0x1000b790
 */

int __stdcall sub_10027B80(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v51 = sub_1000B6E0(a3, (int)v48, v48[1]);
  sub_1000B790(1u, (int)(v3 + 1));
  v48[1] = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
    invalid_parameter_noinfo();
