/*
 * func-name: sub_10018670
 * func-address: 0x10018670
 * callers: 0x10018150
 * callees: 0x10009da0, 0x1000bb00, 0x1000bbb0
 */

int __stdcall sub_10018670(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v51 = sub_1000BB00((int)v48, v48[1], (int)a3);
  sub_1000BBB0(1u, (int)(v3 + 1));
  v48[1] = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
    invalid_parameter_noinfo();
