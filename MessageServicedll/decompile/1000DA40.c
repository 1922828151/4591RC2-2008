/*
 * func-name: ?cache_start_connector_with_first_message@Message_Facade@Message@Outpop@@SAHAAVINET_Addr@IONetwork@3@HIHIAAV?$Smart_Ptr@VBinary_Stream@Utility@Outpop@@@Utility@3@AAV?$Smart_Ptr@VRef_Object@Utility@Outpop@@@73@W4ETransmitType@73@_NII4HHHH@Z
 * func-address: 0x1000da40
 * callers: none
 * callees: 0x10001000, 0x10015230, 0x100294e2
 */

int __cdecl Outpop::Message::Message_Facade::cache_start_connector_with_first_message(
        int a1,
        int a2,
        int a3,
        int a4,
        ...
        int a16)
{
  ...
  if ( a16 )
    v20[9] = a16;
  v18 = Outpop::Message::Connector_Manager::cache_add_connector(
