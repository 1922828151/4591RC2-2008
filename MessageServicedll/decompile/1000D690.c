/*
 * func-name: ?start_connector@Message_Facade@Message@Outpop@@SAHAAVINET_Addr@IONetwork@3@HIHIAAV?$Smart_Ptr@VRef_Object@Utility@Outpop@@@Utility@3@W4ETransmitType@73@_N3IIIH3HHHH@Z
 * func-address: 0x1000d690
 * callers: none
 * callees: 0x10001000, 0x100146d0, 0x100294e2
 */

int __cdecl Outpop::Message::Message_Facade::start_connector(
        int a1,
        int a2,
        int a3,
        int a4,
        ...
        int a18)
{
  ...
  if ( a18 )
    v21[9] = a18;
  v19 = Outpop::Message::Connector_Manager::add_connector(
