/*
 * func-name: sub_10020010
 * func-address: 0x10020010
 * callers: none
 * callees: 0x100038e0, 0x10007400, 0x1001aa50, 0x10020800
 */

int __thiscall sub_10020010(wchar_t *this, Outpop::Utility::Ref_Object *a2, DWORD a3, const wchar_t **a4)
{
  int v5; // esi
  ...
  LOBYTE(v29) = 0;
  if ( sub_10020800(this + 68, &a2, a3, &v27, v25, v26) == -1 )
  {
      ...
      && *(_BYTE *)(Outpop::Utility::Logger::instance() + 140) == 1 )
    {
      ...
      v14 = sub_10007400(
              ...
              LastError)
          + v10;
      v15 = sub_1001AA50((int)this, (Outpop::IONetwork::INET_Addr *)v28);
      LOBYTE(v29) = 3;
      v16 = ntohs(*((_WORD *)v15 + 7));
