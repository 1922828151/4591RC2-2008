/*
 * func-name: sub_10039B80
 * func-address: 0x10039b80
 * callers: 0x10017730, 0x10036c20
 * callees: 0x10015200, 0x1002c040, 0x10035f10
 */

int __stdcall sub_10039B80(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  while ( 1 )
  {
    ...
    if ( *(_QWORD *)a3 >= *(_QWORD *)(v48 + 8) )
    {
      if ( v48 == *(_DWORD *)(v47 + 4) )
        invalid_parameter_noinfo();
      if ( *(_QWORD *)(v48 + 8) >= *(_QWORD *)a3 )
      {
        result = a2;
        *(_DWORD *)a2 = v47;
        *(_DWORD *)(a2 + 4) = v48;
  ...
  v51 = sub_10035F10(v48, *(_DWORD *)(v48 + 4), (int)a3);
  sub_1002C040(1u, (int)(v3 + 1));
  *(_DWORD *)(v48 + 4) = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
    invalid_parameter_noinfo();
