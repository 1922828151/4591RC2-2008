/*
 * func-name: ?erase_security_wait_channel_from_map@Dgram_Acceptor@IONetwork@Outpop@@QAEXAAVINET_Addr@23@@Z
 * func-address: 0x1002a120
 * callers: 0x1003ffb0, 0x10040db0
 * callees: 0x10007400, 0x1003a2e0
 */

char __thiscall Outpop::IONetwork::Dgram_Acceptor::erase_security_wait_channel_from_map(
        ...
        struct in_addr *a2)
{
    ...
    && *(_BYTE *)(Outpop::Utility::Logger::instance() + 138) == 1 )
  {
    ...
    sub_10007400(
      0xFFFF - v8,
      &log_buffer[v8],
      L"Dgram_Acceptor::erase_security_wait_channel_from_map  addr ip is %S,port is %d",
      v9,
      v17);
  ...
  v11 = Outpop::Utility::Thread_Mutex::acquire((Outpop::IONetwork::Dgram_Acceptor *)((char *)this + 208)) - 1;
  if ( v11 != -1 )
  {
    ntohl(a2[4].S_un.S_addr);
    ntohs(a2[3].S_un.S_un_w.s_w2);
    sub_1003A2E0((char *)this + 288);
    LOBYTE(v11) = Outpop::Utility::Thread_Mutex::release((Outpop::IONetwork::Dgram_Acceptor *)((char *)this + 208));
  }
  return v11;
}
