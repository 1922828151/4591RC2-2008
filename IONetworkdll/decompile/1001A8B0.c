/*
 * func-name: sub_1001A8B0
 * func-address: 0x1001a8b0
 * callers: 0x1002a4c0, 0x1003a2e0
 * callees: none
 */

_DWORD *__userpurge sub_1001A8B0@<eax>(_DWORD *a1@<edi>, _DWORD *a2, _DWORD *a3)
{
  ldiv_t v3; // rax
  unsigned int v4; // esi
  int v5; // ecx
