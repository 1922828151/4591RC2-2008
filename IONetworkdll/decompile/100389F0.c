/*
 * func-name: ?handle_time_out@Dgram_Connector@IONetwork@Outpop@@UAEXABVTime_Value@Utility@3@0AAV?$Smart_Ptr@VRef_Object@Utility@Outpop@@@53@J@Z
 * func-address: 0x100389f0
 * callers: none
 * callees: 0x1003b740, 0x1004e98e
 */

int __thiscall Outpop::IONetwork::Dgram_Connector::handle_time_out(
        int this,
        int a2,
        int a3,
        ...
        int a5)
{
  ...
  *(_DWORD *)(v7 + 52) = a5;
  result = PostQueuedCompletionStatus(**(HANDLE **)(this + 8), v11, 0, v13[0]);
  if ( !result )
