/*
 * func-name: sub_10034E50
 * func-address: 0x10034e50
 * callers: 0x10034730, 0x10048940
 * callees: 0x10015200, 0x100160b0, 0x10025c20
 */

int __stdcall sub_10034E50(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  while ( 1 )
  {
    ...
    if ( *(_WORD *)a3 >= *(_WORD *)(v47 + 8) )
    {
      if ( v47 == *(_DWORD *)(v46 + 4) )
        invalid_parameter_noinfo();
      if ( *(_WORD *)(v47 + 8) >= *(_WORD *)a3 )
      {
        result = a2;
        *(_DWORD *)a2 = v46;
        *(_DWORD *)(a2 + 4) = v47;
  ...
  v50 = sub_10025C20(a3, v47, *(_DWORD *)(v47 + 4));
  sub_100160B0(1u, (int)(v3 + 1));
  *(_DWORD *)(v47 + 4) = v50;
  *(_DWORD *)v50[1] = v50;
  if ( !v46 )
    invalid_parameter_noinfo();
