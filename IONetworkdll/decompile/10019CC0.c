/*
 * func-name: sub_10019CC0
 * func-address: 0x10019cc0
 * callers: none
 * callees: none
 */

int __userpurge sub_10019CC0@<eax>(int a1@<ecx>, int a2, int a3, int a4, int a5)
{
  _DWORD *v6; // edi
  _DWORD *v7; // eax
  _DWORD *v8; // edi
  ...
  *(_BYTE *)(a2 + 72) = 1;
  ...
  retaddr = -1;
  return (*(int (__thiscall **)(_DWORD, int, int, int))(**(_DWORD **)(a1 + 88) + 20))(*(_DWORD *)(a1 + 88), a2, a4, a5);
}
