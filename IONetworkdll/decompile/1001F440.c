/*
 * func-name: sub_1001F440
 * func-address: 0x1001f440
 * callers: none
 * callees: 0x10002e10, 0x10007400, 0x1001eb90
 */

void __thiscall sub_1001F440(int this)
{
  ...
  if ( *(_DWORD *)(this + 88) )
  {
    ...
    Outpop::IONetwork::Stream_Connector::bluider_channel_falied(
      *(Outpop::Utility::Ref_Object **)(this + 88),
      0,
      v13[0],
      (int)v13[1],
      (int)tm,
