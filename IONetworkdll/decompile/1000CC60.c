/*
 * func-name: ?process@Security_Processer@IONetwork@Outpop@@QAE_NAAV?$Smart_Ptr@VBinary_Stream@Utility@Outpop@@@Utility@3@PAVSecurity@23@_N@Z
 * func-address: 0x1000cc60
 * callers: 0x1000f2a0, 0x1000f9b0, 0x10010440, 0x1002d330, 0x1002e210, 0x10030dd0, 0x10032520
 * callees: 0x100070a0, 0x10007400
 */

char __stdcall Outpop::IONetwork::Security_Processer::process(
        ...
        int a3)
{
  ...
  if ( Outpop::IONetwork::Crypto_Aes::aes_encrypt_buff(
  ...
  else
  {
      ...
      && *(_BYTE *)(Outpop::Utility::Logger::instance() + 140) == 1 )
    {
      ...
      v14 = sub_10007400(
              ...
              41);
      sub_10007400(0xFFFF - (v14 + v10), &log_buffer[v14 + v10], L"aes_encrypt_buff error is:%d", LastError);
