/*
 * func-name: sub_1003B670
 * func-address: 0x1003b670
 * callers: 0x1003b980
 * callees: none
 */

int __thiscall sub_1003B670(_DWORD *this)
{
  Outpop::Utility::Ref_Object *v2; // ecx
  Outpop::Utility::Ref_Object *v3; // ecx
  int result; // eax

  *this = &Outpop::IONetwork::Asynch_IO_Dgram_Read_Result<Outpop::Utility::Smart_Ptr<Outpop::IONetwork::Dgram_Connector>>::`vftable';
