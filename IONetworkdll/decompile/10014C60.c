...
_DWORD *__stdcall sub_10014C60(_DWORD *a1, Outpop::Utility::Ref_Object *a2)
{
  *a1 = &Outpop::IONetwork::Asynch_Result::`vftable';
  ...
  a1[4] = 0;
  a1[3] = 0;
  *a1 = &Outpop::IONetwork::Asynch_Timer_Result<Outpop::Utility::Smart_Ptr<Outpop::IONetwork::Stream_Channel>>::`vftable';
  a1[7] = a2;
  if ( a2 )
