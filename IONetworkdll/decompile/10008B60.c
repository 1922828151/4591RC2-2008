/*
 * func-name: ?set_local_address@Channel@IONetwork@Outpop@@QAEXAAVINET_Addr@23@@Z
 * func-address: 0x10008b60
 * callers: none
 * callees: none
 */

_DWORD *__thiscall Outpop::IONetwork::Channel::set_local_address(
