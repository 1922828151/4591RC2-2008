/*
 * func-name: sub_100192B0
 * func-address: 0x100192b0
 * callers: 0x10017730
 * callees: 0x10008df0, 0x10008e90, 0x10016200, 0x1003dc50, 0x1004e98e
 */

int __stdcall sub_100192B0(int a1, _DWORD *a2, struct Outpop::IONetwork::Acceptor *a3)
{
  ...
  _DWORD *v7; // edi
  _DWORD *v8; // eax
  Outpop::IONetwork::Accept_Bluider_Process *v9; // eax
  int v10; // eax
  _DWORD v12[7]; // [esp+18h] [ebp-28h] BYREF
  int v13; // [esp+3Ch] [ebp-4h]

  sub_10016200((_DWORD *)a1);
  v13 = 0;
  *(_DWORD *)a1 = &Outpop::IONetwork::Wait_Stream_Channel<Outpop::IONetwork::Stream_Acceptor,Outpop::IONetwork::Accept_Bluider_Process>::`vftable';
  *(_BYTE *)(a1 + 76) = 1;
  *(_DWORD *)(a1 + 80) = -1;
  LOBYTE(v13) = 1;
  *(_DWORD *)(a1 + 88) = a3;
  ...
  *v8 = *v7;
  ...
  LOBYTE(v13) = 1;
  v12[0] = &Outpop::IONetwork::Addr::`vftable';
  v9 = (Outpop::IONetwork::Accept_Bluider_Process *)operator new(28);
  LOBYTE(v13) = 6;
  if ( v9 )
    v10 = Outpop::IONetwork::Accept_Bluider_Process::Accept_Bluider_Process(
            v9,
