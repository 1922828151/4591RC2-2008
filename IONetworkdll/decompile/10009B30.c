/*
 * func-name: sub_10009B30
 * func-address: 0x10009b30
 * callers: 0x100091d0, 0x1001a2c0, 0x1002ad90, 0x10035b20, 0x1003a5b0, 0x1003ade0, 0x1003dd30, 0x1003fba0, 0x1003ffb0, 0x100407c0, 0x10041b20
 * callees: 0x1004f112
 */

int *__userpurge sub_10009B30@<eax>(int *a1@<esi>, const char *a2)
{
  DWORD LastError; // eax
  int v3; // edi
  ...
  if ( Outpop::Utility::Stream_Base::get_space((Outpop::Utility::Stream_Base *)a1) < 4u )
  {
    v3 = *a1;
    size = Outpop::Utility::Stream_Base::get_size((Outpop::Utility::Stream_Base *)a1);
    (*(void (__thiscall **)(int *, unsigned int))(v3 + 16))(a1, size + 132);
  }
  v5 = Outpop::Utility::OS_Buffer::write((Outpop::Utility::OS_Buffer *)a1[2], a2, a1[3], 4);
  if ( v5 == -1 )
  {
