/*
 * func-name: sub_1001F690
 * func-address: 0x1001f690
 * callers: none
 * callees: 0x100038e0, 0x10007400, 0x10016370, 0x10020490
 */

int __thiscall sub_1001F690(int this, Outpop::Utility::Ref_Object *a2, Outpop::IONetwork::INET_Addr *a3, int a4)
{
  ...
  if ( this )
    Outpop::Utility::Ref_Object::addref((Outpop::Utility::Ref_Object *)this);
  LOBYTE(v49) = 2;
  if ( sub_10020490(this + 80, &a2, (DWORD)a3, &v42, v40, v41) == -1 )
  {
    a4 = -1;
    v43 = GetLastError();
    if ( (*(_BYTE *)(Outpop::Utility::Logger::instance() + 136) == 1
