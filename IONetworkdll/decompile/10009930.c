/*
 * func-name: sub_10009930
 * func-address: 0x10009930
 * callers: 0x100091d0, 0x10023270, 0x100328d0, 0x10045f80, 0x10046320, 0x10046860
 * callees: 0x1004f112
 */

int *__userpurge sub_10009930@<eax>(int *a1@<esi>, const char *a2)
{
  DWORD LastError; // eax
  int v3; // edi
  ...
  if ( !Outpop::Utility::Stream_Base::get_space((Outpop::Utility::Stream_Base *)a1) )
  {
    v3 = *a1;
    size = Outpop::Utility::Stream_Base::get_size((Outpop::Utility::Stream_Base *)a1);
    (*(void (__thiscall **)(int *, unsigned int))(v3 + 16))(a1, size + 129);
  }
  v5 = Outpop::Utility::OS_Buffer::write((Outpop::Utility::OS_Buffer *)a1[2], a2, a1[3], 1);
  if ( v5 == -1 )
  {
