/*
 * func-name: sub_100155B0
 * func-address: 0x100155b0
 * callers: 0x1000e910, 0x1000ee60, 0x100117b0
 * callees: 0x10015a50, 0x1001b880
 */

int __stdcall sub_100155B0(
        SOCKET *a1,
        ...
        _DWORD *a6)
{
  ...
  CHAR *v14; // eax
  SOCKET v16; // [esp-1Ch] [ebp-50h]
  _DWORD v17[9]; // [esp-4h] [ebp-38h] BYREF
  _WSABUF Buffers; // [esp+20h] [ebp-14h] BYREF
