/*
 * func-name: sub_10022310
 * func-address: 0x10022310
 * callers: 0x10021010
 * callees: 0x10002e10, 0x10003930, 0x10004050, 0x100040d0, 0x10005ae0, 0x10007400, 0x1001eb90, 0x100227d0, 0x1004e861
 */

char *__fastcall sub_10022310(int a1, _DWORD *a2)
{
...
LABEL_5:
    ...
    Outpop::IONetwork::Stream_Connector::bluider_channel_falied(
      *(Outpop::Utility::Ref_Object **)(a1 + 140),
      0,
      v9[0],
      (int)v9[1],
      (int)v9[2],
  ...
  *(_DWORD *)(a1 + 136) = -1;
  ...
  v8 = **(_DWORD **)(a1 + 140);
  LOBYTE(v19) = 2;
  (*(void (__cdecl **)(SOCKET *, _DWORD, _DWORD))(v8 + 24))(s, 0, 0);
  LOBYTE(v19) = 1;
  if ( v12 )
    Outpop::Utility::Ref_Object::release(v12);
  v19 = 0;
