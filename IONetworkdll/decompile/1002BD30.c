/*
 * func-name: sub_1002BD30
 * func-address: 0x1002bd30
 * callers: 0x10016d50, 0x10026040, 0x1002a450, 0x1002c990
 * callees: 0x10015200, 0x1002c4b0, 0x100355d0, 0x10035660, 0x10035680, 0x1004f112
 */

unsigned int __stdcall sub_1002BD30(int a1, int a2)
{
  int v2; // ebx
  int v3; // edx
  int v4; // edi
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  ...
  v16[8] = a2 + 4;
  v16[6] = a1 + 4;
  sub_1002C4B0(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v19, a2 + 4, v7);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v22 = -1;
  v17 = **(_DWORD ***)(a1 + 8);
  v19 = **(_DWORD ***)(a2 + 8);
