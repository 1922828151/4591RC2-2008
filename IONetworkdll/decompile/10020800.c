/*
 * func-name: sub_10020800
 * func-address: 0x10020800
 * callers: 0x10020010
 * callees: 0x1001b880, 0x10020dc0
 */

int __stdcall sub_10020800(
        SOCKET *a1,
        ...
        Outpop::Utility::Ref_Object **a6)
{
  ...
  Outpop::Utility::Ref_Object *v17[8]; // [esp-4h] [ebp-34h] BYREF
  ...
  v9 = (Outpop::Utility::Ref_Object *)Outpop::Utility::Sect_Block_Allocator::malloc(v7, (unsigned int)v17[1]);
  v17[6] = v9;
  if ( v9 )
  {
    v17[7] = (Outpop::Utility::Ref_Object *)v17;
    v17[0] = a5;
    if ( a5 )
      Outpop::Utility::Ref_Object::addref(a5);
    LOBYTE(v19) = 1;
    v10 = sub_10020DC0(v9, v17[0]);
  }
  else
  {
    v10 = 0;
