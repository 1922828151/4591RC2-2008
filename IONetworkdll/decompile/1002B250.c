/*
 * func-name: sub_1002B250
 * func-address: 0x1002b250
 * callers: 0x10028900
 * callees: 0x10003930, 0x10004050, 0x100040d0, 0x10005ae0, 0x10007400, 0x10027c40, 0x1002bf40, 0x1004e861
 */

char *__thiscall sub_1002B250(int this)
{
  ...
  v14 = 0;
  if ( !*(_BYTE *)(this + 8) )
    return (char *)Outpop::IONetwork::Dgram_Acceptor::asynch_receive(
                     *(Outpop::IONetwork::Dgram_Acceptor **)(this + 72),
                     0);
  ...
  v5 = *(_DWORD *)(this + 80);
  LOBYTE(v14) = 1;
  (*(void (__cdecl **)(_BYTE *, int, int))(v3 + 20))(v9, v5, v6);
  LOBYTE(v14) = 0;
