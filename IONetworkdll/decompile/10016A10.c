/*
 * func-name: ??0Dgram_Connect_Bluider_Process@IONetwork@Outpop@@QAE@ABV012@@Z
 * func-address: 0x10016a10
 * callers: none
 * callees: 0x10002e10
 */
...
Outpop::IONetwork::Dgram_Connect_Bluider_Process *__thiscall Outpop::IONetwork::Dgram_Connect_Bluider_Process::Dgram_Connect_Bluider_Process(
        ...
        const struct Outpop::IONetwork::Dgram_Connect_Bluider_Process *a2)
{
  ...
  *(_DWORD *)this = &Outpop::IONetwork::Dgram_Connect_Bluider_Process::`vftable';
  Outpop::IONetwork::INET_Addr::INET_Addr(
    (Outpop::IONetwork::Dgram_Connect_Bluider_Process *)((char *)this + 8),
    (const struct Outpop::IONetwork::Dgram_Connect_Bluider_Process *)((char *)a2 + 8));
  *((_DWORD *)this + 9) = *((_DWORD *)a2 + 9);
  *((_DWORD *)this + 10) = *((_DWORD *)a2 + 10);
  *((_DWORD *)this + 12) = *((_DWORD *)a2 + 12);
  v3 = (Outpop::Utility::Ref_Object *)*((_DWORD *)a2 + 13);
  *((_DWORD *)this + 13) = v3;
  if ( v3 )
  ...
  *((_DWORD *)this + 16) = *((_DWORD *)a2 + 16);
  v4 = (Outpop::Utility::Ref_Object *)*((_DWORD *)a2 + 17);
  *((_DWORD *)this + 17) = v4;
  if ( v4 )
