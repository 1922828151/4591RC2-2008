/*
 * func-name: sub_10048880
 * func-address: 0x10048880
 * callers: 0x10048920
 * callees: none
 */

void __thiscall sub_10048880(_DWORD *this)
{
  Outpop::Utility::Ref_Object *v2; // ecx
  Outpop::Utility::Ref_Object *v3; // ecx

  *this = &Outpop::IONetwork::Asynch_Timer_Result<Outpop::Utility::Smart_Ptr<Outpop::IONetwork::P2P_Channel>>::`vftable';
