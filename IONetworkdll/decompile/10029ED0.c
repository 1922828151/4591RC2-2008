/*
 * func-name: ?erase_simple_wait_channel_from_map@Dgram_Acceptor@IONetwork@Outpop@@QAEXAAVINET_Addr@23@@Z
 * func-address: 0x10029ed0
 * callers: 0x1002bf40
 * callees: 0x10007400, 0x1003a2e0
 */

char __thiscall Outpop::IONetwork::Dgram_Acceptor::erase_simple_wait_channel_from_map(
        ...
        struct in_addr *a2)
{
    ...
    && *(_BYTE *)(Outpop::Utility::Logger::instance() + 138) == 1 )
  {
    ...
    sub_10007400(
      0xFFFF - v8,
      &log_buffer[v8],
      L"Dgram_Acceptor::erase_simple_wait_channel_from_map  addr ip is %S,port is %d",
      v9,
      v17);
