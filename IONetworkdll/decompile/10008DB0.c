/*
 * func-name: ?local_addr@Bluid_Pakcet@IONetwork@Outpop@@QAEXAAVINET_Addr@23@@Z
 * func-address: 0x10008db0
 * callers: 0x1001dec0
 * callees: none
 */

_DWORD *__thiscall Outpop::IONetwork::Bluid_Pakcet::local_addr(
