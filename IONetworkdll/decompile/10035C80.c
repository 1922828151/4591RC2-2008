/*
 * func-name: sub_10035C80
 * func-address: 0x10035c80
 * callers: 0x10033240, 0x10035ba0, 0x10047130
 * callees: 0x1004f112
 */

int __userpurge sub_10035C80@<eax>(int a1@<esi>, char *a2)
{
  ...
  if ( Outpop::Utility::Stream_Base::get_readable((Outpop::Utility::Stream_Base *)a1) < 2u )
  {
