/*
 * func-name: sub_1003D1F0
 * func-address: 0x1003d1f0
 * callers: 0x1003c7d0
 * callees: 0x10015200, 0x10016000, 0x100160b0
 */

int __stdcall sub_1003D1F0(int *a1, int a2, _WORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v50 = sub_10016000(v47, *(_DWORD *)(v47 + 4), (int)a3);
