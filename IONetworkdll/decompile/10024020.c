/*
 * func-name: sub_10024020
 * func-address: 0x10024020
 * callers: 0x10023520
 * callees: 0x10015200, 0x10025230, 0x1002c040
 */

int __stdcall sub_10024020(int *a1, int a2, _WORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
