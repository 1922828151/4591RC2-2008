/*
 * func-name: sub_10024980
 * func-address: 0x10024980
 * callers: 0x10022a00, 0x10022d00, 0x10023f30, 0x10042370
 * callees: 0x10015200, 0x10024e20, 0x10025390, 0x10035660, 0x10035680, 0x1004f112
 */

unsigned int __stdcall sub_10024980(int a1, int a2)
{
  int v2; // esi
  int v3; // edx
  int v4; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  ...
  v16[8] = a2 + 4;
  v16[6] = a1 + 4;
  sub_10025390(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v19, a2 + 4, v7);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v22 = -1;
  v17 = **(_DWORD ***)(a1 + 8);
  v19 = **(_DWORD ***)(a2 + 8);
