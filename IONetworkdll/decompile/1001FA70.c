/*
 * func-name: sub_1001FA70
 * func-address: 0x1001fa70
 * callers: none
 * callees: 0x100038e0, 0x10007400, 0x10016370, 0x100205e0
 */

int __thiscall sub_1001FA70(
        ...
        int a4)
{
  ...
  if ( this )
    Outpop::Utility::Ref_Object::addref(this);
  LOBYTE(v32) = 1;
  if ( sub_100205E0((char *)this + 80, &a2, a3, v24, v25) == -1 )
  {
    a4 = -1;
