/*
 * func-name: ?make_respond_packet@Dgram_Accept_Bluider_Process@IONetwork@Outpop@@QAE_NV?$Smart_Ptr@VBinary_Stream@Utility@Outpop@@@Utility@3@PAVSecurity@23@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
 * func-address: 0x100407c0
 * callers: 0x1003ffb0
 * callees: 0x100068e0, 0x10007400, 0x10008000, 0x10008920, 0x10009b30, 0x1000d010, 0x1000d260, 0x1004e861, 0x1004e938
 */

char __thiscall Outpop::IONetwork::Dgram_Accept_Bluider_Process::make_respond_packet(
        _DWORD *this,
        ...
        int a10)
{
  ...
  DWORD pdwDataLen; // [esp+18h] [ebp-ECh] BYREF
  DWORD v60; // [esp+1Ch] [ebp-E8h]
  void *v61; // [esp+20h] [ebp-E4h]
  ...
  *(_DWORD *)pbData = v12;
  ...
  aes_key = Outpop::IONetwork::Crypto_Aes::create_aes_key(
              (Outpop::IONetwork::Crypto_Aes *)(this[11] + 32),
              *v15,
              (BYTE *)v13,
              0x10u,
              *(_DWORD *)(v14 + 100));
  ...
  if ( !aes_key )
  {
      ...
      && *(_BYTE *)(Outpop::Utility::Logger::instance() + 140) == 1 )
    {
      ...
      sub_10007400(
        0xFFFF - (v23 + v19),
        &log_buffer[v23 + v19],
        L"Dgram_Accept_Bluider_Process::make_respond_packet  se_->get_win32_des_oldobj().create_aes_key falied,errcode is:%d",
        pdwDataLen);
  ...
  if ( !Outpop::IONetwork::CryptProv::UpdateKey(v26, v56, v57) )
  {
      ...
      && *(_BYTE *)(Outpop::Utility::Logger::instance() + 140) == 1 )
    {
      ...
      sub_10007400(
        0xFFFF - (v34 + v30),
        &v29[v34 + v30],
        L"Dgram_Accept_Bluider_Process::make_respond_packet  g_pRsan.UpdateKey failed  %d",
        v60);
LABEL_19:
      if ( *(_BYTE *)(Outpop::Utility::Logger::instance() + 136) )
        wprintf(L"%s", v29);
  ...
  if ( !CryptEncrypt(*((_DWORD *)v37 + 2), 0, 1, 0, pbData, &pdwDataLen, 0xC8u) )
  {
      ...
      && *(_BYTE *)(Outpop::Utility::Logger::instance() + 140) == 1 )
    {
      ...
      sub_10007400(
        0xFFFF - (v43 + v39),
        &v29[v43 + v39],
        L"Dgram_Accept_Bluider_Process::make_respond_packet  g_pRsan.EnCryptEncrypt2  %d",
        v60);
      goto LABEL_19;
    }
LABEL_24:
  ...
  sub_10009B30((int *)a2, (const char *)&pdwDataLen);
