/*
 * func-name: sub_100205E0
 * func-address: 0x100205e0
 * callers: 0x1001fa70
 * callees: 0x1001b6d0, 0x10020c80, 0x1004f170
 */

int __stdcall sub_100205E0(
        SOCKET *a1,
        ...
        Outpop::Utility::Ref_Object *a5)
{
  ...
  Outpop::Utility::Ref_Object *v15[6]; // [esp-4h] [ebp-1030h] BYREF
  ...
  v7 = (Outpop::Utility::Ref_Object *)Outpop::Utility::Sect_Block_Allocator::malloc(v6, (unsigned int)v15[1]);
  v16 = v7;
  if ( v7 )
  {
    v17 = v15;
  ...
  *(_DWORD *)(v8 + 32) = a5;
  ...
  LOBYTE(v20) = 0;
  sub_1001B6D0(v8, v15[0]);
  v11 = *a2;
  v17 = (Outpop::Utility::Ref_Object **)v11;
  if ( v11 )
  ...
  while ( v11 )
  {
    ...
    v11 = *v12;
    v17 = (Outpop::Utility::Ref_Object **)*v12;
    if ( v17 )
      Outpop::Utility::Ref_Object::addref(v11);
    LOBYTE(v20) = 4;
    if ( v16 )
