/*
 * func-name: sub_100216E0
 * func-address: 0x100216e0
 * callers: 0x10020ed0
 * callees: 0x10002e10, 0x10003930, 0x10004050, 0x100040d0, 0x10005ae0, 0x10005b00, 0x10007400, 0x1000c9e0, 0x1000d770, 0x1001eb90, 0x10022840, 0x10035dd0, 0x1004e861, 0x1004f112
 */

char *__fastcall sub_100216E0(Outpop::Utility::Ref_Object **a1, _DWORD *a2)
{
  unsigned int v4; // ecx
...
LABEL_13:
    LOBYTE(v70) = 2;
    Outpop::IONetwork::Stream_Connector::bluider_channel_falied(
      a1[35],
      0,
      v57,
      v58,
...
LABEL_15:
      ...
      LOBYTE(v70) = 19;
      v44 = a1[35];
      v45 = (void (__thiscall **)(Outpop::Utility::Ref_Object *, SOCKET *, wchar_t *, Outpop::Utility::Ref_Object *, DWORD))(*(_DWORD *)v44 + 24);
