/*
 * func-name: sub_100493D0
 * func-address: 0x100493d0
 * callers: 0x100328d0, 0x10046860
 * callees: 0x10015200, 0x10025d80, 0x1004a3a0
 */

int __stdcall sub_100493D0(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v50 = sub_10025D80(a3, v47, *(_DWORD *)(v47 + 4));
  sub_1004A3A0(1, v3 + 1);
  *(_DWORD *)(v47 + 4) = v50;
  *(_DWORD *)v50[1] = v50;
  if ( !v46 )
