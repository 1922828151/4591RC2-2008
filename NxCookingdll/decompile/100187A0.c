/*
 * func-name: sub_100187A0
 * func-address: 0x100187a0
 * callers: none
 * callees: 0x10014910
 */

char __thiscall sub_100187A0(_DWORD *this, char a2, int a3)
{
  int v4; // eax
  int v5; // edi
  ...
  if ( !v11 )
    return 0;
  (*(void (__thiscall **)(int, _DWORD *, int))(*(_DWORD *)a3 + 24))(a3, v11, v44);
  if ( a2 )
  {
    v13 = 0;
    if ( this[1] )
