 ...
 * callers: none
 * callees: 0x10001610, 0x10001d00, 0x10001dd0, 0x10002100, 0x10002380, 0x10002880, 0x10034bd3
 */

void __thiscall sub_10002D40(_DWORD **this, int a2, int a3, char a4, const char *a5, int a6)
{
  char *v7; // eax
  int v8; // eax
  const char *v9; // eax
    ...
    && this[8215] )
  {
    ...
    v10 = v7;
    v8 = sub_10001DD0(a5);
    sub_10001D00(v11, a3, 4, 16, v8, v10);
    sub_10002380(v11, this[8215]);
    sub_10002100(this[8215], a2);
    v9 = a5;
    if ( !a4 )
      v9 = byte_10049374;
    v13 = 15;
