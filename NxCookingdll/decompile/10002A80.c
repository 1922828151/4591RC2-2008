/*
 * func-name: sub_10002A80
 * func-address: 0x10002a80
 * callers: none
 * callees: 0x10001610, 0x10001830, 0x10001d00, 0x10001dd0, 0x10002380, 0x10002880, 0x10034bd3
 */

void __thiscall sub_10002A80(_DWORD **this, float *a2, int a3, int a4, const char *a5, int a6)
{
  char v7; // bl
  const char *v8; // edi
  char *v9; // eax
    ...
    && this[8215] )
  {
    ...
    v11 = v9;
    v10 = sub_10001DD0(a5);
    sub_10001D00(v12, a3, 1, 4, v10, v11);
    sub_10002380(v12, this[8215]);
    a4 = *(int *)a2;
    sub_10001830(this[8215], (int)&a4, 4u);
    if ( !v7 )
      v8 = byte_10049374;
    v14 = 15;
    Block = 0;
