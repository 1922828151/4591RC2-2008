/*
 * func-name: sub_1004197C
 * func-address: 0x1004197c
 * callers: 0x10037742
 * callees: 0x10034ca4, 0x100375b9, 0x10045ef8, 0x1004643a
 */

int __cdecl sub_1004197C(int a1, int a2, struct localeinfo_struct *a3)
{
  int v3; // eax
