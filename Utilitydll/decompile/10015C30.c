/*
 * func-name: ??0float_underflow_error@Utility@Outpop@@QAE@PAU_EXCEPTION_RECORD@@PAVoutpop_exception@12@@Z
 * func-address: 0x10015c30
 * callers: 0x10014ff0
 * callees: 0x10015510
 */
...
{
  Outpop::Utility::float_exception::float_exception(this, a2, "float underflow.", a3);
