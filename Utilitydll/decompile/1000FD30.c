/*
 * func-name: sub_1000FD30
 * func-address: 0x1000fd30
 * callers: 0x10011b40
 * callees: 0x100072a0, 0x10010980, 0x10010c00, 0x10014170
 */

int __stdcall sub_1000FD30(int *a1, int a2, int a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_16:
    for ( i = v13; ; i = v67 )
    {
      ...
      if ( i == (int *)v62[1] )
        invalid_parameter_noinfo();
      v56 = (_DWORD *)std::string::end(i + 2, v72);
      v16 = (_DWORD *)std::string::begin(i + 2, v73);
      v17 = sub_10010C00(*v16, v16[1], *v56, v56[1]);
      v18 = ldiv(v17, 127773);
...
LABEL_50:
  ...
  v38 = (_DWORD *)std::string::end(a3, v73);
  v39 = (_DWORD *)std::string::begin(a3, v72);
  v40 = sub_10010C00(*v39, v39[1], *v38, v38[1]);
  v41 = ldiv(v40, 127773);
  ...
  while ( 1 )
  {
    ...
    if ( v47 == *(_DWORD **)(v63 + 4) )
      invalid_parameter_noinfo();
    if ( !(unsigned __int8)std::operator<<char>(a3, v47 + 2) )
    {
      if ( v47 == *(_DWORD **)(v63 + 4) )
        invalid_parameter_noinfo();
      if ( !(unsigned __int8)std::operator<<char>(v47 + 2, a3) )
      {
        result = a2;
        *(_DWORD *)a2 = v63;
        *(_DWORD *)(a2 + 4) = v47;
