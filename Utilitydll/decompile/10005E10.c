/*
 * func-name: sub_10005E10
 * func-address: 0x10005e10
 * callers: 0x10004190, 0x10004430
 * callees: 0x100072a0, 0x10007820, 0x10007f30
 */

int __stdcall sub_10005E10(_DWORD *a1, int a2, _DWORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= a1[3] >> 2 )
  {
    ...
    else
    {
      ...
      v8 = 2 * v7 - 3;
      a1[8] = v8;
      sub_100072A0(v8 + 2, (_BYTE)a1 + 4, a1[2]);
    }
    v10 = a1[5];
    v11 = a1[9] - (a1[8] >> 1) - 1;
    v57 = v11;
