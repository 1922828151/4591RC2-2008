/*
 * func-name: ??0Event_Base@Utility@Outpop@@QAE@_N0PBD@Z
 * func-address: 0x1000bb00
 * callers: 0x10003e80, 0x1000bf30, 0x1000c080
        ...
        const char *lpName)
{
  ...
  *((_DWORD *)this + 2) = lpName;
  *((_DWORD *)this + 1) = 0;
  EventA = CreateEventA(0, a2, a3, lpName);
  *(_DWORD *)this = EventA;
  if ( !EventA
    ...
    && *((_BYTE *)Outpop::Utility::Logger::instance() + 141) == 1 )
  {
    ...
    sub_1000CD90(&v8[v12], L"Event_Base construct function CreateEventA event faled,errcode is :%d", LastError);
