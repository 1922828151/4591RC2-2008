/*
 * func-name: sub_10012A10
 * func-address: 0x10012a10
 * callers: 0x100125f0
 * callees: 0x100072a0, 0x10010c00, 0x10013ff0, 0x10014260
 */

int __stdcall sub_10012A10(int *a1, int a2, int a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)a1[3] >> 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v65 == (int *)v64[1] )
        invalid_parameter_noinfo();
      v15 = std::string::end(v65 + 2, v71);
      v16 = std::string::begin(v65 + 2, v72);
      v17 = sub_10010C00(*(_DWORD **)v16, *(_DWORD *)(v16 + 4), *(_DWORD **)v15, *(_DWORD *)(v15 + 4));
      v18 = ldiv(v17, 127773);
...
LABEL_49:
  ...
  v44 = std::string::end(a3, v72);
  v45 = std::string::begin(a3, v71);
  v46 = sub_10010C00(*(_DWORD **)v45, *(_DWORD *)(v45 + 4), *(_DWORD **)v44, *(_DWORD *)(v44 + 4));
  v47 = ldiv(v46, 127773);
