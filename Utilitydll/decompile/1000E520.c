/*
 * func-name: ??2Binary_Stream@Utility@Outpop@@SAPAXI@Z
 * func-address: 0x1000e520
 * callers: none
 * callees: 0x10005a90, 0x1000e110, 0x1000e340, 0x10019586
 */

char *__cdecl Outpop::Utility::Binary_Stream::operator new()
{
