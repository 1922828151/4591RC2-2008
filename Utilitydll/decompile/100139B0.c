/*
 * func-name: sub_100139B0
 * func-address: 0x100139b0
 * callers: 0x10010fb0, 0x10012920
 * callees: 0x100072a0, 0x10010780, 0x10013ed0, 0x10014070, 0x100145b0, 0x10019586
 */

unsigned int __stdcall sub_100139B0(int a1, int a2)
{
  int v2; // ebx
  int v3; // edx
  int v4; // edi
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  ...
  v16[8] = a2 + 4;
  v16[6] = a1 + 4;
  sub_100145B0(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v19, a2 + 4, v7);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v22 = -1;
  v17 = **(_DWORD ***)(a1 + 8);
  v19 = **(_DWORD ***)(a2 + 8);
