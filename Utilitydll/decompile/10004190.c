/*
 * func-name: ?schedule_timer@Timer_Queue@Utility@Outpop@@QAEJAAV?$Smart_Ptr@VTimer_Handler@Utility@Outpop@@@23@ABVTime_Value@23@AAV?$Smart_Ptr@VRef_Object@Utility@Outpop@@@23@W4EDispatchType@23@PAVDispatch_Thread@23@@Z
 * func-address: 0x10004190
 * callers: none
 * callees: 0x10001730, 0x10001940, 0x10003590, 0x100043c0, 0x10005a90, 0x10005e10, 0x10008120, 0x100081f0, 0x1000b100, 0x1000e110
 */

int __thiscall Outpop::Utility::Timer_Queue::schedule_timer(int this, int *a2, _DWORD *a3, int *a4, int a5, int a6)
{
  ...
  _DWORD v23[2]; // [esp+24h] [ebp-38h] BYREF
  ...
  *v8 = 2;
  ...
  LOBYTE(v28) = 2;
  if ( v9 )
    v10 = sub_10003590(&Outpop::Utility::Time_Value::zero, v9, v21, a2, v25, 0, a4, a5, a6);
  else
    v10 = 0;
  LOBYTE(v28) = 0;
  if ( v10 )
