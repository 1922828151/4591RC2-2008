/*
 * func-name: sub_10006FD0
 * func-address: 0x10006fd0
 * callers: 0x100037a0, 0x10005d20
 * callees: 0x100072a0, 0x10007770, 0x10008310, 0x10010780, 0x10014070, 0x10019586
 */

unsigned int __stdcall sub_10006FD0(int a1, int a2)
{
  int v2; // esi
  int v3; // edx
  int v4; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  ...
  v16[8] = a2 + 4;
  v16[6] = a1 + 4;
  sub_10008310(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v19, a2 + 4, v7);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v22 = -1;
  v17 = **(_DWORD ***)(a1 + 8);
  v19 = **(_DWORD ***)(a2 + 8);
