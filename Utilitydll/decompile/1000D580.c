/*
 * func-name: sub_1000D580
 * func-address: 0x1000d580
 * callers: 0x1000d3c0
 * callees: 0x100072a0, 0x10007820, 0x10008e50
 */

int __stdcall sub_1000D580(int *a1, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
...
LABEL_49:
  ...
  v51 = sub_10008E50(a3, (int)v48, v48[1]);
  sub_10007820(1u, (int)(v3 + 1));
  v48[1] = v51;
  *(_DWORD *)v51[1] = v51;
  if ( !v47 )
    invalid_parameter_noinfo();
