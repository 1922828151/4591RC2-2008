/*
 * func-name: sub_100067F0
 * func-address: 0x100067f0
 * callers: 0x100028b0, 0x100037a0, 0x100058c0
 * callees: 0x100072a0, 0x10007650, 0x100082d0, 0x10010780, 0x10014070, 0x10018cf2, 0x10019586
 */

unsigned int __stdcall sub_100067F0(int a1, int a2)
{
  int v2; // esi
  int v3; // edx
  int v4; // ebx
  ...
  *(_DWORD *)(a1 + 12) = 0;
  ...
  v19[8] = a2 + 4;
  v19[6] = a1 + 4;
  sub_100082D0(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), a2 + 4, v22, a2 + 4, v10);
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v25 = -1;
  v20 = **(_DWORD ***)(a1 + 8);
  v22 = **(_DWORD ***)(a2 + 8);
