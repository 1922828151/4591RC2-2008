/*
 * func-name: sub_100139D8
 * func-address: 0x100139d8
 * callers: 0x1000b6dd
 * callees: 0x1000a47c, 0x1000b554, 0x100176c6, 0x1001814a
 */

int __cdecl sub_100139D8(int a1, int a2, struct localeinfo_struct *a3)
{
  int v3; // eax
