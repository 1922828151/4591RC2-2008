/*
 * func-name: sub_10003F20
 * func-address: 0x10003f20
 * callers: 0x10004820
 * callees: 0x1000a846
 */

char __cdecl sub_10003F20(int a1, int a2, int a3, double *a4, float *a5, int a6)
{
  int v6; // eax
  int v7; // ecx
  double v8; // st7
  double v9; // st7
  double v10; // st6
  unsigned __int8 (__stdcall *v11)(float *, int, float *, _DWORD, float *, float *, float *); // edx
  double v12; // st7
  char result; // al
  ...
  if ( *(_DWORD *)(a2 + 36) != 1 )
    _wassert(L"volume->GetType()==SWEPT_CAPSULE", L"..\\src\\CharacterController.cpp", 0x1ABu);
  if ( *(_DWORD *)a3 != 5 )
    _wassert(L"geom->mType==TOUCHED_CAPSULE", L"..\\src\\CharacterController.cpp", 0x1ACu);
  v27 = *(float *)(a2 + 40);
  v6 = *(_DWORD *)(a1 + 208);
  v7 = dword_10022760;
  v23 = 0.0;
  ...
  *(&v24 + v6) = *(&v24 + v6) - v8;
  ...
  v25 = v10 + v25;
  v26 = v16 + v26;
  v11 = *(unsigned __int8 (__stdcall **)(float *, int, float *, _DWORD, float *, float *, float *))(*(_DWORD *)v7 + 272);
  v18[0] = -*a5;
  v18[1] = -a5[1];
  v18[2] = -a5[2];
  if ( !v11(&v21, a3 + 32, v18, *(float *)(a6 + 36), &v17, v19, v20) )
    return 0;
  v12 = v17;
