/*
 * func-name: sub_101DE700
 * func-address: 0x101de700
 * callers: 0x10006cee
 * callees: 0x10006695, 0x1000f03d, 0x1000fff1, 0x10017143, 0x1001a708
 */

int __thiscall sub_101DE700(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1001A708(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_1000FFF1((int)v52, v52[1], a3);
  sub_10006695(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
