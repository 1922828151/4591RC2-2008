/*
 * func-name: ?StartSpawningParticles@Effect_LaserParticle@@UAEXXZ_0
 * func-address: 0x10082440
 * callers: 0x1000f434
 * callees: 0x102c0ed0
 */

void __thiscall Effect_LaserParticle::StartSpawningParticles(Effect_LaserParticle *this)
{
  int *v2; // esi
  int *v3; // eax
  int v4; // edx
