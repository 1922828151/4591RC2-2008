/*
 * func-name: sub_101C21E0
 * func-address: 0x101c21e0
 * callers: 0x100045d9
 * callees: 0x100035f8, 0x100038aa, 0x10005425
 */

int __thiscall sub_101C21E0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100035F8(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_100038AA((int)v49, v49[1], (int)a3);
  sub_10005425(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
