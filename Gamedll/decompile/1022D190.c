/*
 * func-name: ?DestroyInstance@FFunc_VehicleReceive@GameClient@@UAEXK@Z_0
 * func-address: 0x1022d190
 * callers: 0x10007284
 * callees: 0x1000676c, 0x1000a506
 */

void __thiscall GameClient::FFunc_VehicleReceive::DestroyInstance(
