/*
 * func-name: sub_101575D0
 * func-address: 0x101575d0
 * callers: 0x100039db
 * callees: 0x10002748, 0x1000637a, 0x10008a0d, 0x1000a6cd, 0x100102f8, 0x10019993, 0x102c9d86
 */

unsigned int __fastcall sub_101575D0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_10008A0D(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
