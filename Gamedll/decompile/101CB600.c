/*
 * func-name: ?OnBegin@UpdateAllStockObserver@GameClient@@UAEXAAVEvent@@@Z_0
 * func-address: 0x101cb600
 * callers: 0x10014542
 * callees: 0x10006947, 0x1000a506, 0x10012968, 0x102c9d50, 0x102c9ea8
 */

void __thiscall GameClient::UpdateAllStockObserver::OnBegin(GameClient::UpdateAllStockObserver *this, struct Event *a2)
{
  ...
  if ( Function )
  {
    ...
    if ( v9 )
    {
      ...
      (*(void (__thiscall **)(int, int *))(*(_DWORD *)v9 + 56))(v9, &v20);
      if ( v21 )
        operator delete(v21);
    }
  }
