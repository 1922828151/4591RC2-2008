/*
 * func-name: sub_100C8060
 * func-address: 0x100c8060
 * callers: 0x10018e71
 * callees: 0x100029cd, 0x102c09f0, 0x102c1270, 0x102c9ea2
 */

float *__cdecl sub_100C8060(float *a1, int *a2)
{
  int v2; // ecx
  int v3; // edx
  int v4; // eax
  ...
  *a1 = 0.0;
  ...
  v18 = v21;
  v19 = v22;
  v5 = (float *)sub_102C09F0(&v20, &v17, &v23);
  v14 = *v5;
  v15 = v5[1];
  v16 = v5[2];
  v6 = sub_102C09F0(&v20, &v14, &v17);
  v23 = *(float *)v6;
  v7 = v23;
  v24 = *(float *)(v6 + 4);
  v8 = v24;
