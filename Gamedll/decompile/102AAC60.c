/*
 * func-name: sub_102AAC60
 * func-address: 0x102aac60
 * callers: 0x10012ee0
 * callees: 0x10005547, 0x1000ada8, 0x10010bdb
 */

int __thiscall sub_102AAC60(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10010BDB(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10005547((int)v49, v49[1], (int)a3);
  sub_1000ADA8(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
