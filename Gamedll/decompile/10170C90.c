/*
 * func-name: sub_10170C90
 * func-address: 0x10170c90
 * callers: 0x100140c9
 * callees: 0x100071b2, 0x1000c3f1, 0x1000e20a
 */

int __thiscall sub_10170C90(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100071B2(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000E20A((int)v49, v49[1], (int)a3);
  sub_1000C3F1(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
