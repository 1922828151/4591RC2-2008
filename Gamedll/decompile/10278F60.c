/*
 * func-name: ?Initialize@CPasswordInputUI@@QAEXXZ_0
 * func-address: 0x10278f60
 * callers: 0x100148fd
 * callees: 0x102c9ea8
 */

void __thiscall CPasswordInputUI::Initialize(CPasswordInputUI *this)
{
  int v2; // eax
  ...
  *((_DWORD *)this + 184) = CPasswordInputUI::PasswordInputUIEvent;
  Control = CREDialog::GetControl(this, 13);
