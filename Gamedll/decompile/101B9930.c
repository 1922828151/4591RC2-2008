/*
 * func-name: sub_101B9930
 * func-address: 0x101b9930
 * callers: 0x100085a3
 * callees: 0x10006d66, 0x1000adc6, 0x1000dafd, 0x10014669
 */

void __stdcall sub_101B9930(Event *a1)
{
  struct BinStream *Stream; // eax
  int v2; // ecx
  int v3; // edx
  GameClient::SuspendVehicle *v4; // ecx
  ...
  GameClient::SuspendVehicle *v25; // [esp+10h] [ebp-74h]
  ...
  {
    v4 = *(GameClient::SuspendVehicle **)(v2 + *((_DWORD *)Stream + 1));
    *((_DWORD *)Stream + 3) = v3;
  }
  v22 = (unsigned int)v4;
  ...
  if ( Establishment )
  {
    ...
    GameClient::SuspendVehicle::OnUpdateMoveStatus(
      Establishment,
      v24,
      v10,
      v23,
