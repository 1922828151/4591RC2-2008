/*
 * func-name: sub_101DB900
 * func-address: 0x101db900
 * callers: 0x100015c8
 * callees: 0x1000af74, 0x1000f1fa, 0x10010573, 0x10012f17, 0x1001790e, 0x100194a2, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_101DB900(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_10010573(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_1000F1FA(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
