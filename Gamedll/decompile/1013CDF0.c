/*
 * func-name: sub_1013CDF0
 * func-address: 0x1013cdf0
 * callers: 0x10008a67
 * callees: 0x10006ca3, 0x1000f03d, 0x10014989, 0x10017143, 0x10019123
 */

int __thiscall sub_1013CDF0(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10006CA3(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_10014989((int)v52, v52[1], a3);
  sub_10019123(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
