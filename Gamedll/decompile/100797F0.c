/*
 * func-name: sub_100797F0
 * func-address: 0x100797f0
 * callers: 0x10009610
 * callees: 0x10004c82, 0x10005254, 0x1000e304, 0x10013836, 0x10014bc3, 0x100188e5, 0x102c9d86
 */

unsigned int __fastcall sub_100797F0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_100188E5(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
