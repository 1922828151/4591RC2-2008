/*
 * func-name: sub_101717A0
 * func-address: 0x101717a0
 * callers: 0x100124db
 * callees: 0x10007ba8, 0x1000c5c2, 0x10017783
 */

int __thiscall sub_101717A0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000C5C2(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10017783((int)v49, v49[1], (int)a3);
  sub_10007BA8(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
