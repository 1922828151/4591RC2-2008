/*
 * func-name: ?BindWheelFrames@PedrailVehicle@GameClient@@QAEXXZ_0
 * func-address: 0x101b7bb0
 * callers: 0x1000b3a7
 * callees: 0x10004dea, 0x100065ff, 0x100072bb, 0x10009fd9, 0x1000c789, 0x1000fe5c, 0x10015078
 */

void __thiscall GameClient::PedrailVehicle::BindWheelFrames(GameClient::PedrailVehicle *this)
{
  _DWORD *v2; // edi
  int v3; // eax
  int v4; // ecx
