/*
 * func-name: ?Tick@HookEsbSheild@@UAEXXZ_0
 * func-address: 0x1012edd0
 * callers: 0x10007793
 * callees: 0x1001371e, 0x102c9ea8
 */

void __thiscall HookEsbSheild::Tick(HookEsbSheild *this)
{
  Editor *v2; // eax
  int Actor; // eax
  int v4; // eax
  ...
  if ( Editor::GetEditorMode(v2) )
  {
    ...
    {
      v4 = World::FindActor(*((_DWORD *)this + 178), (char *)this + 1144);
