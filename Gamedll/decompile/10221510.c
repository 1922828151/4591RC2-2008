/*
 * func-name: sub_10221510
 * func-address: 0x10221510
 * callers: 0x100082b5
 * callees: 0x1000b1c7, 0x1000eda9, 0x10014939
 */

int __thiscall sub_10221510(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10014939(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000B1C7((int)v49, v49[1], (int)a3);
  sub_1000EDA9(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
