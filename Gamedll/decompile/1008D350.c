/*
 * func-name: ?Tick@Effect_MultiTexParticlesEx@@UAEXXZ_0
 * func-address: 0x1008d350
 * callers: 0x100161e9
 * callees: 0x10008f58, 0x10009200, 0x10018f9d, 0x102c0ed0, 0x102c9d50, 0x102c9d62, 0x102c9d98
 */

void __thiscall Effect_MultiTexParticlesEx::Tick(Effect_MultiTexParticlesEx *this)
{
  unsigned int i; // ebx
  int v3; // ecx
  int v4; // eax
  ...
  double v19; // st7
  int v20; // eax
  RandomTextureParticlesEx *v21; // edi
  int v22; // ecx
  int v23; // eax
  unsigned int j; // ebx
  int v25; // ecx
  ...
  double v39; // st7
  int v40; // eax
  RandomTextureParticlesEx *v41; // edi
  int v42; // [esp+8Ch] [ebp-1A4h] BYREF
  int *v43; // [esp+90h] [ebp-1A0h]
  float v44; // [esp+94h] [ebp-19Ch]
  float v45; // [esp+98h] [ebp-198h]
  float v46; // [esp+9Ch] [ebp-194h]
  float v47; // [esp+A0h] [ebp-190h]
  float v48; // [esp+A4h] [ebp-18Ch]
  float v49; // [esp+A8h] [ebp-188h]
  float v50; // [esp+ACh] [ebp-184h]
  float v51; // [esp+B0h] [ebp-180h]
  float v52; // [esp+B4h] [ebp-17Ch]
  float v53; // [esp+B8h] [ebp-178h]
  int v54; // [esp+BCh] [ebp-174h]
  const char *v55; // [esp+C0h] [ebp-170h]
  void *Destination; // [esp+D4h] [ebp-15Ch]
  void *v57; // [esp+D8h] [ebp-158h] BYREF
  void *v58; // [esp+DCh] [ebp-154h]
  int v59[3]; // [esp+E0h] [ebp-150h] BYREF
  int v60[3]; // [esp+ECh] [ebp-144h] BYREF
  _BYTE v61[12]; // [esp+F8h] [ebp-138h] BYREF
  _BYTE v62[12]; // [esp+104h] [ebp-12Ch] BYREF
  char Buffer[268]; // [esp+110h] [ebp-120h] BYREF
  int v64; // [esp+22Ch] [ebp-4h]
    ...
    *(float *)&Destination = 0.0;
    ...
    if ( v17 )
    {
      ...
      *(float *)&v57 = v19;
      ...
      v21 = RandomTextureParticlesEx::RandomTextureParticlesEx(
              (RandomTextureParticlesEx *)v17,
              *((_DWORD *)this + 178),
              -1,
              10.0,
              0,
    ...
    *(float *)&Destination = 0.0;
    ...
    if ( v37 )
    {
      ...
      *(float *)&v57 = v39;
      ...
      v41 = RandomTextureParticlesEx::RandomTextureParticlesEx(
              (RandomTextureParticlesEx *)v37,
              *((_DWORD *)this + 178),
              -1,
              10.0,
              0,
