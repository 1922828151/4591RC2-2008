/*
 * func-name: sub_100631F0
 * func-address: 0x100631f0
 * callers: 0x10010cda
 * callees: 0x10001483, 0x100018c5, 0x10006820, 0x10017512, 0x10018688, 0x100193b2, 0x102c9d86
 */

unsigned int __fastcall sub_100631F0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_10006820(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
