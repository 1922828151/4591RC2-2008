/*
 * func-name: sub_10067620
 * func-address: 0x10067620
 * callers: 0x10007ffe
 * callees: 0x1000b186, 0x1000c5c2, 0x1001039d, 0x10012bac, 0x10016f45, 0x100176bb, 0x102c9d86
 */

unsigned int __fastcall sub_10067620(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_100176BB(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
