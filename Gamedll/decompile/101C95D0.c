/*
 * func-name: sub_101C95D0
 * func-address: 0x101c95d0
 * callers: 0x1000da99
 * callees: 0x1000af10, 0x10016504, 0x10017729
 */

int __thiscall sub_101C95D0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10017729(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10016504((int)v49, v49[1], (int)a3);
  sub_1000AF10(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
