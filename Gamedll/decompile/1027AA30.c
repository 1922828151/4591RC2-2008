/*
 * func-name: ?OnBattleFieldInfoUpdated@CRadarMapUI@@QAEXJ@Z_0
 * func-address: 0x1027aa30
 * callers: 0x10017bde
 * callees: 0x1000516e, 0x1000a105, 0x102c8d6c, 0x102c9ea8
 */

void __thiscall CRadarMapUI::OnBattleFieldInfoUpdated(CRadarMapUI *this, int a2)
{
