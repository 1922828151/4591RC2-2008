/*
 * func-name: sub_101B7F10
 * func-address: 0x101b7f10
 * callers: 0x1000652d
 * callees: 0x1000adc6, 0x1000dafd, 0x100106d6, 0x10014669
 */

void __stdcall sub_101B7F10(Event *a1)
{
  struct BinStream *Stream; // eax
  int v2; // ecx
  int v3; // edx
  GameClient::PedrailVehicle *v4; // ecx
  ...
  GameClient::PedrailVehicle *v25; // [esp+10h] [ebp-74h]
  ...
  {
    v4 = *(GameClient::PedrailVehicle **)(v2 + *((_DWORD *)Stream + 1));
    *((_DWORD *)Stream + 3) = v3;
  }
  v22 = (unsigned int)v4;
  ...
  if ( Establishment )
  {
    ...
    GameClient::PedrailVehicle::OnUpdateMoveStatus(
      Establishment,
      v24,
      v10,
      v23,
