/*
 * func-name: sub_100FC8F0
 * func-address: 0x100fc8f0
 * callers: 0x10003adf
 * callees: 0x10001f46, 0x1000c9be, 0x1000f03d, 0x1000f24a, 0x10017143
 */

int __thiscall sub_100FC8F0(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000F24A(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_10001F46((int)v52, v52[1], a3);
  sub_1000C9BE(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
