/*
 * func-name: ?FlushParticles@Effect_LaserParticle@@UAEXXZ_0
 * func-address: 0x100824e0
 * callers: 0x10019597
 * callees: 0x102c0ed0
 */

void __thiscall Effect_LaserParticle::FlushParticles(Effect_LaserParticle *this)
{
  int *v2; // esi
  int *v3; // eax
  int v4; // edx
