 ...
 * callers: 0x10008b98
 * callees: 0x1000b55f, 0x1000f03d, 0x10013c7d, 0x10015276, 0x10017143
 */

int __thiscall sub_101032A0(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10013C7D(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_10015276((int)v52, v52[1], a3);
  sub_1000B55F(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
