/*
 * func-name: sub_10212BB0
 * func-address: 0x10212bb0
 * callers: 0x100128e1
 * callees: 0x102c9d86
 */

int __thiscall sub_10212BB0(int this, char *a2)
{
  ...
  if ( !Outpop::Utility::Stream_Base::get_readable((Outpop::Utility::Stream_Base *)this) )
  {
