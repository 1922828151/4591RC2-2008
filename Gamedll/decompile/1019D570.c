/*
 * func-name: ?OnBegin@CtlEsabTransformObserver@GameClient@@UAEXAAVEvent@@@Z_0
 * func-address: 0x1019d570
 * callers: 0x10003a80
 * callees: 0x1000adc6, 0x1000dafd, 0x10019e57
 */

void __thiscall GameClient::CtlEsabTransformObserver::OnBegin(
        GameClient::CtlEsabTransformObserver *this,
        struct Event *a2)
{
  ...
  if ( GameClient::EstabManager::GetEstablishment(v6, v9) )
  {
    ...
    {
      GameClient::ControlledEstab::SetCurrentTransState((int)a2);
    }
    else
    {
      v10 = *(_DWORD *)(v8 + *((_DWORD *)v7 + 1));
      *((_DWORD *)v7 + 3) = v8 + 4;
      GameClient::ControlledEstab::SetCurrentTransState(v10);
    }
  }
}
