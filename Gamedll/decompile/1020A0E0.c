/*
 * func-name: sub_1020A0E0
 * func-address: 0x1020a0e0
 * callers: 0x10003ec2
 * callees: 0x10003ee0, 0x1000615e, 0x100082ce
 */

int __thiscall sub_1020A0E0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000615E(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10003EE0((int)v49, v49[1], (int)a3);
  sub_100082CE(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
