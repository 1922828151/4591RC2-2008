/*
 * func-name: sub_101EEAD0
 * func-address: 0x101eead0
 * callers: 0x100092c8
 * callees: 0x1000560f, 0x100102d5, 0x10011cb6
 */

int __thiscall sub_101EEAD0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10011CB6(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_100102D5((int)v49, v49[1], (int)a3);
  sub_1000560F(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
