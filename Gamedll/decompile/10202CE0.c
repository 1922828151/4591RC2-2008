/*
 * func-name: sub_10202CE0
 * func-address: 0x10202ce0
 * callers: 0x1001a6ea
 * callees: 0x100033d2, 0x10009b7e, 0x1000d7e7
 */

int __thiscall sub_10202CE0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100033D2(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000D7E7((int)v49, v49[1], (int)a3);
  sub_10009B7E(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
