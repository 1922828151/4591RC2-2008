/*
 * func-name: ?FetchStock@Func_Store@GameClient@@QAE_NABV?$vector@UStockInfo@GameClient@@V?$allocator@UStockInfo@GameClient@@@std@@@std@@@Z_0
 * func-address: 0x101c52f0
 * callers: 0x10011725
 * callees: 0x1000549d, 0x1000b0ff
 */

char __thiscall GameClient::Func_Store::FetchStock(_DWORD *this, int a2)
{
  _DWORD *v2; // ebx
  unsigned int v3; // edi
  int v4; // ecx
  ...
  if ( sub_1000549D() )
  {
    while ( 1 )
    {
      ...
      if ( !v8 || v3 >= (*(_DWORD *)(a2 + 8) - v8) >> 3 )
        _invalid_parameter_noinfo();
      *(_DWORD *)(v6 + 12) -= *(_DWORD *)(*(_DWORD *)(a2 + 4) + v5 + 4);
      v9 = *(_DWORD *)(a2 + 4);
  ...
  for ( i = 0; (int)i < (int)v3; ++i )
  {
    ...
    if ( !v14 || i >= (*(_DWORD *)(a2 + 8) - v14) >> 3 )
      _invalid_parameter_noinfo();
    *(_DWORD *)(v19 + 12) += *(_DWORD *)(*(_DWORD *)(a2 + 4) + 8 * i + 4);
    v15 = *(_DWORD *)(a2 + 4);
