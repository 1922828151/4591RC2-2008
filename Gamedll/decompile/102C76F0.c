/*
 * func-name: sub_102C76F0
 * func-address: 0x102c76f0
 * callers: 0x102be010, 0x102be340
 * callees: 0x102c9d62
 */

void *__cdecl sub_102C76F0(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  int v9; // edi
  int v10; // eax
  int v11; // eax
