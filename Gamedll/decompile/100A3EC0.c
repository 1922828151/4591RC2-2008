/*
 * func-name: sub_100A3EC0
 * func-address: 0x100a3ec0
 * callers: 0x1000334b
 * callees: 0x10004dc2, 0x10009ac0, 0x1000e098, 0x10017bfc, 0x102c9d86
 */

int **__thiscall sub_100A3EC0(int *this, int **a2, char a3, int *a4, void *a5)
{
  int v6; // ebp
  int *v7; // eax
  int *v8; // eax
  ...
  v6 = sub_10017BFC(this[1], (int)a4, this[1], a5, 0);
  v7 = (int *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = (int *)(v6 + 4);
  for ( i = v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 44); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 44) )
      {
        ...
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 44) = 0;
        sub_10004DC2(*(_DWORD *)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 44) = 1;
