/*
 * func-name: ?OnUpdateMoveStatus@SuspendVehicle@GameClient@@QAEXKK_NABVVector@@ABVMatrix@@111@Z_0
 * func-address: 0x101b8ed0
 * callers: 0x10006d66
 * callees: 0x1001419b, 0x10019b41
 */

void __thiscall GameClient::SuspendVehicle::OnUpdateMoveStatus(
