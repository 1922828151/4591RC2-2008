/*
 * func-name: sub_1002EAB0
 * func-address: 0x1002eab0
 * callers: none
 * callees: 0x1002dc10, 0x1002de00, 0x102c9d98
 */

int __cdecl sub_1002EAB0(int a1, int a2)
{
  float *v3; // eax
  float v4; // ecx
  float v5; // edx
  ...
  v6 = 0;
  v7 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector___add__", &v6, &v7)
    || sub_1002DC10(&v9, v6, (const char **)dword_103B4E84, 1) == -1
    || sub_1002DC10(&v8, v7, (const char **)dword_103B4E84, 1) == -1 )
  {
    return 0;
  }
  v10 = *v8 + *v9;
