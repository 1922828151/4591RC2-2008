/*
 * func-name: sub_10200870
 * func-address: 0x10200870
 * callers: 0x10015da2
 * callees: 0x10009da4, 0x1000ff92, 0x10017b20
 */

int __thiscall sub_10200870(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10017B20(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000FF92((int)v49, v49[1], (int)a3);
  sub_10009DA4(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
