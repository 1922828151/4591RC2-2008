/*
 * func-name: sub_10168E40
 * func-address: 0x10168e40
 * callers: 0x1000d6e3
 * callees: 0x10007d65, 0x100080ee, 0x10009219, 0x1001282d, 0x100159ba, 0x10017bc5, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_10168E40(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_10017BC5(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_100080EE(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
