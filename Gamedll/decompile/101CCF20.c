/*
 * func-name: sub_101CCF20
 * func-address: 0x101ccf20
 * callers: 0x1000a04c
 * callees: 0x1000a083, 0x10010f9b, 0x10013f16
 */

int __thiscall sub_101CCF20(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10013F16(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000A083((int)v49, v49[1], (int)a3);
  sub_10010F9B(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
