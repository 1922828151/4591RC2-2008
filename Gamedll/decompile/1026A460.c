/*
 * func-name: ?SetEnergy@CDropBagUI@@IAEXKPBVFProductInfo@GameClient@@@Z_0
 * func-address: 0x1026a460
 * callers: 0x10008409
 * callees: 0x1000970a, 0x102c8d6c, 0x102c9ea8
 */

void __thiscall CDropBagUI::SetEnergy(CDropBagUI *this, unsigned int a2, const struct GameClient::FProductInfo *a3)
{
