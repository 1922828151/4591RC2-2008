/*
 * func-name: ?WriteSynaData@FAArmor@GameClient@@UAE_NAAVBinStream@@@Z_0
 * func-address: 0x10247210
 * callers: 0x100176ca
 * callees: 0x1000a3a8, 0x1000ed13, 0x1001990c
 */

char __thiscall GameClient::FAArmor::WriteSynaData(GameClient::FAArmor *this, struct BinStream *a2)
{
  unsigned int v3; // edx
  unsigned int v4; // eax
  int v5; // eax
