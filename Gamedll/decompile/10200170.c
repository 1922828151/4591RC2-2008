/*
 * func-name: sub_10200170
 * func-address: 0x10200170
 * callers: 0x10010ccb
 * callees: 0x10004c82, 0x1000aa47, 0x1000b7b2
 */

int __thiscall sub_10200170(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10004C82(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000AA47((int)v49, v49[1], (int)a3);
  sub_1000B7B2(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
