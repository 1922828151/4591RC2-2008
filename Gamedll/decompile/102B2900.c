/*
 * func-name: sub_102B2900
 * func-address: 0x102b2900
 * callers: 0x1000bb9a
 * callees: 0x102c9d86
 */

int __thiscall sub_102B2900(int this, char *a2)
{
  ...
  if ( Outpop::Utility::Stream_Base::get_readable((Outpop::Utility::Stream_Base *)this) < 8u )
  {
