/*
 * func-name: sub_100A3680
 * func-address: 0x100a3680
 * callers: 0x10016bee
 * callees: 0x10002699, 0x100063e8, 0x10009ac0, 0x10014952, 0x10015e2e, 0x10018f20, 0x102c9d50, 0x102c9d86
 */

_DWORD *__thiscall sub_100A3680(_DWORD *this, _DWORD *a2, int a3, void *a4)
{
  int v5; // edi
  int v6; // esi
  int v7; // eax
