/*
 * func-name: sub_101AF060
 * func-address: 0x101af060
 * callers: 0x10009575
 * callees: 0x1001560e, 0x10018e6c, 0x10019731
 */

int __thiscall sub_101AF060(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10019731(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001560E((int)v49, v49[1], (int)a3);
  sub_10018E6C(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
