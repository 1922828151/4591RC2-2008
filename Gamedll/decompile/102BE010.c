/*
 * func-name: sub_102BE010
 * func-address: 0x102be010
 * callers: none
 * callees: 0x102bd940, 0x102c76f0, 0x102c9d62
 */

float *__thiscall sub_102BE010(
        _DWORD *this,
        float *a2,
        int a3,
        int a4,
        ...
        int a16)
{
  ...
  char *v27; // eax
  char *v28; // eax
  void (__cdecl **v29)(int, const char *, int); // edi
  int v30; // eax
  ...
  LOBYTE(v52) = 1;
  sub_102BD940(this, v49, v32[0], v32[1], v32[2], v32[3], v32[4], v32[5], v33, v34, v35, v36, v37, v38, v39, v40);
  *a2 = 0.0;
  v40 = 0;
  a2[1] = 0.0;
  a2[2] = 0.0;
  ...
  v17 = sub_102C76F0(v45, v33, v34, v35, v36, v37, v38, v39, v40);
  LOBYTE(v52) = 4;
  ...
  v41 = &v33;
  std::string::string(&v33, v49);
  v19 = sub_102C76F0(v47, v33, v34, v35, v36, v37, v38, v39, v40);
  LOBYTE(v52) = 7;
  ...
  v41 = &v33;
  std::string::string(&v33, v49);
  v21 = sub_102C76F0(v46, v33, v34, v35, v36, v37, v38, v39, v40);
  LOBYTE(v52) = 10;
  ...
  *a2 = strtod(v23, (char **)v40);
  ...
  {
    v29 = *(void (__cdecl ***)(int, const char *, int))dword_103B9580;
    v40 = std::string::c_str(v49);
    v30 = std::string::c_str(&a3);
    (*v29)(dword_103B9580, "ConfigFile::GetVector: The value for the key '%s' was invalid: '%s'", v30);
    *a2 = 0.0;
    a2[1] = 0.0;
    a2[2] = 0.0;
  }
