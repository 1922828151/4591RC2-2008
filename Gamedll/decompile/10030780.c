/*
 * func-name: sub_10030780
 * func-address: 0x10030780
 * callers: none
 * callees: 0x1002dc10, 0x1002de00, 0x102c9d98
 */

int __cdecl sub_10030780(int a1, int a2)
{
  float *v3; // eax
  float v4; // edx
  float v5; // ecx
  ...
  v8 = 0;
  v9 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector4___add__", &v8, &v9)
    || sub_1002DC10(&v11, v8, (const char **)dword_103B4E80, 1) == -1
