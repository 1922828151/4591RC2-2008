/*
 * func-name: sub_1002FF60
 * func-address: 0x1002ff60
 * callers: none
 * callees: 0x10008c06, 0x1002dc10, 0x1002de00, 0x102c9d98
 */

int __cdecl sub_1002FF60(int a1, int a2)
{
  int *v3; // eax
  int v4; // esi
  int v5; // edi
  ...
  v3 = (int *)sub_10008C06((int)v12, v10);
  v4 = *v3;
  v5 = v3[1];
  v6 = v3[2];
