/*
 * func-name: sub_10030180
 * func-address: 0x10030180
 * callers: none
 * callees: 0x1002dc10, 0x1002de00, 0x102c9d98
 */

int __cdecl sub_10030180(int a1, int a2)
{
  float *v3; // eax
  float v4; // ecx
  float v5; // edx
  ...
  v6 = 0;
  v7 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector_HalfWay", &v6, &v7)
