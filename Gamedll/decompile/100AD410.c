/*
 * func-name: ?GetWorldBBox@ParticleSystem@@UAE?AVBBox@@XZ_0
 * func-address: 0x100ad410
 * callers: 0x10009f6b
 * callees: 0x100146be, 0x102c9dbc
 */

int __thiscall ParticleSystem::GetWorldBBox(float *this, int a2)
{
  double v2; // st7
  double v3; // st6
  double v4; // st5
  ...
  v8 = sqrt(v7);
  v9 = v8 * 0.5 * (v6 * v6) + (this[74] + this[69]) * v6;
  *(float *)&v10 = this[5] + v9;
