/*
 * func-name: sub_102B37A0
 * func-address: 0x102b37a0
 * callers: 0x100103a7
 * callees: 0x1000b7d0, 0x1000d1cf, 0x1001684c
 */

int __thiscall sub_102B37A0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000D1CF(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001684C((int)v49, v49[1], (int)a3);
  sub_1000B7D0(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
