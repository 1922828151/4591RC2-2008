/*
 * func-name: ?FlushParticles@Effect_ShadedParticles@@UAEXXZ_0
 * func-address: 0x10097540
 * callers: 0x10017341
 * callees: 0x102c0ed0
 */

void __thiscall Effect_ShadedParticles::FlushParticles(Effect_ShadedParticles *this)
{
  int v2; // eax
  FXManager *v3; // eax
  ...
  if ( v2 )
  {
    ...
    if ( FXSystemFromHash )
    {
      ...
      *((_BYTE *)v5 + 112) = *((_BYTE *)this + 816);
      (*(void (__thiscall **)(struct FXSystem *))(v7 + 44))(v5);
    }
  }
}
