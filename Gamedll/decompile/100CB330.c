/*
 * func-name: ?Tick@RandomTextureTraceLineEx@@UAEXXZ_0
 * func-address: 0x100cb330
 * callers: 0x10012be3
 * callees: none
 */

void __thiscall RandomTextureTraceLineEx::Tick(RandomTextureTraceLineEx *this)
{
  double v1; // st7
  bool v3; // zf
  unsigned int v4; // ebp
  ...
  if ( *((int *)this + 48) > 0 )
  {
    ...
    do
    {
      ...
      *(float *)(v7 + 64) = v11;
      if ( v11 <= 0.0 && v10 )
      {
        (*(void (__thiscall **)(RandomTextureTraceLineEx *, int))(*(_DWORD *)this + 20))(this, v7);
      ...
      *(float *)(v7 + 68) = *((float *)this + 102) * v1 + *(float *)(v7 + 68);
  ...
  if ( v10 )
  {
    while ( 1 )
    {
      ...
      if ( !v9 || v8 >= (*((_DWORD *)this + 46) - v9) / 184 )
        _invalid_parameter_noinfo();
      (*(void (__thiscall **)(RandomTextureTraceLineEx *, unsigned int))(*(_DWORD *)this + 20))(
        this,
