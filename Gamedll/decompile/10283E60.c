/*
 * func-name: ?SetSubWeapon@CRobotRoofUI@@AAEXHK@Z_0
 * func-address: 0x10283e60
 * callers: 0x100160e0
 * callees: 0x10003ca1, 0x1000aff6, 0x10010389, 0x100104e2, 0x1001241d, 0x10012c29, 0x100131c9, 0x102c8d6c, 0x102c9ea8
 */

void __thiscall CRobotRoofUI::SetSubWeapon(CRobotRoofUI *this, unsigned int a2, unsigned int a3)
{
  int v4; // ebx
  ...
  unsigned int v46; // [esp+10h] [ebp-6Ch]
  int v47; // [esp+10h] [ebp-6Ch]
  int v48; // [esp+28h] [ebp-54h]
  int v49; // [esp+2Ch] [ebp-50h] BYREF
  int v50; // [esp+30h] [ebp-4Ch] BYREF
  int v51; // [esp+34h] [ebp-48h]
  _BYTE v52[28]; // [esp+38h] [ebp-44h] BYREF
  _BYTE v53[28]; // [esp+54h] [ebp-28h] BYREF
  ...
  if ( a3 != -1 )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( *(_DWORD *)(v9 + 4 * i) != -1 && i != *((_DWORD *)this + 1003) )
      {
        ...
        v44 = *(_DWORD *)(*((_DWORD *)this + 983) + 4 * i);
        v10 = GameClient::FlyweightManager::Instance();
        v4 += *((_DWORD *)GameClient::FlyweightManager::GetFlyweight(v10, v44) + 51);
      }
    }
    for ( j = 0; ; ++j )
    {
      ...
      if ( *(_DWORD *)(v13 + 4 * j) != -1 )
      {
        if ( !v13 || j >= (*((_DWORD *)this + 988) - v13) >> 2 )
          _invalid_parameter_noinfo();
        v45 = *(_DWORD *)(*((_DWORD *)this + 987) + 4 * j);
        v14 = GameClient::FlyweightManager::Instance();
        v4 += *((_DWORD *)GameClient::FlyweightManager::GetFlyweight(v14, v45) + 51);
      }
    }
    v48 = v4;
    ...
    v51 = *((_DWORD *)v16 + 51);
    if ( !v17 || v18 >= (*((_DWORD *)this + 988) - v17) >> 2 )
      _invalid_parameter_noinfo();
    v19 = *((_DWORD *)this + 987);
    v20 = *(_DWORD *)(v19 + 4 * v18);
    v21 = *((_DWORD *)this + 1003);
    if ( !v19 || v21 >= (*((_DWORD *)this + 988) - v19) >> 2 )
      _invalid_parameter_noinfo();
    *(_DWORD *)(*((_DWORD *)this + 987) + 4 * v21) = -1;
    ...
    if ( !v23 || v24 >= (*((_DWORD *)this + 988) - v23) >> 2 )
      _invalid_parameter_noinfo();
    *(_DWORD *)(*((_DWORD *)this + 987) + 4 * v24) = v20;
    v26 = (CREStatic *)*((_DWORD *)this + 972);
    if ( !v25 )
    {
      CREStatic::SetText(v26, word_10322F80);
      return;
    }
    if ( v51 >= v48 )
    {
      CREStatic::SetText(v26, word_10322F98);
      return;
    }
    CREStatic::SetText(v26, word_10322FB8);
  }
  if ( CItemHolder::GetXYByPos(*((CItemHolder **)this + 970), a2, &v50, &v49) )
  {
    v27 = *((_DWORD *)this + 987);
    if ( v27 )
      v28 = (*((_DWORD *)this + 988) - v27) >> 2;
    else
      v28 = 0;
    if ( v28 < a2 + 1 )
      sub_10003CA1((char *)this + 3944, a2 + 1, -1);
    v29 = *((_DWORD *)this + 987);
    if ( v29 && a2 < (*((_DWORD *)this + 988) - v29) >> 2 )
    {
    ...
    *(_DWORD *)(*((_DWORD *)this + 987) + 4 * a2) = a3;
    CItemHolder::SetItem(*((CItemHolder **)this + 970), v50, v49, 0);
    if ( a3 == -1 )
    {
      v41 = *((_DWORD *)this + 1000);
      v40 = a2 + 3;
      if ( !v41 || v40 >= (*((_DWORD *)this + 1001) - v41) >> 2 )
        v30();
      v47 = 0;
    }
    else
    {
      ...
      if ( v33 )
      {
        ...
        ProductInfo = GameClient::ProductManager::GetProductInfo(v34, v46);
        if ( ProductInfo )
        {
          std::wstring::wstring(v53, &unk_10322FBC);
          v54 = 0;
          v36 = (const char *)std::string::c_str((char *)ProductInfo + 176);
          v37 = atow(v36);
          std::wstring::wstring(v52, v37);
          v38 = *((_DWORD *)this + 970);
          LOBYTE(v54) = 1;
          CItemHolder::InsertItem(v38, v50, v49, v52, 0, &unk_103B40DC, -1, v53);
          LOBYTE(v54) = 0;
      ...
      v40 = a2 + 3;
      if ( !v39 || v40 >= (*((_DWORD *)this + 1001) - v39) >> 2 )
        v30();
      v47 = 1;
    }
    v42 = *(_DWORD *)(*((_DWORD *)this + 1000) + 4 * v40);
    (*(void (__thiscall **)(int, int))(*(_DWORD *)v42 + 136))(v42, v47);
