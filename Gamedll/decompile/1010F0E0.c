/*
 * func-name: sub_1010F0E0
 * func-address: 0x1010f0e0
 * callers: 0x10015384
 * callees: 0x100043c7, 0x1000af60, 0x1000fecf, 0x1001186f, 0x1001822d, 0x1001a663, 0x102c9d86
 */

unsigned int __fastcall sub_1010F0E0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  v24 = *(_DWORD *)(v29 + 8);
  v28 = a1 + 16;
  sub_1001822D(v7, v29 + 4, v24);
  *(_DWORD *)(a1 + 32) = *(_DWORD *)(a3 + 32);
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  sub_1000FECF(v25[0], v25[1]);
  v23 = *(int **)(a3 + 8);
  v22 = *v23;
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1001A663(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
