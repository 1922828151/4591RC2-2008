/*
 * func-name: sub_10062CD0
 * func-address: 0x10062cd0
 * callers: 0x1000ee5d
 * callees: 0x100015eb, 0x10004863, 0x10008f44, 0x100092b4, 0x100108e8, 0x10016a54, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_10062CD0(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_10016A54(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_100015EB(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
