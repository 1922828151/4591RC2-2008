/*
 * func-name: sub_1011C640
 * func-address: 0x1011c640
 * callers: 0x10019114
 * callees: 0x10001a00, 0x1000b41f, 0x1000c162, 0x1000f03d, 0x10017143
 */

int __thiscall sub_1011C640(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000C162(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
    ...
    while ( 1 )
    {
      ...
      if ( v66 == (int *)v65[1] )
        _invalid_parameter_noinfo();
      if ( (this[8] & sub_10017143((int)(v66 + 2))) == v63 )
      {
        if ( v66 == (int *)v65[1] )
          _invalid_parameter_noinfo();
        v12 = v63;
...
LABEL_49:
  ...
  v43 = (int *)std::string::end(a3, v72);
  v44 = (int *)std::string::begin(a3, v70);
  v45 = sub_1000F03D(*v44, v44[1], *v43, v43[1]);
  v46 = ldiv(v45, 127773);
  v47 = (16807 * v46.rem - 2836 * v46.quot + (16807 * v46.rem - 2836 * v46.quot < 0 ? 0x7FFFFFFF : 0)) & v3[8];
  v62 = v47;
  if ( v3[9] <= v47 )
  {
    v47 += -1 - ((unsigned int)v3[8] >> 1);
    v62 = v47;
  }
  v48 = v3[5];
  v64 = v47;
  ...
  v55 = sub_10001A00((int)v52, v52[1], a3);
  sub_1000B41F(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
