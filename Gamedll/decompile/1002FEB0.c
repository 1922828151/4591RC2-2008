/*
 * func-name: sub_1002FEB0
 * func-address: 0x1002feb0
 * callers: none
 * callees: 0x1002dc10
 */

int __cdecl sub_1002FEB0(int a1, int a2)
{
  ...
  v3 = 0;
  v4 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector_CosAngle", &v3, &v4)
