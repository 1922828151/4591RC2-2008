/*
 * func-name: sub_100E1B90
 * func-address: 0x100e1b90
 * callers: 0x1001619e
 * callees: 0x10003c42, 0x10009ac0, 0x1000b03c, 0x1000cff4, 0x102c9d86
 */

int **__thiscall sub_100E1B90(int *this, int **a2, char a3, int *a4, int a5)
{
  int v6; // ebp
  int *v7; // eax
  int *v8; // eax
  ...
  v6 = sub_10003C42(this[1], (int)a4, this[1], a5, 0);
  v7 = (int *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
    ...
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 20) )
      {
        ...
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 20) = 0;
        sub_1000B03C(*(_DWORD *)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 20) = 1;
