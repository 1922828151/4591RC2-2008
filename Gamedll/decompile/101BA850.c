/*
 * func-name: ?OnUpdateMoveStatus@WheelVehicle@GameClient@@QAEXKK_NABVVector@@ABVMatrix@@111@Z_0
 * func-address: 0x101ba850
 * callers: 0x10007455
 * callees: 0x1001419b, 0x10019b41
 */

void __thiscall GameClient::WheelVehicle::OnUpdateMoveStatus(
