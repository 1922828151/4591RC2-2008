/*
 * func-name: sub_10156C40
 * func-address: 0x10156c40
 * callers: 0x1000f407
 * callees: 0x10002748, 0x1000ca9f, 0x1001064f
 */

int __thiscall sub_10156C40(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10002748(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000CA9F((int)v49, v49[1], (int)a3);
  sub_1001064F(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
