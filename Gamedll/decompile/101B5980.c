/*
 * func-name: sub_101B5980
 * func-address: 0x101b5980
 * callers: 0x10018dcc
 * callees: 0x1000a67d, 0x1000de22, 0x10011955, 0x10016103, 0x100178e6, 0x10018b1f, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_101B5980(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_1000DE22(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_10016103(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
