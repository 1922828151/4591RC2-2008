/*
 * func-name: sub_1002EDC0
 * func-address: 0x1002edc0
 * callers: none
 * callees: 0x1000bbb3, 0x1002dc10
 */

int __cdecl sub_1002EDC0(int a1, int a2)
{
  ...
  v4 = 0;
  v5 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector___ne__", &v4, &v5)
