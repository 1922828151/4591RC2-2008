/*
 * func-name: sub_1002FA70
 * func-address: 0x1002fa70
 * callers: none
 * callees: 0x1002dc10
 */

int __cdecl sub_1002FA70(int a1, int a2)
{
  _DWORD *v3; // [esp+8h] [ebp-8h] BYREF
  float v4; // [esp+Ch] [ebp-4h] BYREF

  v3 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **))PyArg_ParseTuple)(a2, "O:Vector_DotSelf", &v3)
