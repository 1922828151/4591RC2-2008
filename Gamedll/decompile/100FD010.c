/*
 * func-name: sub_100FD010
 * func-address: 0x100fd010
 * callers: 0x10007c89
 * callees: 0x100063fc, 0x1000645b, 0x100081d9, 0x1000f24a, 0x10015cd5, 0x10018c50, 0x102c9d86
 */

unsigned int __fastcall sub_100FD010(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1000645B(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
