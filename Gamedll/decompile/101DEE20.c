/*
 * func-name: sub_101DEE20
 * func-address: 0x101dee20
 * callers: 0x10015b4f
 * callees: 0x1000df67, 0x1001005a, 0x1001a1f9
 */

int __thiscall sub_101DEE20(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000DF67(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001A1F9((int)v49, v49[1], (int)a3);
  sub_1001005A(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
