/*
 * func-name: sub_1016BEA0
 * func-address: 0x1016bea0
 * callers: 0x100103e8
 * callees: 0x100036f2, 0x10014f01, 0x10019367
 */

int __thiscall sub_1016BEA0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100036F2(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10014F01((int)v49, v49[1], (int)a3);
  sub_10019367(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
