/*
 * func-name: ?OnReadVarComplete@FWheelVehicle@GameClient@@UAEXXZ_0
 * func-address: 0x10245c70
 * callers: 0x10008fad
 * callees: 0x100026bc, 0x1000a795, 0x1000aff6, 0x1001789b, 0x102c9ea8
 */

void __thiscall GameClient::FWheelVehicle::OnReadVarComplete(GameClient::FWheelVehicle *this)
{
  unsigned int v2; // edi
  int i; // ebx
  int v4; // eax
  ...
  for ( i = 0; ; i += 28 )
  {
    ...
    if ( Flyweight )
    {
      ...
      v15 = _RTDynamicCast(
              ...
              &GameClient::FWheelVehicleWheel `RTTI Type Descriptor');
      if ( v15 )
        sub_100026BC((char *)this + 1156, (int)&v15);
    }
    ++v2;
  }
}
