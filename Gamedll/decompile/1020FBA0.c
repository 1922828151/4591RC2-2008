/*
 * func-name: sub_1020FBA0
 * func-address: 0x1020fba0
 * callers: 0x100042eb
 * callees: 0x1000232e, 0x10008cec, 0x1001a541
 */

int __thiscall sub_1020FBA0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000232E(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001A541((int)v49, v49[1], (int)a3);
  sub_10008CEC(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
