/*
 * func-name: sub_101D6980
 * func-address: 0x101d6980
 * callers: 0x100029d2
 * callees: 0x10001e38, 0x10003fdf, 0x100123d7
 */

int __thiscall sub_101D6980(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10003FDF(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10001E38((int)v49, v49[1], (int)a3);
  sub_100123D7(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
