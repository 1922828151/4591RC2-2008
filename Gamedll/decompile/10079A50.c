/*
 * func-name: sub_10079A50
 * func-address: 0x10079a50
 * callers: 0x1000634d
 * callees: 0x100033d2, 0x10006d7a, 0x1000a2a4, 0x1000d738, 0x1001a31b, 0x1001a4fb, 0x102c9d86
 */

unsigned int __fastcall sub_10079A50(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1000D738(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
