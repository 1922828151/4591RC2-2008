/*
 * func-name: sub_10201F80
 * func-address: 0x10201f80
 * callers: 0x10001e29
 * callees: 0x10002996, 0x10010ccb
 */

int __thiscall sub_10201F80(_DWORD *this, int *a2)
{
  _DWORD *v3; // edi
  int v4; // ebp
  int v5; // edx
  ...
  if ( v10 == v12 )
  {
    ...
    LOBYTE(v16) = 1;
    v7 = (_DWORD *)sub_10010CCB((int)v11, (int)&v14);
    v3 = (_DWORD *)*v7;
    v4 = v7[1];
    LOBYTE(v16) = 0;
