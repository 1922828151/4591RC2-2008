/*
 * func-name: sub_101CE000
 * func-address: 0x101ce000
 * callers: 0x10006271
 * callees: 0x10004f0c, 0x10006947, 0x1000a506
 */

void __stdcall sub_101CE000(Event *a1)
{
  ...
  if ( Function && *((_DWORD *)Function + 10) == 5 )
  {
    ...
    v13 = v10;
    GameClient::Func_Power::SetEnergy(v7, v13);
  }
}
