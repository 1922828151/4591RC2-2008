/*
 * func-name: sub_100546C0
 * func-address: 0x100546c0
 * callers: 0x10011630
 * callees: 0x1000267b, 0x10004c50, 0x1000b5b9, 0x1000fc54, 0x100134da, 0x10013ca0, 0x10016d1f, 0x10017ed1, 0x1001a3d4, 0x102c9d50
 */

unsigned int __thiscall sub_100546C0(
        unsigned int *this,
        unsigned int *a2,
        char *Source,
        int a4,
  ...
  if ( v10 )
  {
    ...
    if ( v11 >= v10 + v13 )
    {
      ...
      if ( (int)(v23 - (_DWORD)Source) >> 2 >= v10 )
      {
        ...
        return sub_100134DA(a4, a5, a6, a7, v24);
      }
      else
      {
        v25 = 4 * v10;
        ...
        sub_1000B5B9((int)&v35, v26);
        v27 = v36;
        sub_1000FC54(v35, v36, a6, a7, (void *)this[2]);
        v28 = v35;
        v29 = a5;
        v30 = a4;
        this[2] += v25;
        return sub_100134DA(v30, v29, v28, (int)v27, v24);
      }
    }
    else
    {
      ...
      v19 = (void *)sub_1000FC54(a4, a5, a6, a7, v18);
