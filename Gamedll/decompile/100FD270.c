/*
 * func-name: sub_100FD270
 * func-address: 0x100fd270
 * callers: 0x100189c6
 * callees: 0x10003099, 0x10009548, 0x1000a79f, 0x1000ca45, 0x10012553, 0x1001680b, 0x102c9d86
 */

unsigned int __fastcall sub_100FD270(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_10009548(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
