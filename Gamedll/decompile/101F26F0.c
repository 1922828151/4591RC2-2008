/*
 * func-name: sub_101F26F0
 * func-address: 0x101f26f0
 * callers: 0x1000432c
 * callees: 0x102c9d86
 */

int *__thiscall sub_101F26F0(int *this, const char *a2)
{
  DWORD LastError; // eax
  int v4; // edi
  ...
  if ( Outpop::Utility::Stream_Base::get_space((Outpop::Utility::Stream_Base *)this) < 2u )
  {
    v4 = *this;
    size = Outpop::Utility::Stream_Base::get_size((Outpop::Utility::Stream_Base *)this);
    (*(void (__thiscall **)(int *, unsigned int))(v4 + 16))(this, size + 130);
  }
  v6 = Outpop::Utility::OS_Buffer::write((Outpop::Utility::OS_Buffer *)this[2], a2, this[3], 2);
  if ( v6 == -1 )
  {
