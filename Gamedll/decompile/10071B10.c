/*
 * func-name: sub_10071B10
 * func-address: 0x10071b10
 * callers: 0x10007621
 * callees: 0x1000270c, 0x10003882, 0x10009ac0, 0x10011757, 0x10016a8b, 0x10018859, 0x102c9d50, 0x102c9d86
 */

_DWORD *__thiscall sub_10071B10(_DWORD *this, _DWORD *a2, int a3, void *a4)
{
  int v5; // edi
  int v6; // esi
  int v7; // eax
