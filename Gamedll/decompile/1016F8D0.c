/*
 * func-name: sub_1016F8D0
 * func-address: 0x1016f8d0
 * callers: 0x1001213e
 * callees: 0x100102c6, 0x100161c1, 0x10016a54
 */

int __thiscall sub_1016F8D0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10016A54(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_100161C1((int)v49, v49[1], (int)a3);
  sub_100102C6(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
