/*
 * func-name: sub_101DF540
 * func-address: 0x101df540
 * callers: 0x10013d2c
 * callees: 0x10006cee, 0x10009980
 */

int __thiscall sub_101DF540(_DWORD *this, void *a2)
{
  _DWORD *v3; // edi
  int v4; // ebx
  _DWORD *v5; // eax
  ...
  if ( v8 == v10 )
  {
    ...
    v12 = 0;
    v13 = 0;
    v5 = (_DWORD *)sub_10006CEE((int)&v9, v11);
    v3 = (_DWORD *)*v5;
    v4 = v5[1];
    v13 = -1;
