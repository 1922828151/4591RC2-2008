/*
 * func-name: ?Move@SuspendVehicle@GameClient@@QAEXKK_N@Z_0
 * func-address: 0x101b9330
 * callers: 0x10017184
...
void __thiscall GameClient::SuspendVehicle::Move(
  ...
  if ( v5 )
  {
    ...
    else
    {
      ...
      *((_BYTE *)this + 552) = v6;
      ...
      sub_100077ED((int)&v29, 9, 0, COERCE_INT(0.0), 1, 512);
      v18 = *(_DWORD *)(v15 + 88);
      v32 = a3;
      v19 = *((_DWORD *)this + 134);
      v30 = a2;
