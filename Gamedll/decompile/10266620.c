/*
 * func-name: sub_10266620
 * func-address: 0x10266620
 * callers: 0x10015546
 * callees: 0x100125b7, 0x100138d6, 0x10013c1e
 */

int __thiscall sub_10266620(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10013C1E(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_100125B7((int)v49, v49[1], (int)a3);
  sub_100138D6(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
