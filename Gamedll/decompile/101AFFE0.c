/*
 * func-name: ??4FPedrailVehicle@GameClient@@QAEAAV01@ABV01@@Z_0
 * func-address: 0x101affe0
 * callers: 0x10002536
 * callees: 0x1000d5c1, 0x1001663f, 0x10018836, 0x1001a1fe
 */

int __thiscall GameClient::FPedrailVehicle::operator=(int this, int a2)
{
  ...
  *(_DWORD *)(this + 1136) = *(_DWORD *)(a2 + 1136);
  ...
  sub_1001663F(a2 + 1156);
  sub_1000D5C1(a2 + 1172);
  sub_1000D5C1(a2 + 1188);
  sub_10018836(a2 + 1204);
  sub_1000D5C1(a2 + 1220);
  std::string::operator=(this + 1236, a2 + 1236);
  std::string::operator=(this + 1264, a2 + 1264);
  std::string::operator=(this + 1292, a2 + 1292);
  std::string::operator=(this + 1320, a2 + 1320);
