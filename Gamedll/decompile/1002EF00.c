/*
 * func-name: sub_1002EF00
 * func-address: 0x1002ef00
 * callers: none
 * callees: 0x1002dc10
 */

// write access to const memory has been detected, the output may be wrong!
int __cdecl sub_1002EF00(int a1, int a2)
{
  float *v3; // eax
  float *v4; // ecx
  ...
  v5 = 0;
  v6 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector___iadd__", &v5, &v6)
