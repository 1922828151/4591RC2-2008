/*
 * func-name: sub_102B1FA0
 * func-address: 0x102b1fa0
 * callers: 0x10007a7c
 * callees: 0x10003ae9, 0x1000ad21, 0x100162a7
 */

int __thiscall sub_102B1FA0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100162A7(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10003AE9((int)v49, v49[1], (int)a3);
  sub_1000AD21(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
