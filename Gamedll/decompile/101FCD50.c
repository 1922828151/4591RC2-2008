/*
 * func-name: sub_101FCD50
 * func-address: 0x101fcd50
 * callers: 0x1000a5bf
 * callees: 0x10007bd0, 0x10009ac0, 0x1000bf7d, 0x10018110, 0x102c9d86
 */

int **__thiscall sub_101FCD50(int *this, int **a2, char a3, int *a4, int a5)
{
  int v6; // ebp
  int *v7; // eax
  int *v8; // eax
  ...
  v6 = sub_10007BD0(this[1], (int)a4, this[1], a5, 0);
  v7 = (int *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = (int *)(v6 + 4);
  for ( i = v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 16); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 16) )
      {
        ...
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 16) = 0;
        sub_1000BF7D(*(_DWORD *)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 16) = 1;
