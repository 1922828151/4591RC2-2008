/*
 * func-name: sub_101AE950
 * func-address: 0x101ae950
 * callers: 0x100080da
 * callees: 0x10006096, 0x1000d0bc, 0x1001131a
 */

int __thiscall sub_101AE950(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000D0BC(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001131A((int)v49, v49[1], (int)a3);
  sub_10006096(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
