/*
 * func-name: sub_102A67A0
 * func-address: 0x102a67a0
 * callers: 0x100045f7
 * callees: 0x1000d10c, 0x1000e56b, 0x10010a32, 0x10013eb7, 0x10015eab
 */

void __stdcall sub_102A67A0(Outpop::Utility::Ref_Object *a1, int a2)
{
  ...
  if ( User )
  {
    sub_1000D10C((int)&a1, 13, 13004, (int)v2, 0, 512);
    sub_10015EAB((int)&a2);
