/*
 * func-name: ?Hide@CMiniWorldMapUI@@QAEXXZ_0
 * func-address: 0x10277b90
 * callers: 0x10009bb0
 * callees: none
 */

void __thiscall CMiniWorldMapUI::Hide(CMiniWorldMapUI *this)
{
  int v2; // ebx
  int v3; // edi
  int v4; // eax
  ...
  *((_BYTE *)this + 3868) = 1;
  v7(this);
  (*(void (__thiscall **)(_DWORD, int))(**((_DWORD **)this + 970) + 136))(*((_DWORD *)this + 970), 1);
