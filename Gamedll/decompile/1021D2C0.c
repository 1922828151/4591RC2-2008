/*
 * func-name: ?RequestMapStatus@BattleFieldManager@GameClient@@QAEXJ@Z_0
 * func-address: 0x1021d2c0
 * callers: 0x1000aa42
 * callees: 0x1000194c, 0x1000e56b, 0x10013eb7, 0x10015eab
 */

void __thiscall GameClient::BattleFieldManager::RequestMapStatus(GameClient::BattleFieldManager *this, int a2)
{
  int v2; // edi
  ...
  if ( v2 )
  {
    ...
    v9 = 1;
    Outpop::Message::Message::set_protocol_catalog(v8[0], 0x12u);
    Outpop::Message::Message::set_protocol_type(v8[0], 0x4665u);
    sub_10015EAB((int)&a2);
