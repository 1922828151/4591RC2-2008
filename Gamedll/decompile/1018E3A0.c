/*
 * func-name: sub_1018E3A0
 * func-address: 0x1018e3a0
 * callers: 0x10015bd6
 * callees: 0x10006f73, 0x1001741d, 0x10017d3c
 */

int __thiscall sub_1018E3A0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10006F73(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1001741D((int)v49, v49[1], (int)a3);
  sub_10017D3C(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
