/*
 * func-name: sub_10156530
 * func-address: 0x10156530
 * callers: 0x10003440
 * callees: 0x1000c74d, 0x10016d6f, 0x100179c7
 */

int __thiscall sub_10156530(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100179C7(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10016D6F((int)v49, v49[1], (int)a3);
  sub_1000C74D(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
