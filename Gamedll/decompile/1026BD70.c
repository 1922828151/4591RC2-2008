/*
 * func-name: ?RefreshEquipCount@CDropBagUI@@IAEXXZ_0
 * func-address: 0x1026bd70
 * callers: 0x1001607c
 * callees: 0x10003ca1, 0x1000aff6, 0x100103c0, 0x10012c29, 0x10015834, 0x102c9ea8
 */

void __thiscall CDropBagUI::RefreshEquipCount(CDropBagUI *this)
{
  GameClient::FlyweightManager *v2; // eax
  struct GameClient::Flyweight *Flyweight; // edi
  GameClient::FlyweightManager *v4; // eax
  struct GameClient::Flyweight *v5; // ebx
  struct GameClient::FSystemPart *v6; // ebp
  int v7; // eax
  int v8; // ebx
  int v9; // eax
  int v10; // edi
  ...
  if ( *((_DWORD *)this + 968) == -1 || *((_DWORD *)this + 969) == -1 )
    return;
  v24 = *((_DWORD *)this + 968);
  ...
  if ( v6 && v7 )
  {
    sub_10003CA1((char *)this + 3884, *(_DWORD *)(v7 + 332) + *((_DWORD *)v6 + 76), -1);
    sub_10003CA1((char *)this + 3900, *(_DWORD *)(v8 + 332) + *((_DWORD *)v6 + 76), -1);
    CItemHolder::SetMaxItem(*((CItemHolder **)this + 987), *(_DWORD *)(v8 + 332) + *((_DWORD *)v6 + 76));
    v9 = *((_DWORD *)this + 972);
    if ( v9 )
    {
      v10 = (*((_DWORD *)this + 973) - v9) >> 2;
      if ( v10 >= 3 )
      {
LABEL_12:
        sub_10003CA1((char *)this + 3916, *(_DWORD *)(v8 + 336) + retaddr[77], -1);
        sub_10003CA1((char *)this + 3932, *(_DWORD *)(v8 + 336) + retaddr[77], -1);
        CItemHolder::SetMaxItem(*((CItemHolder **)this + 988), *(_DWORD *)(v8 + 336) + retaddr[77]);
        v13 = *((_DWORD *)this + 980);
        if ( v13 )
          v14 = (*((_DWORD *)this + 981) - v13) >> 2;
        else
          v14 = 0;
        for ( i = v14 + 3; ; ++i )
        {
          v16 = *((_DWORD *)this + 998);
          if ( !v16 || i >= (*((_DWORD *)this + 999) - v16) >> 2 )
            break;
          v17 = *(_DWORD *)(*((_DWORD *)this + 998) + 4 * i);
    ...
    {
      v11 = *((_DWORD *)this + 998);
      if ( !v11 || v10 >= (unsigned int)((*((_DWORD *)this + 999) - v11) >> 2) )
        _invalid_parameter_noinfo();
      v12 = *(_DWORD *)(*((_DWORD *)this + 998) + 4 * v10);
...
LABEL_19:
  ...
  {
    v19 = *((_DWORD *)this + 972);
    if ( !v19 || j >= (*((_DWORD *)this + 973) - v19) >> 2 )
      break;
    v20 = *((_DWORD *)this + 972);
    if ( *(_DWORD *)(4 * j + v20) != -1 )
    {
      if ( !v20 || j >= (*((_DWORD *)this + 973) - v20) >> 2 )
        _invalid_parameter_noinfo();
      v26 = *(_DWORD *)(*((_DWORD *)this + 972) + 4 * j);
      ...
      if ( !v23 || !GameClient::Robot::IsMatchEquip(v6, v23) )
        CDropBagUI::SetWeapon(this, j, 0xFFFFFFFF, 0xFFFFFFFF, 0);
    }
  }
}
