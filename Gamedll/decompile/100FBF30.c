/*
 * func-name: sub_100FBF30
 * func-address: 0x100fbf30
 * callers: 0x10019aa1
 * callees: 0x1000db70, 0x1000f03d, 0x100102e4, 0x1001680b, 0x10017143
 */

int __thiscall sub_100FBF30(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1001680B(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_1000DB70((int)v52, v52[1], a3);
  sub_100102E4(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
