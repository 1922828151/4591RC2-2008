/*
 * func-name: sub_10200F60
 * func-address: 0x10200f60
 * callers: 0x100184a3
 * callees: 0x1000dd1e, 0x1000ea16, 0x10012e2c
 */

int __thiscall sub_10200F60(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10012E2C(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000DD1E((int)v49, v49[1], (int)a3);
  sub_1000EA16(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
