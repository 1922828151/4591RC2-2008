/*
 * func-name: sub_1013D530
 * func-address: 0x1013d530
 * callers: 0x10019ff6
 * callees: 0x1000551f, 0x1000ba0a, 0x1000f03d, 0x10017143, 0x100181fb
 */

int __thiscall sub_1013D530(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000BA0A(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_1000551F((int)v52, v52[1], a3);
  sub_100181FB(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
