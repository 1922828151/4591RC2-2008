/*
 * func-name: sub_10063920
 * func-address: 0x10063920
 * callers: 0x10006280
 * callees: 0x10006bea, 0x10013a16, 0x10014a24, 0x1001776f, 0x1001942a, 0x10019899, 0x102c9d86
 */

unsigned int __fastcall sub_10063920(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_10019899(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
