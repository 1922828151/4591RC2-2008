/*
 * func-name: ?RefreshSuiteStatus@CRobotRoofUI@@AAEXXZ_0
 * func-address: 0x10282820
 * callers: 0x100104e2
...
void __thiscall CRobotRoofUI::RefreshSuiteStatus(CRobotRoofUI *this)
{
  int i; // ebx
  ...
  *(float *)&v53 = 0.0;
  ...
  for ( i = 0; i < 3; ++i )
  {
    if ( *((_DWORD *)this + i + 979) != -1 )
    {
      v42 = (void ***)*((_DWORD *)this + i + 979);
  ...
  {
    v11 = *((_DWORD *)this + 983);
    if ( !v11 || v10 >= (*((_DWORD *)this + 984) - v11) >> 2 )
      break;
    v12 = *((_DWORD *)this + 983);
    ...
    v42 = *(void ****)(4 * v10 + *((_DWORD *)this + 983));
...
LABEL_27:
  ...
  {
    v19 = *((_DWORD *)this + 987);
    if ( !v19 || v18 >= (*((_DWORD *)this + 988) - v19) >> 2 )
      break;
    v20 = *((_DWORD *)this + 987);
    if ( *(_DWORD *)(4 * v18 + v20) == -1 )
      goto LABEL_46;
    if ( !v20 || v18 >= (*((_DWORD *)this + 988) - v20) >> 2 )
      _invalid_parameter_noinfo();
    v42 = *(void ****)(*((_DWORD *)this + 987) + 4 * v18);
...
LABEL_46:
  ...
  *(_DWORD *)v41 = &CREControl `RTTI Type Descriptor';
  v40 = 0;
  Control = CREDialog::GetControl(this, 30);
  ...
  *(_DWORD *)&v41[2] = 0;
  v29 = CREDialog::GetControl(this, 33);
  ...
  *(_DWORD *)v41 = 0;
  v30 = CREDialog::GetControl(this, 34);
  ...
  {
    v32(0, -65536);
    CREStatic::SetText(*((CREStatic **)this + 972), word_10322FE0);
    (*(void (__thiscall **)(_DWORD, int))(**((_DWORD **)this + 972) + 136))(*((_DWORD *)this + 972), 1);
  }
  v42 = 0;
  *(_DWORD *)&v41[2] = &CREStatic `RTTI Type Descriptor';
  *(_DWORD *)v41 = &CREControl `RTTI Type Descriptor';
  v40 = 0;
  v33 = CREDialog::GetControl(this, 32);
  ...
  *(_DWORD *)v41 = &CREControl `RTTI Type Descriptor';
  v40 = 0;
  v34 = CREDialog::GetControl(this, 31);
