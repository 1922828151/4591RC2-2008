/*
 * func-name: sub_100627B0
 * func-address: 0x100627b0
 * callers: 0x1000df2b
 * callees: 0x100033ff, 0x10006299, 0x10009a48, 0x1000df67, 0x10011586, 0x1001866f, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_100627B0(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_1000DF67(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_10009A48(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
