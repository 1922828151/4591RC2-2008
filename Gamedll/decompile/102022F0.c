/*
 * func-name: sub_102022F0
 * func-address: 0x102022f0
 * callers: 0x100096ba
 * callees: 0x1000a240, 0x1000cc7a
 */

int __thiscall sub_102022F0(_DWORD *this, int *a2)
{
  _DWORD *v3; // edi
  int v4; // ebp
  int v5; // edx
  ...
  if ( v10 == v12 )
  {
    ...
    LOBYTE(v16) = 1;
    v7 = (_DWORD *)sub_1000CC7A((int)v11, (int)&v14);
    v3 = (_DWORD *)*v7;
    v4 = v7[1];
    LOBYTE(v16) = 0;
