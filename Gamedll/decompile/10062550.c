/*
 * func-name: sub_10062550
 * func-address: 0x10062550
 * callers: 0x100118fb
 * callees: 0x10002612, 0x100039bd, 0x100040bb, 0x100053ad, 0x10011383, 0x1001a708, 0x102c9d86
 */

unsigned int __fastcall sub_10062550(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_10011383(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
