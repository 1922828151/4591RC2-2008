/*
 * func-name: sub_102C26D0
 * func-address: 0x102c26d0
 * callers: 0x10093b50, 0x100d3b80, 0x100dd3d0, 0x100dd510, 0x100e7530, 0x100f3370, 0x10175070, 0x101760b0, 0x10177e70, 0x101791a0, 0x1017e700, 0x101963e0, 0x10196950, 0x101b1f60, 0x101b3cc0, 0x101dcb90
 * callees: 0x102c9552, 0x102c9ea2, 0x102ca08c, 0x102ca092
 */

int __thiscall sub_102C26D0(float *this, float a2, float a3, float a4)
{
  float v5; // eax
  float v6; // ecx
  float v7; // edx
  ...
  v26[0] = 1.0;
  v26[15] = 1.0;
  D3DXMatrixMultiply(v26, v25, v23);
  memset(v22, 0, sizeof(v22));
  v22[10] = 1.0;
  v22[5] = 1.0;
  v22[0] = 1.0;
  v22[15] = 1.0;
  D3DXMatrixMultiply(v22, v26, v24);
  v5 = v22[1];
  v6 = v22[2];
  *this = v22[0];
  v7 = v22[4];
