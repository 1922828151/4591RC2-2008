/*
 * func-name: ?PostRender@HookAlarmArea@@UAEXPAVCamera@@@Z_0
 * func-address: 0x10134780
 * callers: 0x1000655a
 * callees: 0x10014669, 0x100146be, 0x102c0750
 */

void __thiscall HookAlarmArea::PostRender(HookAlarmArea *this, struct Camera *a2)
{
  Editor *v3; // eax
  int v4; // eax
  int v5; // eax
  ...
  if ( Editor::GetEditorMode(v3) )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v9 )
      {
        ...
        {
          v10 = Canvas::Instance();
          v21 = *((float *)this + 214) + *((float *)this + 297);
          v11 = (int *)v10;
          v19 = *((float *)this + 298) + *((float *)this + 215);
          v23 = *((float *)this + 299) + *((float *)this + 216);
          v25[0] = v21;
          v25[1] = v19;
          v25[2] = v23;
          v24 = *((float *)this + 214) - *((float *)this + 297);
          v20 = *((float *)this + 215) - *((float *)this + 298);
          v22 = *((float *)this + 216) - *((float *)this + 299);
          v26[0] = v24;
          v26[1] = v20;
          v26[2] = v22;
