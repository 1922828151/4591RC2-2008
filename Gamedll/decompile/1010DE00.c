/*
 * func-name: sub_1010DE00
 * func-address: 0x1010de00
 * callers: 0x10010e6f
 * callees: 0x10009e4e, 0x1000f03d, 0x1001433a, 0x10017143, 0x1001822d
 */

int __thiscall sub_1010DE00(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1001822D(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_10009E4E((int)v52, v52[1], a3);
  sub_1001433A(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
