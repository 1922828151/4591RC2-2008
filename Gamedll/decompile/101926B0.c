/*
 * func-name: sub_101926B0
 * func-address: 0x101926b0
 * callers: 0x10017896
 * callees: 0x1000232e, 0x10004ccd, 0x100090ca, 0x1000ab3c, 0x1001044c, 0x10018953, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_101926B0(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_1000232E(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_1000AB3C(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
