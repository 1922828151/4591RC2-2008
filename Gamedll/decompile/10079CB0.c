/*
 * func-name: sub_10079CB0
 * func-address: 0x10079cb0
 * callers: 0x10010e92
 * callees: 0x10009d9f, 0x1000b0aa, 0x1000bccb, 0x10012ff3, 0x1001651d, 0x10017b20, 0x102c9d86
 */

unsigned int __fastcall sub_10079CB0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1001651D(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
