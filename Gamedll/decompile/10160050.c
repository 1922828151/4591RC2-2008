/*
 * func-name: sub_10160050
 * func-address: 0x10160050
 * callers: 0x1000e8b8
 * callees: 0x1000a13c, 0x10016838, 0x10018bce
 */

int __thiscall sub_10160050(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10016838(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000A13C((int)v49, v49[1], (int)a3);
  sub_10018BCE(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
