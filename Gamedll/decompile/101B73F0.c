/*
 * func-name: ?OnUpdateMoveStatus@PedrailVehicle@GameClient@@QAEXKK_NABVVector@@ABVMatrix@@111@Z_0
 * func-address: 0x101b73f0
 * callers: 0x100106d6
 * callees: 0x1001419b, 0x10019b41
 */

void __thiscall GameClient::PedrailVehicle::OnUpdateMoveStatus(
