/*
 * func-name: ?WriteSnapshot@WheelVehicle@GameClient@@UAE_NAAVBinStream@@@Z_0
 * func-address: 0x101baa10
 * callers: 0x10005de9
 * callees: 0x1000c4f5
 */

bool __thiscall GameClient::WheelVehicle::WriteSnapshot(GameClient::WheelVehicle *this, struct BinStream *a2)
{
  bool result; // al
  int v4; // eax
  unsigned int v5; // edx
