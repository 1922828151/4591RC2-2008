/*
 * func-name: sub_10143190
 * func-address: 0x10143190
 * callers: 0x10010f91
 * callees: 0x10006a69, 0x10008deb, 0x10018bec
 */

int __thiscall sub_10143190(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10008DEB(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10006A69((int)v49, v49[1], (int)a3);
  sub_10018BEC(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
