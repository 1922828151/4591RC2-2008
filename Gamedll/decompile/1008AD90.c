/*
 * func-name: ?StartSpawningParticles@Effect_MultiTexParticles@@UAEXXZ_0
 * func-address: 0x1008ad90
 * callers: 0x1000853a
 * callees: 0x102c0ed0
 */

void __thiscall Effect_MultiTexParticles::StartSpawningParticles(Effect_MultiTexParticles *this)
{
  int v2; // eax
  FXManager *v3; // eax
