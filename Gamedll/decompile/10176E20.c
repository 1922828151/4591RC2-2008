/*
 * func-name: ?Use@Robot@GameClient@@QAEXXZ_0
 * func-address: 0x10176e20
 * callers: 0x100058a8
 * callees: 0x1000815c, 0x10009886, 0x1000d67a, 0x1000d8be, 0x1000dd50
 */

void __thiscall GameClient::Robot::Use(GameClient::Robot *this)
{
  int v2; // ebx
  int v3; // eax
  int v4; // ebx
  ...
  if ( *((_DWORD *)this + 57) )
  {
    ...
    v6 = *(_DWORD *)(936 * v5 + *(_DWORD *)(v4 + 4) + 620);
    v7 = *((_DWORD *)this + 43);
    v8 = *(_DWORD *)(v7 + 1748);
    v9 = v7 + 1744;
    ...
    if ( *((_BYTE *)this + 700) )
    {
      v11 = *(_DWORD *)(GameClient::CombinRobot::GetAnimFPV((int)v13, *(_DWORD *)(*((_DWORD *)this + 57) + 8) + 1040)
                      + 48);
