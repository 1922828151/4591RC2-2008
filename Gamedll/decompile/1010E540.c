/*
 * func-name: sub_1010E540
 * func-address: 0x1010e540
 * callers: 0x1000290f
 * callees: 0x1000c00e, 0x1000d7fb, 0x1000fb05
 */

int __thiscall sub_1010E540(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1000FB05(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000D7FB((int)v49, v49[1], (int)a3);
  sub_1000C00E(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
