/*
 * func-name: sub_101DC5C0
 * func-address: 0x101dc5c0
 * callers: 0x10003530
 * callees: 0x10003fb7, 0x1000a574, 0x10010339, 0x10014939, 0x10015a00, 0x1001a57d, 0x102c9d86
 */

unsigned int __fastcall sub_101DC5C0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1000A574(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
