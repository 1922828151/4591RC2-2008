/*
 * func-name: sub_10079F10
 * func-address: 0x10079f10
 * callers: 0x1000e205
 * callees: 0x10002289, 0x1000f66e, 0x10010645, 0x10010ad2, 0x10012e2c, 0x1001a62c, 0x102c9d86
 */

unsigned int __fastcall sub_10079F10(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1001A62C(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
