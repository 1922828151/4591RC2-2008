/*
 * func-name: sub_10066BC0
 * func-address: 0x10066bc0
 * callers: 0x10014790
 * callees: 0x100043f9, 0x100071b2, 0x1000ff6f, 0x10010f00, 0x1001a546, 0x1001a7e4, 0x102c9d86
 */

unsigned int __fastcall sub_10066BC0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  ...
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1000FF6F(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
