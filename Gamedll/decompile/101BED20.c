/*
 * func-name: ?UpdateInput@WheelVehicleController@GameClient@@UAEXPAVSeat@2@@Z_0
 * func-address: 0x101bed20
 * callers: 0x1000b357
 * callees: 0x10002ea5, 0x1000e363, 0x10018d0e
 */

void __thiscall GameClient::WheelVehicleController::UpdateInput(
        ...
        struct GameClient::Seat *a2)
{
  ...
  if ( *((_DWORD *)this + 3) )
  {
    ...
    v6 = dword_103B67B4 + 8;
    if ( !v5 || (unsigned int)((*(_DWORD *)(dword_103B67B4 + 12) - v5) >> 2) <= 3 )
      _invalid_parameter_noinfo();
    v7 = (Input *)Input::Instance(*(_DWORD *)(*(_DWORD *)v6 + 12));
    Input::ControlDown(v7);
    v8 = *(_DWORD *)(dword_103B67B4 + 8);
    v9 = dword_103B67B4 + 8;
    if ( !v8 || (unsigned int)((*(_DWORD *)(dword_103B67B4 + 12) - v8) >> 2) <= 4 )
      _invalid_parameter_noinfo();
    v10 = (Input *)Input::Instance(*(_DWORD *)(*(_DWORD *)v9 + 16));
    if ( Input::ControlDown(v10) )
      retaddr = 1;
    v11 = *(_DWORD *)(dword_103B67B4 + 8);
    v12 = dword_103B67B4 + 8;
    if ( !v11 || (unsigned int)((*(_DWORD *)(dword_103B67B4 + 12) - v11) >> 2) <= 5 )
      _invalid_parameter_noinfo();
    v13 = (Input *)Input::Instance(*(_DWORD *)(*(_DWORD *)v12 + 20));
...
LABEL_31:
    GameClient::WheelVehicle::Move(*(GameClient::WheelVehicle **)(v22 + 12), 0, 0, v21);
  }
}
