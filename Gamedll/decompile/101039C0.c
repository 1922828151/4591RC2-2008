/*
 * func-name: sub_101039C0
 * func-address: 0x101039c0
 * callers: 0x10012e5e
 * callees: 0x10007009, 0x1000a411, 0x1001023f, 0x10013c7d, 0x100170d0, 0x10019e70, 0x102c9d86
 */

unsigned int __fastcall sub_101039C0(unsigned int a1, int a2, int a3)
{
  int v4; // esi
  int v5; // ecx
  int v6; // ebx
  ...
  v24 = *(_DWORD *)(v29 + 8);
  v28 = a1 + 16;
  sub_10013C7D(v7, v29 + 4, v24);
  *(_DWORD *)(a1 + 32) = *(_DWORD *)(a3 + 32);
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a3 + 36);
  sub_10007009(v25[0], v25[1]);
  v23 = *(int **)(a3 + 8);
  v22 = *v23;
  v21 = *(_DWORD *)(v6 + 4);
  v31 = 0;
  sub_1001023F(v6, v21, a3 + 4, v22, a3 + 4, (int)v23, a3);
  *(_BYTE *)v29 = *(_BYTE *)a3;
  v8 = **(_DWORD ***)(a3 + 8);
  v9 = 0;
  v26 = **(_DWORD ***)(v6 + 4);
