/*
 * func-name: ?IsEquipMatchingRobotSystem@CDropBagUI@@IAE_NK@Z_0
 * func-address: 0x10269b50
 * callers: 0x10008a17
 * callees: 0x1000aff6, 0x1000e7b4, 0x100103c0, 0x10011766, 0x10012c29, 0x102c9d50
 */

bool __thiscall CDropBagUI::IsEquipMatchingRobotSystem(CDropBagUI *this, struct GameClient::FSystemPart *a2)
{
  ...
  {
    v11 = *((_DWORD *)this + 972);
    if ( !v11 || i >= (*((_DWORD *)this + 973) - v11) >> 2 )
      break;
    v12 = *((_DWORD *)this + 972);
    if ( *(_DWORD *)(v12 + 4 * i) != -1 )
    {
      if ( !v12 || i >= (*((_DWORD *)this + 973) - v12) >> 2 )
        _invalid_parameter_noinfo();
      v24 = *(_DWORD *)(*((_DWORD *)this + 972) + 4 * i);
  ...
  {
    v15 = *((_DWORD *)this + 980);
    if ( !v15 || j >= (*((_DWORD *)this + 981) - v15) >> 2 )
      break;
    v16 = *((_DWORD *)this + 980);
    if ( *(_DWORD *)(v16 + 4 * j) != -1 )
    {
      if ( !v16 || j >= (*((_DWORD *)this + 981) - v16) >> 2 )
        _invalid_parameter_noinfo();
      v25 = *(_DWORD *)(*((_DWORD *)this + 980) + 4 * j);
