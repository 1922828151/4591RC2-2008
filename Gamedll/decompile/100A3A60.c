/*
 * func-name: sub_100A3A60
 * func-address: 0x100a3a60
 * callers: 0x1000812f
 * callees: 0x10001735, 0x10002699, 0x10009ac0, 0x10015e2e, 0x102c9d86
 */

int **__thiscall sub_100A3A60(int *this, int **a2, char a3, int *a4, int a5)
{
  int v6; // ebp
  int *v7; // eax
  int *v8; // eax
  ...
  v6 = sub_10001735(this[1], (int)a4, this[1], a5, 0);
  v7 = (int *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
    ...
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 20) )
      {
        ...
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 20) = 0;
        sub_10015E2E(*(_DWORD *)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 20) = 1;
