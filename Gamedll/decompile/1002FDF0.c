/*
 * func-name: sub_1002FDF0
 * func-address: 0x1002fdf0
 * callers: none
 * callees: 0x1002dc10, 0x102c9db6
 */

int __cdecl sub_1002FDF0(int a1, int a2)
{
  ...
  v3 = 0;
  v4 = 0;
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(a2, "OO:Vector_RadAngle", &v3, &v4)
