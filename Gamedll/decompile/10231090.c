/*
 * func-name: sub_10231090
 * func-address: 0x10231090
 * callers: 0x10007545
 * callees: 0x10006320, 0x10016ad6, 0x10019d30
 */

int __thiscall sub_10231090(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10006320(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_10019D30((int)v49, v49[1], (int)a3);
  sub_10016AD6(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
