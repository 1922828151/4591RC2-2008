/*
 * func-name: sub_1010F350
 * func-address: 0x1010f350
 * callers: 0x100138f9
 * callees: 0x10005191, 0x1000b311, 0x1000fb05, 0x10016333, 0x100192b8, 0x1001a56e, 0x102c9d50, 0x102c9d86
 */

unsigned int __thiscall sub_1010F350(_DWORD *this, int a2)
{
  int v3; // ecx
  int v4; // esi
  int v5; // eax
  ...
  v24 = v27[2];
  v28 = (char *)(this + 4);
  sub_1000FB05(v5, (_BYTE)v27 + 4, v24);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(v4 + 8) = 0;
  ...
  v22 = *(_DWORD *)(v4 + 4);
  v31 = 0;
  sub_1000B311(v4, v22, a2 + 4, v23, a2 + 4, (int)v9, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v10 = **(_DWORD ***)(a2 + 8);
  v11 = 0;
  v26 = **(_DWORD ***)(v4 + 4);
