/*
 * func-name: sub_1016FFE0
 * func-address: 0x1016ffe0
 * callers: 0x10015ef1
 * callees: 0x1000ce73, 0x1000d2ce, 0x1001776f
 */

int __thiscall sub_1016FFE0(int *this, int a2, _DWORD *a3)
{
  int *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1001776F(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v52 = sub_1000CE73((int)v49, v49[1], (int)a3);
  sub_1000D2CE(1);
  v49[1] = v52;
  **(_DWORD **)(v52 + 4) = v52;
  if ( !v48 )
