/*
 * func-name: ?RemoveAura@WorldObject@GameClient@@QAEXK@Z_0
 * func-address: 0x1019b000
 * callers: 0x10016441
 * callees: 0x100084f4, 0x1000aff6, 0x1001816a
 */

void __thiscall GameClient::WorldObject::RemoveAura(GameClient::WorldObject *this, unsigned int a2)
{
  void (__cdecl *v2)(); // ebp
  char *v3; // ebx
  unsigned int v4; // edi
  ...
  while ( 1 )
  {
    ...
    if ( a2 == *(_DWORD *)(*(_DWORD *)v4 + 12) )
    {
      ...
      if ( v6 && *(_BYTE *)(v6 + 212) )
      {
        ...
        sub_1001816A(4);
        *(_DWORD *)(*((_DWORD *)Stream + 1) + *((_DWORD *)Stream + 2)) = v16;
        *((_DWORD *)Stream + 2) += 4;
        sub_1001816A(4);
        *(_DWORD *)(*((_DWORD *)Stream + 1) + *((_DWORD *)Stream + 2)) = v9;
        *((_DWORD *)Stream + 2) += 4;
        v2 = _invalid_parameter_noinfo;
      }
      if ( v4 >= *((_DWORD *)v3 + 2) )
