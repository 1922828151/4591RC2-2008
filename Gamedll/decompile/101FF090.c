/*
 * func-name: sub_101FF090
 * func-address: 0x101ff090
 * callers: 0x10003e45
 * callees: 0x102c9d50
 */

_DWORD *__thiscall sub_101FF090(_DWORD *this, _DWORD *a2, int a3, _DWORD *a4)
{
  ldiv_t v5; // rax
  unsigned int v6; // eax
  unsigned int i; // ebx
  ...
  if ( v10 != (void *)this[2] )
  {
    ...
    *(_DWORD *)(*(_DWORD *)v10 + 4) = *((_DWORD *)v10 + 1);
    v14 = (Outpop::Utility::Ref_Object *)*((_DWORD *)v10 + 3);
    if ( v14 )
    {
