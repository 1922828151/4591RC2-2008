/*
 * func-name: sub_1011BCC0
 * func-address: 0x1011bcc0
 * callers: 0x1000db6b
 * callees: 0x10008300, 0x1000dd37, 0x1000f03d, 0x100153a7, 0x10017143
 */

int __thiscall sub_1011BCC0(int *this, int a2, void *a3)
{
  int *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= (unsigned int)this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100153A7(v9 + 2, (_BYTE)v3 + 4, v3[2]);
    }
    v11 = v3[5];
...
LABEL_49:
  ...
  v55 = sub_1000DD37((int)v52, v52[1], a3);
  sub_10008300(1);
  v52[1] = v55;
  **(_DWORD **)(v55 + 4) = v55;
  if ( !v51 )
