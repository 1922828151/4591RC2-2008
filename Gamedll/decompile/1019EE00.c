/*
 * func-name: sub_1019EE00
 * func-address: 0x1019ee00
 * callers: 0x1000d049
 * callees: 0x102c9d86
 */

int *__thiscall sub_1019EE00(int *this, const char *a2)
{
  DWORD LastError; // eax
  int v4; // edi
  ...
  if ( Outpop::Utility::Stream_Base::get_space((Outpop::Utility::Stream_Base *)this) < 0xCu )
  {
    v4 = *this;
    size = Outpop::Utility::Stream_Base::get_size((Outpop::Utility::Stream_Base *)this);
    (*(void (__thiscall **)(int *, unsigned int))(v4 + 16))(this, size + 140);
  }
  v6 = Outpop::Utility::OS_Buffer::write((Outpop::Utility::OS_Buffer *)this[2], a2, this[3], 12);
  if ( v6 == -1 )
  {
