/*
 * func-name: sub_10030870
 * func-address: 0x10030870
 * callers: none
 * callees: 0x1002dc10, 0x1002de00
 */

int __cdecl sub_10030870(int a1, int a2)
{
  float *v3; // eax
  float *v4; // ecx
  ...
  if ( !((int (__cdecl *)(int, const char *, _DWORD **, _DWORD **))PyArg_ParseTuple)(
          ...
          &v5,
          &v6)
    || sub_1002DC10(&v8, v5, (const char **)dword_103B4E80, 1) == -1
    || sub_1002DC10(&v7, v6, (const char **)dword_103B4E80, 1) == -1 )
  {
    return 0;
  }
  v3 = v8;
