/*
 * func-name: ?doesSegmentCrossPlane@LaserParticleSystem@@QAE_NAAVVector@@0000@Z_0
 * func-address: 0x100a7940
 * callers: 0x10005b55
 * callees: none
 */

char __thiscall LaserParticleSystem::doesSegmentCrossPlane(
