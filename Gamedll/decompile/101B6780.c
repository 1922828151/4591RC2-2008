/*
 * func-name: sub_101B6780
 * func-address: 0x101b6780
 * callers: 0x1000895e
 * callees: 0x1000adc6, 0x1000dafd, 0x10012e1d, 0x10014669
 */

void __stdcall sub_101B6780(Event *a1)
{
  struct BinStream *Stream; // eax
  int v2; // ecx
  int v3; // edx
  GameClient::AircraftVehicle *v4; // ecx
  ...
  unsigned int v23; // [esp+8h] [ebp-7Ch]
  unsigned int v24; // [esp+Ch] [ebp-78h]
  GameClient::AircraftVehicle *v25; // [esp+10h] [ebp-74h]
  ...
  {
    v4 = *(GameClient::AircraftVehicle **)(v2 + *((_DWORD *)Stream + 1));
    *((_DWORD *)Stream + 3) = v3;
  }
  v22 = (unsigned int)v4;
  ...
  if ( Establishment )
  {
    ...
    if ( v9 + 4 <= v8 )
    {
      v23 = *(_DWORD *)(v9 + *((_DWORD *)v6 + 1));
      *((_DWORD *)v6 + 3) = v9 + 4;
    }
    v10 = *((_DWORD *)v6 + 3);
    if ( v10 + 4 > v8 )
    {
      v11 = (unsigned int)Establishment;
    }
    else
    {
      v11 = *(_DWORD *)(v10 + *((_DWORD *)v6 + 1));
      *((_DWORD *)v6 + 3) = v10 + 4;
    }
    v36 = 0.0;
    v37 = 0.0;
    ...
    GameClient::AircraftVehicle::OnUpdateMoveStatus(
      Establishment,
      v24,
      v23,
      v11,
