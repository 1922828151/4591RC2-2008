/*
 * func-name: ?WriteSynaData@AArmor@GameClient@@UAE_NAAVBinStream@@@Z_0
 * func-address: 0x101cf5a0
 * callers: 0x10006cf3
 * callees: 0x100015b4, 0x10008a62
 */

char __thiscall GameClient::AArmor::WriteSynaData(GameClient::AArmor *this, struct BinStream *a2)
{
  int v4; // eax
