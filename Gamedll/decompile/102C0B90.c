/*
 * func-name: sub_102C0B90
 * func-address: 0x102c0b90
 * callers: 0x10030030
 * callees: 0x10002e2d, 0x102c9dbc
 */

double __thiscall sub_102C0B90(float *this, float *a2, float *a3)
{
