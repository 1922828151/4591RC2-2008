/*
 * func-name: ?connect_remote_peer@Peer@P2P@Outpop@@QAEXABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
 * func-address: 0x10003d20
 * callers: none
 * callees: 0x10002910, 0x1000a570, 0x100234ce
 */

void __thiscall Outpop::P2P::Peer::connect_remote_peer(char *this, int a2)
{
  _DWORD *v3; // eax
  ...
  if ( !(unsigned __int8)std::operator==<char>(this + 32, &unk_10026701) )
  {
    v3 = operator new(0x3Cu);
    v4 = v3 ? (struct Outpop::IONetwork::Asynch_Result *)sub_10002910(v3, a2, (int)this) : 0;
           ...
           0) == -1 )
    {
        ...
        && *(_BYTE *)(Outpop::Utility::Logger::instance() + 142) == 1 )
      {
        ...
        v12 = sub_1000A570(
                ...
                350);
        sub_1000A570(&log_buffer[v12 + v8], L"Peer post remote peer error");
