/*
 * func-name: sub_10015A90
 * func-address: 0x10015a90
 * callers: 0x10015ca0, 0x10016490, 0x10017280, 0x100173b0
 * callees: 0x10015a20
 */

int __usercall sub_10015A90@<eax>(
...
LABEL_16:
      ...
      break;
    case 0x13:
      return sub_10015A20(a1 + 1, (int)a2, a4, a3);
    case 0x16:
    case 0x18:
      v6 = a1 + 1;
      goto LABEL_16;
