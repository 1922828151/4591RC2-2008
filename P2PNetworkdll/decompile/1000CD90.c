 ...
 * callers: 0x1000b090
 * callees: 0x10008430, 0x10008e30, 0x10009cc0, 0x1000dbc0
 */

int __stdcall sub_1000CD90(_DWORD *a1, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= a1[3] >> 2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v64 == (_DWORD *)v63[1] )
        invalid_parameter_noinfo();
      v14 = std::string::end(v64 + 2, v70);
      v15 = std::string::begin(v64 + 2, v71);
      v16 = sub_10009CC0(*(_DWORD **)v15, *(_DWORD *)(v15 + 4), *(_DWORD **)v14, *(_DWORD *)(v14 + 4));
      v17 = ldiv(v16, 127773);
...
LABEL_49:
  ...
  v43 = std::string::end(a3, v71);
  v44 = std::string::begin(a3, v70);
  v45 = sub_10009CC0(*(_DWORD **)v44, *(_DWORD *)(v44 + 4), *(_DWORD **)v43, *(_DWORD *)(v43 + 4));
  v46 = ldiv(v45, 127773);
  ...
  v55 = sub_10008E30((int)v52, v52[1], a3);
  sub_10008430(1u, (int)(v3 + 1));
  v52[1] = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
