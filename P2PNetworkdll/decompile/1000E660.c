/*
 * func-name: sub_1000E660
 * func-address: 0x1000e660
 * callers: 0x1000ab00, 0x1000ac90, 0x1000b090, 0x1000b380
 * callees: 0x10023bc6
 */

int *__userpurge sub_1000E660@<eax>(int *a1@<esi>, const char *a2)
{
  DWORD LastError; // eax
  int v3; // edi
