/*
 * func-name: sub_100079C0
 * func-address: 0x100079c0
 * callers: 0x10002770, 0x100063d0
 * callees: 0x100080d0, 0x100084c0, 0x100084e0, 0x10009850, 0x1000e470, 0x10023bc6
 */

unsigned int __stdcall sub_100079C0(int a1, int a2)
{
  int v2; // esi
  int v3; // ebx
  _DWORD *v4; // ecx
  ...
  *(_DWORD *)(a1 + 36) = *(_DWORD *)(a2 + 36);
  sub_1000E470(a1 + 4);
  v23 = 0;
  sub_10009850(a1 + 4, a1 + 4, *(_DWORD *)(a1 + 8), v2 + 4, **(_DWORD **)(v2 + 8), v2 + 4, *(_DWORD *)(v2 + 8));
  *(_BYTE *)a1 = *(_BYTE *)a2;
  v4 = **(_DWORD ***)(a2 + 8);
  v5 = 0;
  v19 = **(_DWORD ***)(a1 + 8);
