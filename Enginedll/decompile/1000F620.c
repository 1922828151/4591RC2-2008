/*
 * func-name: ?_Insert_n@?$vector@PAVMaterial@@V?$allocator@PAVMaterial@@@std@@@std@@IAEXV?$_Vector_iterator@PAVMaterial@@V?$allocator@PAVMaterial@@@std@@@2@IABQAVMaterial@@@Z
 * func-address: 0x1000f620
 * callers: 0x100117e0, 0x1002b5c0, 0x1002b680, 0x1002b6a0
 * callees: 0x1000a1e0, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall std::vector<Material *>::_Insert_n(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
