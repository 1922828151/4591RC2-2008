/*
 * func-name: sub_10005610
 * func-address: 0x10005610
 * callers: 0x10006230, 0x10008f60
 * callees: 0x10001ca0, 0x100116a0, 0x10015b30, 0x101a2534
 */

char __stdcall sub_10005610(int *Buffer, void **a2, FILE *Stream, _DWORD *a4, int a5)
{
  FILE *v5; // esi
  int v6; // eax
  _DWORD *v7; // edi
  ...
  char *v19; // ebx
  int v20; // eax
  int v22[7]; // [esp+18h] [ebp-44h] BYREF
  int v23[7]; // [esp+34h] [ebp-28h] BYREF
