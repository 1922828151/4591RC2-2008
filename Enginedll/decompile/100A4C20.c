/*
 * func-name: ?GetReadingWindowOrientation@CREIMEEditBox@@KAXK@Z
 * func-address: 0x100a4c20
 * callers: 0x100a4d40
 * callees: none
 */

void __cdecl CREIMEEditBox::GetReadingWindowOrientation(unsigned int a1)
{
  unsigned int v1; // esi
  const WCHAR *v2; // eax
  ...
  if ( CREIMEEditBox::s_hklCurrent == (HIMC)-535951356 || CREIMEEditBox::s_hklCurrent == (HIMC)-536280060 || !a1 )
  {
    CREIMEEditBox::s_bHorizontalReading = 1;
  }
  else
  {
    CREIMEEditBox::s_bHorizontalReading = 0;
