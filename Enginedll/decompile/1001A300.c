/*
 * func-name: ?_Xinvarg@?$vector@UVFormat@VertexManager@@V?$allocator@UVFormat@VertexManager@@@std@@@std@@KAXXZ
 * func-address: 0x1001a300
 * callers: none
 * callees: 0x101a2522
 */

void __noreturn std::vector<VertexManager::VFormat>::_Xinvarg()
{
