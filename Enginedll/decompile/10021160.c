/*
 * func-name: ?reserve@?$vector@PAVModel@@V?$allocator@PAVModel@@@std@@@std@@QAEXI@Z
 * func-address: 0x10021160
 * callers: none
 * callees: 0x10019720, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall std::vector<Model *>::reserve(int this, unsigned int a2)
{
  int v3; // ecx
