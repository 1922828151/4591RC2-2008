/*
 * func-name: sub_10147110
 * func-address: 0x10147110
 * callers: 0x101474e0
 * callees: 0x10024540, 0x100245a0, 0x10051d40, 0x10051e70, 0x10051f70, 0x10053140, 0x10053240, 0x100535f0, 0x10146b40, 0x10146d20, 0x10146d90, 0x10146dd0, 0x101a2500, 0x101a2522
 */

void __thiscall sub_10147110(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  int v8; // ecx
  ...
  if ( a4 )
  {
    ...
    else
    {
      ...
      v35 = v14;
      LOBYTE(v33) = 1;
      v16 = sub_10053140(v15, a3, v14);
      v17 = sub_10146D90(v16, a4, v28);
      v18 = (_DWORD *)this[2];
      LOBYTE(v30) = 0;
      sub_10053140(a3, v18, v17);
      v19 = this[1];
      if ( v19 )
        v19 = (this[2] - v19) / 112;
      v20 = v19 + a4;
