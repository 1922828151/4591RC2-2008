/*
 * func-name: ?_Xlen@?$vector@PAVEditorVar@@V?$allocator@PAVEditorVar@@@std@@@std@@KAXXZ
 * func-address: 0x10019a40
 * callers: 0x1001cfc0, 0x10021390, 0x10021430, 0x10024e30, 0x10024ea0
 * callees: 0x101a2522
 */

void __noreturn std::vector<EditorVar *>::_Xlen()
{
