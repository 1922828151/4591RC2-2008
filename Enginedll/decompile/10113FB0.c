/*
 * func-name: sub_10113FB0
 * func-address: 0x10113fb0
 * callers: 0x10115310
 * callees: 0x1010f2f0, 0x1010f460, 0x1010f8c0, 0x1010fba0, 0x10112020
 */

int __thiscall sub_10113FB0(_DWORD *this, int a2, char *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10112020(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
    ...
    while ( 1 )
    {
      ...
      if ( v66 == (_DWORD *)v65[1] )
        invalid_parameter_noinfo();
      if ( (this[8] & sub_1010FBA0((int)(v66 + 2))) == v63 )
      {
        if ( v66 == (_DWORD *)v65[1] )
          invalid_parameter_noinfo();
        v12 = v63;
...
LABEL_49:
  ...
  v43 = (int *)std::wstring::end(a3, v72);
  v44 = std::wstring::begin(a3, v70);
  v45 = sub_1010F460(*(_DWORD *)v44, *(_DWORD *)(v44 + 4), *v43, v43[1]);
  v46 = ldiv(v45, 127773);
  ...
  while ( 1 )
  {
    ...
    if ( !(unsigned __int8)std::operator<<wchar_t>(a3, v52 + 8) )
    {
      if ( v52 == *(_DWORD *)(v51 + 4) )
        invalid_parameter_noinfo();
      if ( !(unsigned __int8)std::operator<<wchar_t>(v52 + 8, a3) )
      {
        result = a2;
        *(_DWORD *)(a2 + 4) = v52;
        *(_DWORD *)a2 = v51;
  ...
  v55 = sub_1010F8C0(v52, *(CREControl **)(v52 + 4), a3);
  sub_1010F2F0(v3 + 1, 1u);
  *(_DWORD *)(v52 + 4) = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
