/*
 * func-name: sub_100412C0
 * func-address: 0x100412c0
 * callers: 0x10041980, 0x10044cf0
 * callees: 0x100116a0, 0x1003be70, 0x100492d0, 0x100497b0, 0x10049860, 0x10049910, 0x1004a5e0, 0x1004a6e0
 */

char __thiscall sub_100412C0(char *this, char *a2, char *a3)
{
  XMLSystem *v4; // edi
  char *FirstNode; // eax
  char *v6; // ebp
  ...
  *(_DWORD *)(v6 + 2211) = Int;
  ...
  if ( v84 )
  {
    ...
    v101 = -1;
    std::string::~string(v100);
    if ( (unsigned __int8)std::operator!=<char>(v6 + 2263, &unk_101BCE87) )
    {
      a2 = v6 + 2263;
      sub_1003BE70((_DWORD *)v98 + 3, (int *)&a2);
    }
  }
  else
  {
    std::string::operator=(v6 + 2263, &unk_101BCE8F);
  }
  a2 = v91;
