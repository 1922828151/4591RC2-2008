/*
 * func-name: ?_Insert_n@?$vector@PAVMatrix@@V?$allocator@PAVMatrix@@@std@@@std@@IAEXV?$_Vector_iterator@PAVMatrix@@V?$allocator@PAVMatrix@@@std@@@2@IABQAVMatrix@@@Z
 * func-address: 0x10024c70
 * callers: 0x1002b120, 0x1002b1e0, 0x1002b270, 0x1002b290
 * callees: 0x100198a0, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall std::vector<Matrix *>::_Insert_n(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
