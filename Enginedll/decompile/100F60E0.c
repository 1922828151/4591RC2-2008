/*
 * func-name: sub_100F60E0
 * func-address: 0x100f60e0
 * callers: 0x100f6560, 0x100f6620
 * callees: 0x1003b6b0, 0x100dd410, 0x100f5880, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_100F60E0(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
