/*
 * func-name: ?_Xran@?$vector@UAttributeRange@@V?$allocator@UAttributeRange@@@std@@@std@@KAXXZ
 * func-address: 0x1001a0e0
 * callers: 0x1001d1d0
 * callees: 0x101a2522
 */

void __noreturn std::vector<AttributeRange>::_Xran()
{
