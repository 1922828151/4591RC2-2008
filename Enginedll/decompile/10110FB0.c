/*
 * func-name: sub_10110FB0
 * func-address: 0x10110fb0
 * callers: 0x1010d330, 0x10111ec0
 * callees: 0x1001cb40, 0x100906b0, 0x10095080, 0x1010e670, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10110FB0(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
