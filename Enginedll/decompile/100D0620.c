/*
 * func-name: sub_100D0620
 * func-address: 0x100d0620
 * callers: 0x100d4880
 * callees: 0x10051fd0, 0x10052210, 0x100cded0, 0x1010fea0, 0x101a2522
 */

_DWORD *__thiscall sub_100D0620(_DWORD *this, int a2)
{
  int v2; // eax
  unsigned int v4; // esi
  char *v5; // eax
