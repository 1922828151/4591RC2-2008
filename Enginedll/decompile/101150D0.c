/*
 * func-name: sub_101150D0
 * func-address: 0x101150d0
 * callers: 0x1010b610, 0x1010b790
 * callees: 0x1010fd40, 0x10112ea0
 */

int __thiscall sub_101150D0(_DWORD *this, int a2)
{
  _DWORD *v3; // edi
  int v4; // ebx
  _DWORD *v5; // eax
  ...
  if ( v8 == v10 )
  {
    ...
    v12 = 0;
    v13 = 0;
    v5 = (_DWORD *)sub_10112EA0(this, (int)v9, (int)v11);
    v3 = (_DWORD *)*v5;
    v4 = v5[1];
    v13 = -1;
