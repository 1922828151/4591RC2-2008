/*
 * func-name: sub_10179E00
 * func-address: 0x10179e00
 * callers: none
 * callees: 0x1004c240, 0x1017b990, 0x101a2516, 0x101a251c
 */

float *__cdecl sub_10179E00(float *a1, int *a2)
{
  int v2; // ecx
  int v3; // edx
  int v4; // eax
  ...
  v29 = 0.0;
  v23 = 0.0;
  v5 = (float *)sub_1017B990(&v27, &v21, &v24);
  v18 = *v5;
  v19 = v5[1];
  v20 = v5[2];
  ...
  if ( v31 < 0.1000000014901161 )
  {
    ...
    v22 = 0.89999998;
    v23 = 0.1;
    v6 = (float *)sub_1017B990(&v27, &v21, &v24);
    v18 = *v6;
    v19 = v6[1];
    v20 = v6[2];
  }
  v7 = sub_1017B990(&v27, &v18, &v24);
  v21 = *(float *)v7;
  v8 = v21;
  v22 = *(float *)(v7 + 4);
  v9 = v22;
