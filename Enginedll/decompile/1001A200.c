/*
 * func-name: ?_Xlen@?$vector@UVFormat@VertexManager@@V?$allocator@UVFormat@VertexManager@@@std@@@std@@KAXXZ
 * func-address: 0x1001a200
 * callers: 0x1001d3a0, 0x10026190, 0x10026280, 0x10026350, 0x100265d0
 * callees: 0x101a2522
 */

void __noreturn std::vector<VertexManager::VFormat>::_Xlen()
{
