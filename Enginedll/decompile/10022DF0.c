/*
 * func-name: sub_10022DF0
 * func-address: 0x10022df0
 * callers: 0x100306d0
 * callees: 0x1001d6c0, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_10022DF0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D6C0((_DWORD *)this, v14) )
