/*
 * func-name: ?FreezeActors@Editor@@QAEXV?$vector@PAVActor@@V?$allocator@PAVActor@@@std@@@std@@@Z
 * func-address: 0x1008c1a0
 * callers: none
 * callees: 0x1000d4b0, 0x1000f2e0, 0x10083100, 0x1008bd00, 0x10091b60, 0x101a2500
 */

void __thiscall Editor::FreezeActors(Editor *this, char a2, void *a3, int a4, int a5)
{
  _DWORD *v6; // eax
