/*
 * func-name: sub_100A1DA0
 * func-address: 0x100a1da0
 * callers: 0x100a1210
 * callees: 0x1000eec0, 0x100a1d10
 */

unsigned int __thiscall sub_100A1DA0(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_1000EEC0((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
