/*
 * func-name: sub_10175990
 * func-address: 0x10175990
 * callers: 0x10175ea0
 * callees: 0x1001a9b0, 0x1001cb40, 0x100906b0, 0x10095080, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10175990(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
  ...
  if ( a4 )
  {
    ...
    if ( v9 >= a4 + v11 )
    {
      ...
      if ( (v20 - a3) >> 3 >= a4 )
      {
        this[2] = sub_100906B0(&v20[-8 * a4], v20, (_DWORD *)this[2]);
        sub_10135A50((int)a3, (int)&v20[-8 * a4], (int)v20);
        return sub_1010F430(a3, &a3[v28], v25);
      }
      else
      {
        sub_100906B0(a3, v20, &a3[8 * a4]);
        v23 = a4 - ((this[2] - (int)a3) >> 3);
        v22 = (_DWORD *)this[2];
        v26 = 2;
        sub_10135A90(v22, v23, v25);
        this[2] += v28;
        return sub_1010F430(a3, (_DWORD *)(this[2] - v28), v25);
      }
    }
    else
    {
      ...
      v15 = sub_10095080(v12);
      v21 = (_DWORD *)this[1];
      v25[2] = v15;
      v26 = 0;
      v16 = sub_1001CB40(v21, a3, v15);
      v17 = sub_10135A90(v16, a4, v25);
