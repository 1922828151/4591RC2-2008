/*
 * func-name: sub_1015C050
 * func-address: 0x1015c050
 * callers: none
 * callees: 0x10013a60
 */

char *__thiscall sub_1015C050(char *this)
{
  ...
  v10 = 1;
  v12 = &v3;
  std::string::string(&v3, "PrefabState");
  Factory::Factory(this, v3, v4, v5, v6, v7, v8, v9, v10, v11);
  *(_DWORD *)this = &TypedFactory<PrefabState>::`vftable';
  return this;
}
