/*
 * func-name: sub_100E8600
 * func-address: 0x100e8600
 * callers: 0x100e89c0
 * callees: 0x1001ad30, 0x1001f460, 0x10027030, 0x1008fa90, 0x100e7cb0, 0x100e7e40, 0x100e7ed0, 0x100e80d0, 0x101a2500, 0x101a2522
 */

int __thiscall sub_100E8600(int this, int a2, int a3, unsigned int a4, _DWORD *a5)
{
  int v6; // eax
  int v7; // ecx
  unsigned int v8; // ebx
  ...
  if ( a4 )
  {
    ...
    if ( v8 >= a4 + v9 )
    {
      ...
      {
        v22 = (int)v21 - 32 * a4;
        *(_DWORD *)(this + 8) = sub_100E80D0(v22, (int)v21, v21);
        sub_100E7E40(a3, v22, (int)v30);
        sub_100E7CB0(a3, a3 + 32 * a4, (int)v28);
      }
      else
      {
        sub_100E80D0(a3, (int)v21, (CREControl *)(a3 + 32 * a4));
        v25 = a4 - ((*(_DWORD *)(this + 8) - a3) >> 5);
        v24 = *(CREControl **)(this + 8);
        LOBYTE(v33) = 3;
        sub_100E7ED0(v24, v25, (int)v28);
        *(_DWORD *)(this + 8) += 32 * a4;
    ...
    else
    {
      ...
      v34 = v13;
      LOBYTE(v33) = 1;
      v15 = sub_1001F460(v14, a3, v13);
      v16 = sub_100E7ED0(v15, a4, (int)v28);
      v17 = *(_DWORD *)(this + 8);
      LOBYTE(v30) = 0;
      sub_1001F460(a3, v17, (CREControl *)v16);
      v18 = *(_DWORD *)(this + 4);
      v33 = 0;
      if ( v18 )
