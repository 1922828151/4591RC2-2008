/*
 * func-name: sub_10102BB0
 * func-address: 0x10102bb0
 * callers: 0x101032a0, 0x10103ef0
 * callees: 0x10104960, 0x101051a0, 0x101a2534
 */

int __thiscall sub_10102BB0(float *this, float **a2, int a3, int a4)
{
  void *v6; // eax
  float *v7; // eax
  double v8; // st7
...
LABEL_16:
        ...
        break;
      default:
        return sub_101051A0((int)(*a2 + 25), (int)&a4);
    }
  }
  return sub_101051A0((int)(*a2 + 25), (int)&a4);
}
