/*
 * func-name: ?SetSharedBool@ShaderManager@@QAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@_N@Z
 * func-address: 0x101209d0
 * callers: 0x10121160
 * callees: none
 */

int __thiscall ShaderManager::SetSharedBool(
        _DWORD *this,
        char a2,
        int a3,
        int a4,
        ...
        unsigned __int8 a9)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( *(_DWORD *)(*(_DWORD *)(v13 + v10 + 28) + 16) )
    {
      ...
      v18 = a9;
      v15 = (void (__stdcall **)(_DWORD *, int, int))(*v14 + 88);
