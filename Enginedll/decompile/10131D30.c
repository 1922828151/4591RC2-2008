/*
 * func-name: sub_10131D30
 * func-address: 0x10131d30
 * callers: 0x101321b0, 0x101324c0
 * callees: 0x10009c50, 0x100576e0, 0x1016caf0, 0x101a2522
 */

_DWORD *__thiscall sub_10131D30(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, int a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_100576E0(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
