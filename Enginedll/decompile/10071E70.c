/*
 * func-name: ??4CREScrollBar@@QAEAAV0@ABV0@@Z
 * func-address: 0x10071e70
 * callers: 0x10072370, 0x10072640, 0x10072a10
 * callees: 0x10071450
 */

int __thiscall CREScrollBar::operator=(int this, int a2)
{
  CREControl::operator=(this, a2);
  *(_BYTE *)(this + 532) = *(_BYTE *)(a2 + 532);
  *(_BYTE *)(this + 533) = *(_BYTE *)(a2 + 533);
