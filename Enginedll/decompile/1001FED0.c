/*
 * func-name: ??4?$vector@PAUModelFrame@@V?$allocator@PAUModelFrame@@@std@@@std@@QAEAAV01@ABV01@@Z
 * func-address: 0x1001fed0
 * callers: none
 * callees: 0x1001cd70, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall std::vector<ModelFrame *>::operator=(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( std::vector<ModelFrame *>::_Buy((_DWORD *)this, v14) )
