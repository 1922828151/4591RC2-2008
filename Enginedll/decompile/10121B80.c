/*
 * func-name: ?SetRenderTarget@Shader@@QAEXPAX@Z
 * func-address: 0x10121b80
 * callers: 0x1016da70, 0x1016e310
 * callees: 0x101189f0, 0x10120f40
 */

void __thiscall Shader::SetRenderTarget(Shader *this, void *a2)
{
  char *v3; // edi
  ...
  v3 = (char *)this + 12008;
  *((_DWORD *)this + 3017) = a2;
  Shader::SetVar(this, (Shader *)((char *)this + 12008));
  *((_DWORD *)v3 + 69) = 0;
