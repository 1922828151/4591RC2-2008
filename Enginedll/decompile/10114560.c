/*
 * func-name: sub_10114560
 * func-address: 0x10114560
 * callers: 0x101153f0
 * callees: 0x1010f390, 0x1010f960, 0x101120d0
 */

int __thiscall sub_10114560(_DWORD *this, int a2, _DWORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_101120D0(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v60 = v12;
...
LABEL_49:
  ...
  v52 = sub_1010F960((int)v49, v49[1], a3);
  sub_1010F390(v3 + 1, 1u);
  v49[1] = v52;
  *(_DWORD *)v52[1] = v52;
  if ( !v48 )
    invalid_parameter_noinfo();
