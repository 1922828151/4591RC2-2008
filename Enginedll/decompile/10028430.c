/*
 * func-name: sub_10028430
 * func-address: 0x10028430
 * callers: 0x1002cfa0, 0x10170260
 * callees: 0x1001b260, 0x1001cb40, 0x100906b0, 0x10095080, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10028430(_DWORD *this, int a2, _DWORD *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
