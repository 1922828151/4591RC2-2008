/*
 * func-name: ?AddOldDialogFromXML@CDlgMgr@@IAEPAVCTYDialog@@PAVDOMElement@xercesc_2_5@@@Z
 * func-address: 0x1014cfa0
 * callers: 0x1014dc70
 * callees: 0x100493a0, 0x100497b0, 0x10049910, 0x10049c70, 0x10049e00, 0x1007ec70, 0x100af0a0, 0x100b3510, 0x100baf70, 0x100ccaf0, 0x1014a750, 0x101a2534, 0x101a26c0
 */

struct CTYDialog *__thiscall CDlgMgr::AddOldDialogFromXML(CDlgMgr *this, struct xercesc_2_5::DOMElement *a2)
{
  CTYDialog *v2; // edi
  XMLSystem *v3; // ebp
  ...
  struct CREControl *OldControl; // eax
  ...
  *((_DWORD *)v2 + 174) = v23;
  ...
  for ( i = 0; i < (*(int (__thiscall **)(int))(*(_DWORD *)v24 + 8))(v24); ++i )
  {
    ...
    {
      OldControl = CDlgMgr::CreateOldControl(this, v2, v26);
      if ( OldControl )
        CREDialog::AddControl(v2, OldControl);
    }
  }
  v38 = -1;
