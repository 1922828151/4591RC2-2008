/*
 * func-name: sub_10176AC0
 * func-address: 0x10176ac0
 * callers: 0x10174d80
 * callees: 0x1001e190, 0x1002cd90, 0x100311f0, 0x1003b570, 0x1003b730
 */

int __thiscall sub_10176AC0(_DWORD *this, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1002CD90(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
...
LABEL_49:
  ...
  v55 = sub_100311F0(v52, *(CREControl **)(v52 + 4), a3);
  sub_1001E190(v3 + 1, 1u);
  *(_DWORD *)(v52 + 4) = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
