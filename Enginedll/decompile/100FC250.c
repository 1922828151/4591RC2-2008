/*
 * func-name: sub_100FC250
 * func-address: 0x100fc250
 * callers: 0x100fd750
...
void __thiscall sub_100FC250(_DWORD *this, int *a2, _DWORD *a3, int a4, float a5, float a6, float a7)
{
  _BYTE *v7; // esi
  int v9; // ecx
  ...
  v111 = &CanSmoothTangentsChecker::`vftable';
  v75 = 0;
  if ( std::vector<Model *>::size(a2) )
  {
    do
  ...
  if ( sub_100FDC20(v95) )
  {
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v24 = this[6];
        v25 = 15 * v22;
        v26 = *(float *)(v24 + 60 * v22 + 24);
        ++v78;
        v18 = i;
        v86 = v26 + v86;
        v87 = *(float *)(v24 + 4 * v25 + 28) + v87;
        v17 = *(float *)(v24 + 4 * v25 + 32) + v88;
      }
