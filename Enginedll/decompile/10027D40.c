/*
 * func-name: sub_10027D40
 * func-address: 0x10027d40
 * callers: 0x1002cd90
 * callees: 0x1001b0e0, 0x1001cb40, 0x100906b0, 0x10095080, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10027D40(_DWORD *this, int a2, _DWORD *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
