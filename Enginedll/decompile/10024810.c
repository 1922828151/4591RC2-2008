/*
 * func-name: ?_Insert_n@?$vector@PAUModelFrame@@V?$allocator@PAUModelFrame@@@std@@@std@@IAEXV?$_Vector_iterator@PAUModelFrame@@V?$allocator@PAUModelFrame@@@std@@@2@IABQAUModelFrame@@@Z
 * func-address: 0x10024810
 * callers: 0x1002ac80, 0x1002ad40, 0x1002add0, 0x1002adf0
 * callees: 0x100195a0, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall std::vector<ModelFrame *>::_Insert_n(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
