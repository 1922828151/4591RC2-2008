/*
 * func-name: sub_1000E6C0
 * func-address: 0x1000e6c0
 * callers: 0x10010a40, 0x100367a0, 0x1003e460, 0x1011acf0, 0x1011b080
 * callees: 0x1000bd50, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_1000E6C0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1000BD50((_DWORD *)this, v14) )
