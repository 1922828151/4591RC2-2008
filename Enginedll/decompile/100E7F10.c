/*
 * func-name: sub_100E7F10
 * func-address: 0x100e7f10
 * callers: 0x100e81c0, 0x100e8280
 * callees: 0x1001adb0, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_100E7F10(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
