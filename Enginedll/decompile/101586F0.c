/*
 * func-name: sub_101586F0
 * func-address: 0x101586f0
 * callers: 0x10158e90
 * callees: 0x100cdeb0, 0x100ce0d0, 0x100ce410, 0x100cfbe0, 0x100d1b10, 0x100d26a0, 0x10157a30, 0x10157b30, 0x10157cc0, 0x101a2500, 0x101a2522
 */

void __thiscall sub_101586F0(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // eax
  int v7; // ecx
  unsigned int v8; // edi
  ...
  if ( a4 )
  {
    ...
    if ( v8 >= a4 + v10 )
    {
      ...
      if ( ((char *)v21 - a3) / 36 >= a4 )
      {
        v22 = 36 * a4;
        v34 = (int)&v21[-9 * a4];
        this[2] = sub_100D1B10(&v21[v22 / 0xFFFFFFFC], v21, v21);
        sub_10157B30((int)a3, v34, v36);
        sub_10157A30(a3, &a3[v22], &v27);
      }
      else
      {
        sub_100D1B10(a3, v21, &a3[36 * a4]);
        v24 = a4 - (this[2] - (int)a3) / 36;
        v23 = (_DWORD *)this[2];
        LOBYTE(v33) = 3;
        sub_10157CC0(v23, v24, &v27);
        this[2] += 36 * a4;
    ...
    else
    {
      ...
      v35 = v13;
      LOBYTE(v33) = 1;
      v15 = sub_100CFBE0(v14, a3, v13);
      v16 = sub_10157CC0(v15, a4, &v27);
      v17 = (_DWORD *)this[2];
      LOBYTE(v30) = 0;
      sub_100CFBE0(a3, v17, v16);
      v18 = this[1];
      v19 = 0;
      v33 = 0;
      if ( v18 )
