/*
 * func-name: sub_10097100
 * func-address: 0x10097100
 * callers: none
 * callees: 0x10013a60
 */

char *__thiscall sub_10097100(char *this)
{
  ...
  v10 = 0;
  v12 = &v3;
  std::string::string(&v3, "PrefabInstance");
  Factory::Factory(this, v3, v4, v5, v6, v7, v8, v9, v10, v11);
  *(_DWORD *)this = &TypedFactory<PrefabInstance>::`vftable';
  return this;
}
