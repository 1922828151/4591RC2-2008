/*
 * func-name: sub_101006C0
 * func-address: 0x101006c0
 * callers: 0x10100a50
 * callees: 0x1000e7f0, 0x1001b350, 0x100fdcf0, 0x100ff6d0, 0x100ff700, 0x100ffde0, 0x10100210, 0x10100230, 0x10100450, 0x101156a0, 0x101a2500, 0x101a2522
 */

void __thiscall sub_101006C0(int this, int a2, char *a3, unsigned int a4, void *a5)
{
  int v6; // ecx
  int v7; // eax
  unsigned int v8; // ebx
  ...
  if ( a4 )
  {
    ...
    if ( v8 >= a4 + v9 )
    {
      ...
      if ( (v21 - (CREControl *)a3) >> 4 >= a4 )
      {
        ...
        *(_DWORD *)(this + 8) = sub_10100450(v22, v21, v21);
        sub_101156A0(a3, v22, v29);
        sub_100FF6D0((int)a3, (int)&a3[16 * a4], (int)&v27);
      }
      else
      {
        sub_10100450(a3, v21, (CREControl *)&a3[16 * a4]);
        v24 = a4 - ((*(_DWORD *)(this + 8) - (int)a3) >> 4);
        v23 = *(CREControl **)(this + 8);
        LOBYTE(v32) = 3;
        sub_10100230(v23, v24, (int)&v27);
        *(_DWORD *)(this + 8) += 16 * a4;
        v25 = *(_DWORD *)(this + 8) - 16 * a4;
        v32 = 0;
        sub_100FF6D0((int)a3, v25, (int)&v27);
      }
    }
    else
    {
      ...
      v33 = v13;
      LOBYTE(v32) = 1;
      v15 = sub_100FFDE0(v14, a3, v13);
      v16 = sub_10100230(v15, a4, (int)&v27);
      v17 = *(_DWORD **)(this + 8);
      LOBYTE(v29) = 0;
      sub_100FFDE0(a3, v17, (CREControl *)v16);
      v18 = *(_DWORD *)(this + 4);
      if ( v18 )
