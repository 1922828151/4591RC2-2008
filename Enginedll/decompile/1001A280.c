/*
 * func-name: ?_Xran@?$vector@UVFormat@VertexManager@@V?$allocator@UVFormat@VertexManager@@@std@@@std@@KAXXZ
 * func-address: 0x1001a280
 * callers: 0x1001d2e0
 * callees: 0x101a2522
 */

void __noreturn std::vector<VertexManager::VFormat>::_Xran()
{
