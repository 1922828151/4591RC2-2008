/*
 * func-name: sub_1003E4B0
 * func-address: 0x1003e4b0
 * callers: 0x1003e700
 * callees: 0x1001a670, 0x1001b350, 0x1001e620, 0x1003e2d0, 0x1003e3d0, 0x100f5d90, 0x100f5f30, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_1003E4B0(int this, int a2, char *a3, unsigned int a4, _DWORD *a5)
{
  int v5; // edx
  int v7; // ecx
  int v8; // edx
  ...
  if ( a4 )
  {
    ...
    else
    {
      ...
      v18 = (_DWORD *)sub_100F5F30(v17, a4, v29);
