/*
 * func-name: sub_1002F5F0
 * func-address: 0x1002f5f0
 * callers: 0x10030e80, 0x10031350, 0x100f4f00
 * callees: 0x1001cf30, 0x1001ea80, 0x1001eca0, 0x10023eb0, 0x1002cad0, 0x100901e0, 0x101a2522
 */

unsigned int __thiscall sub_1002F5F0(_DWORD *this, int a2)
{
  int v2; // esi
  int v4; // ecx
  unsigned int v5; // edx
  ...
  if ( v4 )
    ...
    v7 = 0;
  v27 = this + 4;
  sub_1002CAD0(this + 4, v7, (int)(this + 1), v5);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  sub_100901E0(this + 1);
  v23 = *(_DWORD **)(a2 + 8);
  ...
  v21 = this[2];
  v30 = 0;
  sub_10023EB0((_DWORD *)v6, v6, v21, a2 + 4, v22, a2 + 4, v23, a2);
  *(_BYTE *)v28 = *(_BYTE *)a2;
  v8 = **(_DWORD ***)(a2 + 8);
  v9 = 0;
  v25 = **(_DWORD ***)(v6 + 4);
