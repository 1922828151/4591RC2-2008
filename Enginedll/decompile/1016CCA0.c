/*
 * func-name: sub_1016CCA0
 * func-address: 0x1016cca0
 * callers: 0x1016cee0, 0x1016d2b0
 * callees: 0x10009c50, 0x1016caf0, 0x1016cb90, 0x101a2522
 */

_DWORD *__thiscall sub_1016CCA0(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, void *a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_1016CB90(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = v6 + 1;
  for ( i = (int)v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 44); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 44) )
      {
        ...
        {
          i = *v10;
          sub_1016CAF0(this, *v10);
        }
        *(_BYTE *)(*(_DWORD *)(i + 4) + 44) = 1;
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 44) = 0;
        sub_10009C50(this, *(_DWORD **)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 44) = 1;
