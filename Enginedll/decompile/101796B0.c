/*
 * func-name: sub_101796B0
 * func-address: 0x101796b0
 * callers: 0x10082fb0
 * callees: 0x10178b10, 0x101a2516, 0x101a281a, 0x101a28e0, 0x101a2c88
 */

void __thiscall sub_101796B0(const void *this, float *a2, float *a3, float *a4)
{
  float *v4; // esi
  float *v5; // ebx
  long double v6; // st7
