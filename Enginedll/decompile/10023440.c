/*
 * func-name: sub_10023440
 * func-address: 0x10023440
 * callers: 0x1002e3c0, 0x1003ba10
 * callees: 0x1001d870, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_10023440(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D870((_DWORD *)this, v14) )
