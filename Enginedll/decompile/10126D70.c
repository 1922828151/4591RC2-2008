/*
 * func-name: sub_10126D70
 * func-address: 0x10126d70
 * callers: 0x10127300
 * callees: 0x1000cd90, 0x1001ab30, 0x1001f0c0, 0x10023dc0, 0x10026fa0, 0x1008fa90, 0x10126830, 0x10126c20, 0x101a2500, 0x101a2522
 */

int __thiscall sub_10126D70(int this, int a2, char *a3, unsigned int a4, char *a5)
{
  int v6; // ecx
  int v7; // eax
  int v8; // ecx
  ...
  if ( a4 )
  {
    ...
    if ( v9 >= a4 + v10 )
    {
      ...
      if ( (v22 - (CREControl *)a3) >> 5 >= a4 )
      {
        ...
        *(_DWORD *)(this + 8) = sub_10023DC0(v23, v22, v22);
        sub_1000CD90((int)a3, (int)v23, (int)v31);
        sub_10126830(a3, &a3[32 * a4], &v29);
      }
      else
      {
        sub_10023DC0(a3, v22, (CREControl *)&a3[32 * a4]);
        v26 = a4 - ((*(_DWORD *)(this + 8) - (int)a3) >> 5);
        v25 = *(CREControl **)(this + 8);
        LOBYTE(v34) = 3;
        sub_10126C20(v25, v26, &v29);
        *(_DWORD *)(this + 8) += 32 * a4;
        v27 = (_DWORD *)(*(_DWORD *)(this + 8) - 32 * a4);
        v34 = 0;
    ...
    else
    {
      ...
      v35 = v14;
      LOBYTE(v34) = 1;
      v16 = sub_1001F0C0(v15, a3, v14);
      v17 = sub_10126C20(v16, a4, &v29);
      v18 = *(_DWORD **)(this + 8);
      LOBYTE(v31) = 0;
      sub_1001F0C0(a3, v18, (CREControl *)v17);
      v19 = *(_DWORD *)(this + 4);
      v34 = 0;
      if ( v19 )
