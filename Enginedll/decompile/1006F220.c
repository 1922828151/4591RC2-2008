/*
 * func-name: sub_1006F220
 * func-address: 0x1006f220
 * callers: 0x1006fc60, 0x1006fce0
 * callees: 0x1006c6b0, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall sub_1006F220(int this, unsigned int a2)
{
  unsigned int v2; // edx
  unsigned int v4; // eax
  unsigned int v5; // ecx
