/*
 * func-name: sub_10026A30
 * func-address: 0x10026a30
 * callers: 0x10033210
 * callees: 0x1001d7b0, 0x1001dd70, 0x1006f040, 0x100906b0, 0x101a2500
 */

_DWORD *__thiscall sub_10026A30(_DWORD *this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
