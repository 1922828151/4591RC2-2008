/*
 * func-name: sub_1016B160
 * func-address: 0x1016b160
 * callers: 0x10168040
 * callees: 0x10090220, 0x100a1d10
 */

unsigned int __thiscall sub_1016B160(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_10090220((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
