/*
 * func-name: sub_100786B0
 * func-address: 0x100786b0
 * callers: 0x10078b90, 0x10091040
 * callees: 0x1000a560, 0x10051fd0, 0x10052210, 0x1006bd90, 0x100d0040, 0x100fe6a0, 0x100fec20, 0x101466d0, 0x101a2500, 0x101a2522
 */

int __thiscall sub_100786B0(int this, int a2, char *a3, unsigned int a4, _DWORD *a5)
{
  int v5; // edx
  int result; // eax
  int v8; // ecx
  ...
  if ( a4 )
  {
    ...
    if ( v9 >= a4 + v11 )
    {
      ...
      if ( (v19 - a3) / 12 >= a4 )
      {
        v20 = 12 * a4;
        v27 = (int)&v19[-12 * a4];
        *(_DWORD *)(this + 8) = sub_101466D0(&v19[-v20], v19, v19);
        sub_100FEC20(a3, v27, v29);
        return sub_100FE6A0(a3, &a3[v20], v25);
      }
      else
      {
        ...
        *(_DWORD *)(this + 8) += 12 * a4;
        return sub_100FE6A0(a3, *(_DWORD *)(this + 8) - 12 * a4, v25);
      }
    }
    else
    {
      ...
      v15 = (_DWORD *)sub_100D0040(v14, a4, v25);
