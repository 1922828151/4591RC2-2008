/*
 * func-name: sub_100773F0
 * func-address: 0x100773f0
 * callers: 0x10077900
 * callees: 0x1003b6b0, 0x10057ee0, 0x100770b0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_100773F0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_100770B0((_DWORD *)this, v14) )
