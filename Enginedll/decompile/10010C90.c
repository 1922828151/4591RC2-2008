/*
 * func-name: sub_10010C90
 * func-address: 0x10010c90
 * callers: 0x10012400, 0x10059c90
 * callees: 0x1000a760, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_10010C90(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
