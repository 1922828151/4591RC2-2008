/*
 * func-name: ?reserve@?$vector@PAVActor@@V?$allocator@PAVActor@@@std@@@std@@QAEXI@Z
 * func-address: 0x1001fe20
 * callers: 0x100d0540
 * callees: 0x1000a0f0, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall std::vector<Actor *>::reserve(int this, unsigned int a2)
{
  int v3; // ecx
