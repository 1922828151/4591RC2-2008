/*
 * func-name: ?setMouseOverPic@CPicCheckBox@@QAEXABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUtagRECT@@@Z
 * func-address: 0x100b1e40
 * callers: 0x1014a750
 * callees: 0x1006c5d0, 0x100a5d90, 0x1017a280, 0x101a2534
 */

int __thiscall CPicCheckBox::setMouseOverPic(int this, int a2, _DWORD *a3)
{
  int result; // eax
  int v5; // esi
  int v6; // eax
    ...
    *(_DWORD *)v5 = v9;
    ...
    if ( result >= 1 )
    {
      ...
      if ( result >= 0 )
      {
        result = (int)memmove(
                        (void *)(*(_DWORD *)v10 + 8),
                        (const void *)(*(_DWORD *)v10 + 4),
                        4 * *(_DWORD *)(this + 856) - 4);
        *(_DWORD *)(*(_DWORD *)v10 + 4) = v5;
        ++*(_DWORD *)(this + 856);
      }
    }
  }
