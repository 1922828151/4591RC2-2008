/*
 * func-name: ?reserve@?$vector@PAVMatrix@@V?$allocator@PAVMatrix@@@std@@@std@@QAEXI@Z
 * func-address: 0x100212e0
 * callers: none
 * callees: 0x100198a0, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall std::vector<Matrix *>::reserve(int this, unsigned int a2)
{
  int v3; // ecx
