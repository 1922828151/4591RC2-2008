/*
 * func-name: ?GetSound@MaterialIntersect@@QAE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V23@PAVMaterial@@@Z
 * func-address: 0x101599b0
 * callers: none
 * callees: 0x10159690
 */
        ...
        char *a10)
{
  ...
  {
    v12 = std::string::string(v31, &unk_101CD697);
    v10 = 1;
    LOBYTE(v32) = 2;
    v28 = 1;
  }
  ...
  LOBYTE(v32) = 4;
  MaterialIntersect::GetSound(this, a2, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, v25, v26, v27);
  v28 = v10 | 2;
  LOBYTE(v32) = 1;
