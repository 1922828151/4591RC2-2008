/*
 * func-name: sub_1017A4A0
 * func-address: 0x1017a4a0
 * callers: 0x10097ea0, 0x100dbc90, 0x100dcbd0, 0x1017e0a0
 * callees: none
 */

int __cdecl sub_1017A4A0(int a1)
{
  int last_not_of; // edi
  int v2; // eax
  int v3; // edi
  ...
  {
    std::string::operator=(a1, &unk_101CE7BF);
  }
  ...
  if ( v3 == std::string::npos )
    return std::string::operator=(a1, &unk_101CE7C3);
