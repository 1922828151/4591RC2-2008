/*
 * func-name: sub_10012840
 * func-address: 0x10012840
 * callers: 0x100136b0
 * callees: 0x10011320, 0x100a1d10
 */

unsigned int __thiscall sub_10012840(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_10011320((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
