/*
 * func-name: sub_1003C0B0
 * func-address: 0x1003c0b0
 * callers: 0x1003c7f0
 * callees: 0x1003b4d0, 0x1003b570, 0x1003b620, 0x1003b730, 0x1003bf60
 */

int __thiscall sub_1003C0B0(_DWORD *this, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1003BF60(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
...
LABEL_49:
  ...
  v55 = sub_1003B620((int)v52, v52[1], a3);
  sub_1003B4D0(v3 + 1, 1u);
  v52[1] = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
