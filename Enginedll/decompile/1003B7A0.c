/*
 * func-name: sub_1003B7A0
 * func-address: 0x1003b7a0
 * callers: 0x1003bb50
 * callees: 0x10009a40, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_1003B7A0(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
