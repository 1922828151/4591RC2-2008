/*
 * func-name: ??4?$vector@PAVModel@@V?$allocator@PAVModel@@@std@@@std@@QAEAAV01@ABV01@@Z
 * func-address: 0x10020000
 * callers: 0x1002d2e0, 0x1002e5e0
 * callees: 0x1001ce30, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall std::vector<Model *>::operator=(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( std::vector<Model *>::_Buy((_DWORD *)this, v14) )
