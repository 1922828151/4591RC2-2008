/*
 * func-name: ?CacheSound2DTMP@Precacher@@SAPAVSound@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z
 * func-address: 0x1010b790
 * callers: 0x1010be70, 0x1010cb00
 * callees: 0x10054c00, 0x1010fd40, 0x101150d0, 0x1017a2d0, 0x1017a310, 0x1017a610
 */

_DWORD *__cdecl Precacher::CacheSound2DTMP(char a1)
{
  int v1; // eax
  int v2; // eax
  void *v3; // esi
