/*
 * func-name: sub_1000E890
 * func-address: 0x1000e890
 * callers: 0x100122d0, 0x100368e0, 0x100fb120, 0x100ff6d0
 * callees: 0x1000bda0, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_1000E890(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1000BDA0((_DWORD *)this, v14) )
