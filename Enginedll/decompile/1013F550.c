/*
 * func-name: sub_1013F550
 * func-address: 0x1013f550
 * callers: 0x1013db50
 * callees: 0x100a1d10, 0x1011a290
 */

unsigned int __thiscall sub_1013F550(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_1011A290((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
