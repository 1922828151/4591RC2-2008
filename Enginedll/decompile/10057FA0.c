/*
 * func-name: sub_10057FA0
 * func-address: 0x10057fa0
 * callers: 0x10059e70, 0x1012d8d0, 0x1012dbd0
 * callees: 0x10056bc0, 0x10056be0, 0x10056f00, 0x10056f50, 0x10056fb0, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10057FA0(_DWORD *this, _DWORD *a2, int a3, int a4)
{
  int *v5; // ebx
  int v6; // edi
  int v7; // ecx
      ...
      do
      {
        ...
        else
        {
          if ( !v16[52] )
          {
            v16[52] = 1;
            *(_BYTE *)(v8 + 52) = 0;
            sub_10056F50(this, (_DWORD *)v8);
            v16 = *(_BYTE **)v8;
          }
          if ( v16[53] )
            goto LABEL_53;
          v17 = *((_DWORD *)v16 + 2);
          if ( *(_BYTE *)(v17 + 52) != 1 || *(_BYTE *)(*(_DWORD *)v16 + 52) != 1 )
          {
            if ( *(_BYTE *)(*(_DWORD *)v16 + 52) == 1 )
            {
              *(_BYTE *)(v17 + 52) = 1;
              v16[52] = 0;
              sub_10056F00(this, (int)v16);
              v16 = *(_BYTE **)v8;
            }
            v16[52] = *(_BYTE *)(v8 + 52);
            *(_BYTE *)(v8 + 52) = 1;
