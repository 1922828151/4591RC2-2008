/*
 * func-name: sub_10031B20
 * func-address: 0x10031b20
 * callers: 0x10031ff0, 0x100326a0
 * callees: 0x1001cf30, 0x1001ea80, 0x1001eca0, 0x1002cfa0, 0x10031040, 0x100313e0, 0x101a2522
 */

unsigned int __thiscall sub_10031B20(_DWORD *this, int a2)
{
  int v2; // esi
  int v4; // ecx
  unsigned int v5; // edx
  ...
  if ( v4 )
    ...
    v7 = 0;
  v27 = this + 4;
  sub_1002CFA0(this + 4, v7, (int)(this + 1), v5);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  sub_10031040(this + 1);
  v23 = *(_DWORD **)(a2 + 8);
  ...
  v21 = this[2];
  v30 = 0;
  sub_100313E0((_DWORD *)v6, v6, v21, a2 + 4, v22, a2 + 4, v23, a2);
  *(_BYTE *)v28 = *(_BYTE *)a2;
  v8 = **(_DWORD ***)(a2 + 8);
  v9 = 0;
  v25 = **(_DWORD ***)(v6 + 4);
