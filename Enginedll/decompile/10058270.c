/*
 * func-name: sub_10058270
 * func-address: 0x10058270
 * callers: 0x10059fc0, 0x1012d990, 0x1012da50, 0x1012db10, 0x1012dc90, 0x1012dd50
 * callees: 0x10009c50, 0x10009d30, 0x1000b770, 0x1006c430, 0x1016caf0, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10058270(_DWORD *this, _DWORD *a2, int a3, int a4)
{
  _DWORD *v5; // ebx
  int v6; // edi
  int v7; // ecx
