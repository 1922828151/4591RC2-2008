/*
 * func-name: sub_100E81C0
 * func-address: 0x100e81c0
 * callers: 0x100e78e0
 * callees: 0x100a1d10, 0x100e7f10
 */

unsigned int __thiscall sub_100E81C0(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_100E7F10((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
