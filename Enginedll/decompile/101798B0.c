/*
 * func-name: sub_101798B0
 * func-address: 0x101798b0
 * callers: none
 * callees: 0x1017b990
 */

void __thiscall sub_101798B0(float *this, float *a2, float *a3, float *a4)
{
  float *v5; // eax
  double v6; // st6
  double v7; // st7
  ...
  _BYTE v16[12]; // [esp+28h] [ebp-Ch] BYREF
  ...
  v15[1] = a3[1] - a2[1];
  v15[2] = a3[2] - a2[2];
  v5 = (float *)sub_1017B990(v16, v15, v14);
  v17 = fabs(*v5);
  v11 = v17;
  v18 = fabs(v5[1]);
  v12 = v18;
