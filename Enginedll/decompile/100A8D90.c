/*
 * func-name: ?SetBackGround@CMultiLineStatic@@QAEXABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
 * func-address: 0x100a8d90
 * callers: 0x1014a750
 * callees: 0x100a5d90, 0x1017a280, 0x101a2500, 0x101a2534
 */

void __thiscall CMultiLineStatic::SetBackGround(int this, int a2)
{
  _BYTE *v3; // eax
  int v4; // eax
  bool v5; // cf
