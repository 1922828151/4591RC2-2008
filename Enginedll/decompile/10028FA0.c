/*
 * func-name: ?RemoveInBlockers@PRTSettings@@QAEXAAV?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@Z
 * func-address: 0x10028fa0
 * callers: none
 * callees: 0x100246c0, 0x100993b0
 */

unsigned int __thiscall PRTSettings::RemoveInBlockers(char *this, int a2)
{
