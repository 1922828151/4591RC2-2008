/*
 * func-name: sub_100FF430
 * func-address: 0x100ff430
 * callers: 0x100ff8b0
 * callees: 0x10051fd0, 0x10052210, 0x1006bd90, 0x100d0040, 0x100fdd70, 0x100fe6a0, 0x100fec20, 0x101466d0, 0x101a2500, 0x101a2522
 */

int __thiscall sub_100FF430(int this, int a2, char *a3, unsigned int a4, _DWORD *a5)
{
  int v5; // edx
  int result; // eax
  int v8; // ecx
