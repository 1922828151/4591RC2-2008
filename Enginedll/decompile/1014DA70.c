/*
 * func-name: ?LoadUIXML@CDlgMgr@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAM@Z
 * func-address: 0x1014da70
 * callers: 0x1014de70
 * callees: 0x100490f0, 0x10049860, 0x10049910, 0x1004a5a0, 0x1004ae30, 0x1007ec70, 0x10097220, 0x100aef10, 0x1014a050, 0x1014cc50
 */

char __thiscall CDlgMgr::LoadUIXML(CDlgMgr *this, int a2, float *a3)
{
        ...
        XMLSystem::Load((int)v5, v20, v21, v22, v23, v24, (int)v25, SLODWORD(v26))) )
  {
    ...
    for ( i = 0; i < (*(int (__thiscall **)(int))(*(_DWORD *)v8 + 8))(v8); v11 = i )
    {
      ...
      if ( (*(unsigned __int16 (__thiscall **)(struct xercesc_2_5::DOMElement *))(*(_DWORD *)v12 + 12))(v12) == 1 )
      {
        ...
        {
          v15 = CDlgMgr::AddDialogFromXML(v27, v12);
          v16 = v15;
          if ( v15 )
          {
