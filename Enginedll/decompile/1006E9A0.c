/*
 * func-name: sub_1006E9A0
 * func-address: 0x1006e9a0
 * callers: 0x10075780
 * callees: 0x1006c100, 0x1006c4d0, 0x100a1cd0, 0x1010fea0, 0x101a2522
 */

_DWORD *__thiscall sub_1006E9A0(_DWORD *this, int a2)
{
  int v2; // eax
  unsigned int v4; // esi
  char *v5; // eax
