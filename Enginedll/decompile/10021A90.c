/*
 * func-name: sub_10021A90
 * func-address: 0x10021a90
 * callers: 0x10024100
 * callees: 0x1001d440, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_10021A90(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D440((_DWORD *)this, v14) )
