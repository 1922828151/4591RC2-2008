/*
 * func-name: sub_1000D9A0
 * func-address: 0x1000d9a0
 * callers: 0x1000f220, 0x10055500, 0x100566a0, 0x1005b6b0, 0x10062540, 0x100626d0, 0x10062e00, 0x1006e120, 0x100733c0, 0x100747f0, 0x10075480, 0x100d75b0
 * callees: 0x1000c540, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_1000D9A0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1000C540((_DWORD *)this, v14) )
