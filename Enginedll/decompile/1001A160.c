/*
 * func-name: ?_Xinvarg@?$vector@UAttributeRange@@V?$allocator@UAttributeRange@@@std@@@std@@KAXXZ
 * func-address: 0x1001a160
 * callers: none
 * callees: 0x101a2522
 */

void __noreturn std::vector<AttributeRange>::_Xinvarg()
{
