/*
 * func-name: sub_1012B890
 * func-address: 0x1012b890
 * callers: 0x10128c50
 * callees: 0x100a1d10, 0x1012b610
 */

unsigned int __thiscall sub_1012B890(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_1012B610((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
