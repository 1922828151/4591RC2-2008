/*
 * func-name: sub_101702D0
 * func-address: 0x101702d0
 * callers: 0x1016fa20
 * callees: 0x1001e230, 0x1001e270, 0x1002ce40
 */

int __thiscall sub_101702D0(_DWORD *this, int a2, _DWORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1002CE40(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v60 = v12;
