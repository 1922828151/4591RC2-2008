/*
 * func-name: sub_1016B8E0
 * func-address: 0x1016b8e0
 * callers: 0x10162f00
 * callees: 0x100a1d10, 0x1016b490
 */

unsigned int __thiscall sub_1016B8E0(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_1016B490((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
