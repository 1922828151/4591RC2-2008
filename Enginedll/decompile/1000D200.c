/*
 * func-name: sub_1000D200
 * func-address: 0x1000d200
 * callers: 0x1000eaf0
 * callees: 0x1000c930, 0x10131a50
 */

int __thiscall sub_1000D200(_DWORD *this, int a2, int a3)
{
  _DWORD *v4; // edi
  int *v5; // esi
  char v6; // al
  ...
  if ( v6 )
  {
    if ( v4 == *(_DWORD **)this[1] )
    {
      v8 = sub_1000C930(this, &v14, 1, v4, a3);
      v9 = *v8;
      result = a2;
      *(_DWORD *)(a2 + 4) = v8[1];
      *(_BYTE *)(a2 + 8) = 1;
  ...
  {
    v11 = sub_1000C930(this, &v14, v13, v4, a3);
    v12 = (_DWORD *)*v11;
    result = a2;
    *(_DWORD *)(a2 + 4) = v11[1];
    *(_BYTE *)(a2 + 8) = 1;
