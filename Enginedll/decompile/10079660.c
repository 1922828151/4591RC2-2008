/*
 * func-name: sub_10079660
 * func-address: 0x10079660
 * callers: 0x1004c6f0, 0x1005faa0, 0x1007a540, 0x1007a830
 * callees: none
 */

int __cdecl sub_10079660(int a1, int a2, float *a3, int a4, float *a5, float *a6)
{
  float *v6; // ecx
  int v7; // ebp
  int v8; // edi
