/*
 * func-name: ?Save@MaterialLibrary@@QAE_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
 * func-address: 0x100e28d0
 * callers: none
 * callees: 0x10001720, 0x100407f0
 */

char __thiscall MaterialLibrary::Save(char *this, char a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  char v9; // bl
  ...
  v9 = MaterialSerializer::Save((MaterialSerializer *)v20, v11, v12, v13, v14, v15, v16, v17, v18);
  LOBYTE(v22) = 2;
