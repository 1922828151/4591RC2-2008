/*
 * func-name: sub_10058A90
 * func-address: 0x10058a90
 * callers: 0x1005afe0, 0x1005ed30, 0x1016af00, 0x1016b650
 * callees: 0x1003b6b0, 0x10057400, 0x10057ee0, 0x10108bc0, 0x101a2500
 */
...
int __thiscall sub_10058A90(int this, int a2)
{
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_10057400((_DWORD *)this, v14) )
