/*
 * func-name: sub_1017AEA0
 * func-address: 0x1017aea0
 * callers: none
 * callees: 0x1017a610
 */

int __cdecl sub_1017AEA0(int a1, int a2)
{
  int first_of; // eax
  int v3; // eax
  int v4; // eax
  ...
  first_of = std::string::find_first_of(a1, &unk_101CE7BC, 0);
  ...
  if ( !std::string::find_first_of(a1, &unk_101CE7C0, 0) )
  {
  ...
  v5 = std::string::find_first_of(a1, &unk_101CE7C4, 0);
  for ( i = (_DWORD *)std::string::npos; v5 != std::string::npos; i = (_DWORD *)std::string::npos )
  {
    v7 = std::string::replace(a1, v5, 1, &unk_101CE7C8);
    std::string::operator=(a1, v7);
    v5 = std::string::find_first_of(a1, &unk_101CE7C4, v5 + 1);
  }
  last_of = std::string::find_last_of(a1, &unk_101CE7CC, *i);
