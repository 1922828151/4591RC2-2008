/*
 * func-name: sub_100F6560
 * func-address: 0x100f6560
 * callers: 0x100f37e0
 * callees: 0x100a1d10, 0x100f60e0
 */

unsigned int __thiscall sub_100F6560(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_100F60E0((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
