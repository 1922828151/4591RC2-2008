/*
 * func-name: sub_100228A0
 * func-address: 0x100228a0
 * callers: 0x10024490, 0x1002e5e0, 0x100ecce0, 0x100ecdb0, 0x1011f510
 * callees: 0x1001d620, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_100228A0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D620((_DWORD *)this, v14) )
