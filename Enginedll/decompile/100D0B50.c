/*
 * func-name: sub_100D0B50
 * func-address: 0x100d0b50
 * callers: 0x100d4210
 * callees: 0x1003b6b0, 0x10057ee0, 0x100cec80, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_100D0B50(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_100CEC80((_DWORD *)this, v14) )
