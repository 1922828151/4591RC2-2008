/*
 * func-name: ?_Insert_n@?$vector@PAVModel@@V?$allocator@PAVModel@@@std@@@std@@IAEXV?$_Vector_iterator@PAVModel@@V?$allocator@PAVModel@@@std@@@2@IABQAVModel@@@Z
 * func-address: 0x10024a40
 * callers: 0x1002aed0, 0x1002af90, 0x1002b020, 0x1002b040
 * callees: 0x10019720, 0x1003b6b0, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall std::vector<Model *>::_Insert_n(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
