/*
 * func-name: sub_101677E0
 * func-address: 0x101677e0
 * callers: none
 * callees: 0x10013a60
 */

char *__thiscall sub_101677E0(char *this)
{
  ...
  v10 = 1;
  v12 = &v3;
  std::string::string(&v3, "SurfaceNode");
  Factory::Factory(this, v3, v4, v5, v6, v7, v8, v9, v10, v11);
  *(_DWORD *)this = &TypedFactory<SurfaceNode>::`vftable';
  return this;
}
