/*
 * func-name: sub_100323B0
 * func-address: 0x100323b0
 * callers: 0x10032760, 0x10033210
 * callees: 0x1001cf30, 0x1001ea80, 0x1001eca0, 0x1002cb80, 0x10031700, 0x10031d00, 0x101a2522
 */

unsigned int __thiscall sub_100323B0(_DWORD *this, int a2)
{
  int v2; // esi
  int v4; // ecx
  unsigned int v5; // edx
  ...
  if ( v4 )
    ...
    v7 = 0;
  v27 = this + 4;
  sub_1002CB80(this + 4, v7, (int)(this + 1), v5);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  sub_10031700(this + 1);
  v23 = *(_DWORD **)(a2 + 8);
  ...
  v21 = this[2];
  v30 = 0;
  sub_10031D00((_DWORD *)v6, v6, v21, a2 + 4, v22, a2 + 4, v23, a2);
  *(_BYTE *)v28 = *(_BYTE *)a2;
  v8 = **(_DWORD ***)(a2 + 8);
  v9 = 0;
  v25 = **(_DWORD ***)(v6 + 4);
