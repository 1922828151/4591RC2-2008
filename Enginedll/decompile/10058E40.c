/*
 * func-name: sub_10058E40
 * func-address: 0x10058e40
 * callers: 0x1005ed30
 * callees: 0x1003b6b0, 0x100574f0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_10058E40(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_100574F0((_DWORD *)this, v14) )
