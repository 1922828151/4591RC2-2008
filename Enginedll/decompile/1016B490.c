/*
 * func-name: sub_1016B490
 * func-address: 0x1016b490
 * callers: 0x1016b8e0
 * callees: 0x1003b6b0, 0x10056e00, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_1016B490(int this, int a2, _DWORD *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
