/*
 * func-name: ??4?$vector@PAVEditorVar@@V?$allocator@PAVEditorVar@@@std@@@std@@QAEAAV01@ABV01@@Z
 * func-address: 0x10020260
 * callers: none
 * callees: 0x1001cfc0, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */
...
int __thiscall std::vector<EditorVar *>::operator=(int this, int a2)
{
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( std::vector<EditorVar *>::_Buy((_DWORD *)this, v14) )
