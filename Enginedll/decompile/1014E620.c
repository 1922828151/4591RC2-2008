/*
 * func-name: sub_1014E620
 * func-address: 0x1014e620
 * callers: 0x1014eae0, 0x1014ecb0
 * callees: 0x100ce2a0, 0x100ce2f0, 0x100cedb0, 0x101a2522
 */

_DWORD *__thiscall sub_1014E620(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, _DWORD *a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_100CEDB0(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = v6 + 1;
  for ( i = (int)v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 20); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 20) )
      {
        ...
        {
          i = *v10;
          sub_100CE2A0(this, *v10);
        }
        *(_BYTE *)(*(_DWORD *)(i + 4) + 20) = 1;
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 20) = 0;
        sub_100CE2F0(this, *(_DWORD **)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 20) = 1;
