/*
 * func-name: sub_1013EDB0
 * func-address: 0x1013edb0
 * callers: 0x1013f210
 * callees: 0x1001aeb0, 0x1001af00, 0x1001dc30, 0x101a2522
 */

_DWORD *__thiscall sub_1013EDB0(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, int a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_1001DC30(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = v6 + 1;
  for ( i = (int)v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 48); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 48) )
      {
        ...
        {
          i = *v10;
          sub_1001AEB0(this, *v10);
        }
        *(_BYTE *)(*(_DWORD *)(i + 4) + 48) = 1;
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 48) = 0;
        sub_1001AF00(this, *(_DWORD **)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 48) = 1;
