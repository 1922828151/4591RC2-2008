/*
 * func-name: sub_1002FBC0
 * func-address: 0x1002fbc0
 * callers: 0x10030fd0, 0x100326a0
 * callees: 0x1001cf30, 0x1001dbd0, 0x1001ea80, 0x1001eca0, 0x10020c00, 0x1002cef0, 0x101a2500, 0x101a2522
 */

unsigned int __thiscall sub_1002FBC0(_DWORD *this, int a2)
{
  int v3; // ecx
  unsigned int v4; // edx
  char *v5; // esi
  ...
  if ( v3 )
    ...
    v6 = 0;
  v28 = (char *)(this + 4);
  sub_1002CEF0(this + 4, v6, (int)(this + 1), v4);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  ...
  *(_DWORD *)(this[2] + 4) = this[2];
  ...
  v23 = this[2];
  v31 = 0;
  sub_10020C00(this + 1, (int)(this + 1), v23, a2 + 4, v24, a2 + 4, v10, a2);
  *(_BYTE *)this = *(_BYTE *)a2;
  v11 = **(_DWORD ***)(a2 + 8);
  v12 = 0;
