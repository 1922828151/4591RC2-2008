/*
 * func-name: ?reserve@?$vector@PAVMaterial@@V?$allocator@PAVMaterial@@@std@@@std@@QAEXI@Z
 * func-address: 0x100214e0
 * callers: none
 * callees: 0x1000a1e0, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall std::vector<Material *>::reserve(int this, unsigned int a2)
{
  int v3; // ecx
