/*
 * func-name: sub_1011F7A0
 * func-address: 0x1011f7a0
 * callers: 0x1011b870, 0x1011d270
 * callees: 0x100a1d10, 0x100ecaa0
 */

unsigned int __thiscall sub_1011F7A0(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_100ECAA0((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
