/*
 * func-name: sub_10074C30
 * func-address: 0x10074c30
 * callers: 0x10075bb0
 * callees: 0x10057380, 0x10057540, 0x10058580, 0x10058f70, 0x1006c940, 0x10070eb0, 0x1013efb0
 */

_DWORD *__thiscall sub_10074C30(_DWORD *this, _DWORD *a2)
{
  unsigned int v3; // ecx
  _DWORD *v5; // eax
  _DWORD *v6; // ebx
  ...
  if ( this != a2 )
  {
    ...
    v12 = v6;
    v13 = v7;
    sub_1006C940(this, &v8);
    sub_10070EB0(this, v8, v9, v10, v11, v12, v13, v14, (int)v15, v16);
  }
  return this;
}
