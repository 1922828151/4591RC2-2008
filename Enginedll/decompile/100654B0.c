/*
 * func-name: ?TextCenteredf@Canvas@@UAAXW4FONT_TYPE@@KHHHHPBDZZ
 * func-address: 0x100654b0
 * callers: none
 * callees: 0x100971c0, 0x101189f0, 0x101a26c0
 */

int Canvas::TextCenteredf(int a1, int a2, unsigned int a3, int a4, int a5, int a6, int yBottom, char *Format, ...)
{
  int v8; // edi
  int v9; // ebx
  int v10; // ebp
  ...
  int v15; // ebp
  int v16; // ecx
  char v18; // [esp+37h] [ebp-429h] BYREF
  unsigned int v19; // [esp+38h] [ebp-428h]
  int *v20; // [esp+3Ch] [ebp-424h] BYREF
  __int64 v21; // [esp+40h] [ebp-420h]
  int v22; // [esp+48h] [ebp-418h] BYREF
  int v23; // [esp+4Ch] [ebp-414h] BYREF
  struct tagRECT rc; // [esp+50h] [ebp-410h] BYREF
  char Buffer[1024]; // [esp+60h] [ebp-400h] BYREF
  int v26; // [esp+478h] [ebp+18h]
  int yBottoma; // [esp+47Ch] [ebp+1Ch]
  va_list ArgList; // [esp+484h] [ebp+24h] BYREF
  ...
  if ( v18 )
  {
    ...
    (*(void (__thiscall **)(int *, char *, struct tagRECT *, int, int))(v15 + 20))(
      v20,
      Buffer,
      &rc,
  ...
  return (*(int (__thiscall **)(int *, char *, struct tagRECT *, unsigned int, int))(*v20 + 20))(
           v20,
           Buffer,
           &rc,
           a3,
