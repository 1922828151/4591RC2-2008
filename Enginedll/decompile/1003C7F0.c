/*
 * func-name: sub_1003C7F0
 * func-address: 0x1003c7f0
 * callers: 0x1003adf0
 * callees: 0x1003c0b0, 0x1010fd40
 */

int __thiscall sub_1003C7F0(_DWORD *this, int a2)
{
  _DWORD *v3; // edi
  int v4; // ebx
  _DWORD *v5; // eax
  ...
  if ( v8 == v10 )
  {
    ...
    v12 = 0;
    v13 = 0;
    v5 = (_DWORD *)sub_1003C0B0(this, (int)v9, (int)v11);
    v3 = (_DWORD *)*v5;
    v4 = v5[1];
    v13 = -1;
