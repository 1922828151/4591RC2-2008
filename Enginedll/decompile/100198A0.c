/*
 * func-name: ?_Xlen@?$vector@PAVMatrix@@V?$allocator@PAVMatrix@@@std@@@std@@KAXXZ
 * func-address: 0x100198a0
 * callers: 0x1001cee0, 0x10021240, 0x100212e0, 0x10024c00, 0x10024c70
 * callees: 0x101a2522
 */

void __noreturn std::vector<Matrix *>::_Xlen()
{
