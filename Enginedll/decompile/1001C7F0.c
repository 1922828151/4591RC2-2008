/*
 * func-name: sub_1001C7F0
 * func-address: 0x1001c7f0
 * callers: 0x10020950, 0x1016f260, 0x1016f450, 0x1016fa20
 * callees: 0x101a2522
 */

int __thiscall sub_1001C7F0(_DWORD *this, unsigned int a2)
{
  int v2; // eax
  int result; // eax
