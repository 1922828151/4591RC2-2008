 ...
 * callers: 0x10062b50, 0x10062b80
 * callees: 0x1000d900, 0x10061e00, 0x101a2500, 0x101a2522
 */

CREControl *__cdecl sub_100627B0(_DWORD *a1, _DWORD *a2, CREControl *a3)
{
  CREControl *v3; // esi
  int v5; // eax
  int v6; // eax
