/*
 * func-name: ?_Xlen@?$vector@UAttributeRange@@V?$allocator@UAttributeRange@@@std@@@std@@KAXXZ
 * func-address: 0x1001a060
 * callers: 0x1001d290, 0x10022210, 0x10022300, 0x100223c0, 0x10022540
 * callees: 0x101a2522
 */

void __noreturn std::vector<AttributeRange>::_Xlen()
{
