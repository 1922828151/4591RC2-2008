/*
 * func-name: ?reserve@?$vector@PAUModelFrame@@V?$allocator@PAUModelFrame@@@std@@@std@@QAEXI@Z
 * func-address: 0x10021010
 * callers: none
 * callees: 0x100195a0, 0x100dd410, 0x101a2500
 */

unsigned int __thiscall std::vector<ModelFrame *>::reserve(int this, unsigned int a2)
{
  int v3; // ecx
