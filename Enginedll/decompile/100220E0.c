/*
 * func-name: sub_100220E0
 * func-address: 0x100220e0
 * callers: 0x10024490, 0x1002da40, 0x100ecce0, 0x100ecd30, 0x100ecdb0, 0x1011f510
 * callees: 0x1001d5d0, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_100220E0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D5D0((_DWORD *)this, v14) )
