/*
 * func-name: ?CombineSelected@Editor@@QAEXXZ
 * func-address: 0x10085e90
 * callers: none
 * callees: 0x10011750, 0x100117e0, 0x1002b5c0, 0x10059c90, 0x10077b70, 0x10078420, 0x1007e290, 0x10082810, 0x10090770, 0x1009dd90, 0x1009ee50, 0x100e4400, 0x101189f0, 0x101372f0, 0x101780d4, 0x101786e0, 0x10178c20, 0x10179590, 0x1017eaef, 0x101a2500, 0x101a251c
 */

void __thiscall Editor::CombineSelected(Editor *this)
{
  Editor *v1; // ebp
  unsigned int i; // esi
  int v3; // ecx
