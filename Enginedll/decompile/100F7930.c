/*
 * func-name: sub_100F7930
 * func-address: 0x100f7930
 * callers: 0x100f2d50, 0x10114e90
 * callees: 0x1001de70, 0x1001edf0, 0x1002cad0, 0x1003b570, 0x1003b730
 */

int __thiscall sub_100F7930(_DWORD *this, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1002CAD0(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
...
LABEL_49:
  ...
  v55 = sub_1001EDF0((int)v52, v52[1], a3);
  sub_1001DE70(v3 + 1, 1u);
  v52[1] = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
