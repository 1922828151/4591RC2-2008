/*
 * func-name: sub_100D1230
 * func-address: 0x100d1230
 * callers: 0x100d2420
 * callees: 0x10051fd0, 0x10052210, 0x1006bd90, 0x1006c080, 0x100d0040, 0x100fe6a0, 0x100fec20, 0x101466d0, 0x101a2500, 0x101a2522
 */

int __thiscall sub_100D1230(int this, int a2, char *a3, unsigned int a4, _DWORD *a5)
{
  int v5; // edx
  int result; // eax
  int v8; // ecx
