/*
 * func-name: sub_101116A0
 * func-address: 0x101116a0
 * callers: 0x101120d0
 * callees: 0x1001cb40, 0x100906b0, 0x10095080, 0x1010e7f0, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_101116A0(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
