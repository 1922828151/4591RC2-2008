/*
 * func-name: ?GetBiasFogColor@SkyController@@QAEXAAVVector@@@Z
 * func-address: 0x1012d070
 * callers: 0x1012d370
 * callees: 0x10056fb0
 */

void __thiscall SkyController::GetBiasFogColor(SkyController *this, struct Vector *a2)
{
  float v2; // eax
  char *v3; // esi
  float *v4; // ecx
