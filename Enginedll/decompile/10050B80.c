/*
 * func-name: ??0Actor@@QAE@PAVWorld@@@Z
 * func-address: 0x10050b80
 * callers: 0x10038ca0, 0x10045740, 0x10051b50, 0x100544f0, 0x1009b1f0, 0x100b41c0, 0x100da530, 0x100de9e0, 0x100df590, 0x1012ffd0, 0x1016e600
 * callees: 0x10001440, 0x10011140, 0x1004f700, 0x101786e0, 0x101a251c
 */

Actor *__thiscall Actor::Actor(Actor *this, struct World *a2)
{
  float *v3; // edi

  *((float *)this + 2) = 0.0;
  v3 = (float *)((char *)this + 8);
  *((float *)this + 3) = 0.0;
  *((float *)this + 4) = 0.0;
  *((float *)this + 6) = 0.0;
  *((float *)this + 7) = 0.0;
  ...
  *((float *)this + 251) = 1.0;
  ...
  Actor::Initialize((GUID *)this, a2, 0);
  return this;
}
