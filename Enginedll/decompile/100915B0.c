/*
 * func-name: sub_100915B0
 * func-address: 0x100915b0
 * callers: 0x1008b740
 * callees: 0x1003b570, 0x1003b730, 0x1008fe90, 0x1008ff30, 0x100912b0
 */

int __thiscall sub_100915B0(_DWORD *this, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_100912B0(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
...
LABEL_49:
  ...
  v55 = sub_1008FF30(v52, *(CREControl **)(v52 + 4), a3);
  sub_1008FE90(v3 + 1, 1u);
  *(_DWORD *)(v52 + 4) = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
