/*
 * func-name: ?_Xlen@?$vector@VBBox@@V?$allocator@VBBox@@@std@@@std@@KAXXZ
 * func-address: 0x10019d00
 * callers: 0x1001d0e0, 0x10021590, 0x100250d0, 0x10025310, 0x10025440
 * callees: 0x101a2522
 */

void __noreturn std::vector<BBox>::_Xlen()
{
