/*
 * func-name: sub_10062270
 * func-address: 0x10062270
 * callers: 0x10062640
 * callees: 0x1001b350, 0x1001e620, 0x1003e2d0, 0x1003e3d0, 0x10060fe0, 0x100f5d90, 0x100f5f30, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_10062270(int this, int a2, char *a3, unsigned int a4, _DWORD *a5)
{
  int v5; // edx
  int v7; // ecx
  int v8; // edx
