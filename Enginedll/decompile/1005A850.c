/*
 * func-name: sub_1005A850
 * func-address: 0x1005a850
 * callers: 0x1005b4c0
 * callees: 0x10057590, 0x10057780, 0x10057a50, 0x10058580, 0x10059a50, 0x10059ad0, 0x1006cf70, 0x1006e0b0, 0x101a2522
 */

_DWORD *__thiscall sub_1005A850(
        _DWORD *this,
        int a2,
        _DWORD *a3,
        unsigned int a4,
        ...
        int a11)
{
  ...
  if ( v95 >= v93 )
  {
    ...
    if ( v93 >= v16 )
    {
      ...
      *v77 = 0;
      ...
      v83 = v91;
      v91 = v81;
      sub_1006E0B0(&v88, 0, this, a4, 0, this, v83, v84, v85, v86);
      v86 = (_DWORD *)a4;
      v91 = (int *)&v84;
      v83 = (int *)a10;
      a4 = (unsigned int)v82;
      a10 = (int)v81;
      return sub_10058580(&a5, 0, v15, (unsigned int)a7, 0, a9, (int)v83, 0, this, (unsigned int)v86);
    }
    else
    {
      if ( !v15 )
      ...
      for ( i = (unsigned int)v54; ; ++i )
      {
        ...
        if ( v58 <= v57 )
          v57 -= v58;
        sub_10059AD0((int)this, (_DWORD *)(*(_DWORD *)(v15[1] + 4 * v57) + 4 * a4));
        if ( i >= v15[4] + v15[3] )
          invalid_parameter_noinfo();
      }
      v59 = 0;
      ...
      while ( v59 < v93 )
      {
        ...
        if ( v64 <= v63 )
          v63 -= v64;
        sub_10059AD0((int)this, (_DWORD *)(*(_DWORD *)(this[1] + 4 * v63) + 4 * a10));
        ++a4;
        v15 = a6;
        v59 = a4;
      }
  ...
  else
  {
    ...
    if ( v95 >= v16 )
    {
      ...
      *(_DWORD *)(v47 + 4) = this;
      *(_DWORD *)(v47 + 8) = v45;
      sub_10058580(&a2, v81[0], (_DWORD *)v81[1], v81[2], v82[0], v82[1], (int)v83, (int)v84, v85, (unsigned int)v86);
      v48 = this[3];
      v49 = v48 + this[4];
      a4 = v48;
      if ( v48 > v49 )
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        if ( v24 <= v22 )
          v22 -= v24;
        sub_10059A50((int)this, (_DWORD *)(*(_DWORD *)(v15[1] + 4 * v22) + 4 * a4));
        v16 = v94;
      }
      a4 = v95;
      while ( 1 )
      {
        ...
        if ( v30 <= v29 )
          v29 -= v30;
        sub_10059A50((int)this, (_DWORD *)(*(_DWORD *)(this[1] + 4 * v29) + 4 * v95));
        --a4;
        v15 = a6;
        v16 = v94;
      }
