/*
 * func-name: sub_100D0E20
 * func-address: 0x100d0e20
 * callers: 0x100d1fe0
 * callees: 0x1003b6b0, 0x1006be80, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_100D0E20(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
