/*
 * func-name: sub_10032060
 * func-address: 0x10032060
 * callers: 0x10032340, 0x10033210
 * callees: 0x1001cf30, 0x1001ea80, 0x1001eca0, 0x1002cd90, 0x100317f0, 0x100318d0, 0x101a2522
 */

unsigned int __thiscall sub_10032060(_DWORD *this, int a2)
{
  int v2; // esi
  int v4; // ecx
  unsigned int v5; // edx
  ...
  if ( v4 )
    ...
    v7 = 0;
  v27 = this + 4;
  sub_1002CD90(this + 4, v7, (int)(this + 1), v5);
  this[8] = *(_DWORD *)(a2 + 32);
  this[9] = *(_DWORD *)(a2 + 36);
  sub_100317F0(this + 1);
  v23 = *(_DWORD **)(a2 + 8);
  ...
  v21 = this[2];
  v30 = 0;
  sub_100318D0((_DWORD *)v6, v6, v21, a2 + 4, v22, a2 + 4, v23, a2);
  *(_BYTE *)v28 = *(_BYTE *)a2;
  v8 = **(_DWORD ***)(a2 + 8);
  v9 = 0;
  v25 = **(_DWORD ***)(v6 + 4);
