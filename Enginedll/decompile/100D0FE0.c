/*
 * func-name: sub_100D0FE0
 * func-address: 0x100d0fe0
 * callers: 0x100d2070
 * callees: 0x1001cb40, 0x1006bf00, 0x100906b0, 0x10095080, 0x1010f430, 0x10135a50, 0x10135a90, 0x101a2500, 0x101a2522
 */

_DWORD *__thiscall sub_100D0FE0(_DWORD *this, int a2, char *a3, unsigned int a4, int *a5)
{
  int v5; // edx
  int v7; // ecx
  _DWORD *result; // eax
  ...
  if ( a4 )
  {
    ...
    if ( v9 >= a4 + v11 )
    {
      ...
      if ( (v20 - a3) >> 3 >= a4 )
      {
        ...
        return (_DWORD *)sub_1010F430(a3, &a3[v28], v25);
      }
      else
      {
