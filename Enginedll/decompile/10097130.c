/*
 * func-name: sub_10097130
 * func-address: 0x10097130
 * callers: none
 * callees: 0x10013a60
 */

char *__thiscall sub_10097130(char *this)
{
  ...
  v10 = 0;
  v12 = &v3;
  std::string::string(&v3, "SkyController");
  Factory::Factory(this, v3, v4, v5, v6, v7, v8, v9, v10, v11);
  *(_DWORD *)this = &TypedFactory<SkyController>::`vftable';
  return this;
}
