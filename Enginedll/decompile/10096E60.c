/*
 * func-name: ?LoadGameTexts@Engine@@IAEXV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
 * func-address: 0x10096e60
 * callers: 0x10097ea0
 * callees: 0x10001720, 0x100017b0, 0x100493a0, 0x1004a5a0, 0x1004ae30, 0x1009ad30, 0x100e2550
 */

int __thiscall Engine::LoadGameTexts(void *this, char a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  const char *v9; // eax
  ...
  if ( XMLSystem::Load((int)v26, v17, v18, v19, v20, v21, v22, v23) )
  {
          ...
          i = (*(int (__thiscall **)(struct xercesc_2_5::DOMTreeWalker *))(*(_DWORD *)Walker + 40))(Walker) )
    {
      if ( (*(unsigned __int16 (__thiscall **)(int))(*(_DWORD *)i + 12))(i) == 1 )
      {
        ...
        LOBYTE(v28) = 2;
        sub_1009AD30((int)this + 32, StringW);
        LOBYTE(v28) = 1;
        std::wstring::~wstring(v25);
      }
    }
    v15 = (const char *)std::string::c_str(&a2);
    LogPrintf("LanguageFile: \"%s\"", v15);
    LOBYTE(v28) = 3;
  ...
  else
  {
    ...
    LogPrintf("WARNING: Unable to load LanguageFile \"%s\"", v9);
    LOBYTE(v28) = 0;
    XMLSystem::~XMLSystem((XMLSystem *)v26);
  }
  v28 = -1;
