 ...
 * callers: 0x100163e0, 0x1004ae30, 0x1004b190, 0x1004b530, 0x1004c120, 0x10099ce0, 0x100e2470, 0x10131f30, 0x1017cbd0, 0x1017cd90, 0x1017d440, 0x1017d530, 0x1017d680
 * callees: 0x100160c0, 0x10016170
 */

int __cdecl sub_100161F0(int a1, int a2)
{
  int v2; // edi
  int v3; // ebx
  std::ios_base *v4; // ecx
