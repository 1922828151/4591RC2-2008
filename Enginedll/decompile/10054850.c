/*
 * func-name: sub_10054850
 * func-address: 0x10054850
 * callers: 0x10054a10
 * callees: 0x1003b6b0, 0x10054770, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_10054850(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
