/*
 * func-name: ?_Xlen@?$vector@PAVModel@@V?$allocator@PAVModel@@@std@@@std@@KAXXZ
 * func-address: 0x10019720
 * callers: 0x1001ce30, 0x100210c0, 0x10021160, 0x100249d0, 0x10024a40
 * callees: 0x101a2522
 */

void __noreturn std::vector<Model *>::_Xlen()
{
