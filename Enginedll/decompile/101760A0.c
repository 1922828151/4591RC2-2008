/*
 * func-name: sub_101760A0
 * func-address: 0x101760a0
 * callers: 0x10172570, 0x10174d80, 0x10175180, 0x10175470
 * callees: 0x1001e0f0, 0x10020d90, 0x1002cce0
 */

int __thiscall sub_101760A0(_DWORD *this, int a2, _DWORD *a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // eax
  int v5; // edx
  ...
  _DWORD *v62; // [esp+18h] [ebp-20h]
  _DWORD *v63; // [esp+1Ch] [ebp-1Ch]
  _DWORD *v64; // [esp+20h] [ebp-18h]
  _DWORD *v65; // [esp+24h] [ebp-14h]
  int v66; // [esp+24h] [ebp-14h]
  _DWORD *v67; // [esp+2Ch] [ebp-Ch]
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_1002CCE0(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v60 = v12;
    ...
    v13 = v6[1];
    v62 = *(_DWORD **)(v13 + 8 * v12);
    v63 = *(_DWORD **)(v13 + 8 * v12 + 4);
    while ( 1 )
    {
      v14 = v6[1];
...
LABEL_49:
  ...
  v52 = sub_10020D90((int)v49, v49[1], a3);
  sub_1001E0F0(v3 + 1, 1u);
  v49[1] = v52;
  *(_DWORD *)v52[1] = v52;
  if ( !v48 )
    invalid_parameter_noinfo();
