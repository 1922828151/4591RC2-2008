/*
 * func-name: sub_10097160
 * func-address: 0x10097160
 * callers: none
 * callees: 0x10013a60
 */

char *__thiscall sub_10097160(char *this)
{
  ...
  v10 = 1;
  v12 = &v3;
  std::string::string(&v3, "IndoorVolume");
  Factory::Factory(this, v3, v4, v5, v6, v7, v8, v9, v10, v11);
  *(_DWORD *)this = &TypedFactory<IndoorVolume>::`vftable';
  return this;
}
