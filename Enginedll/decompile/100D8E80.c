/*
 * func-name: sub_100D8E80
 * func-address: 0x100d8e80
 * callers: 0x100d9350
 * callees: 0x10009c50, 0x100d8ab0, 0x1016caf0, 0x101a2522
 */

_DWORD *__thiscall sub_100D8E80(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, int a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_100D8AB0(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
