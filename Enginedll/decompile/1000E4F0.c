/*
 * func-name: sub_1000E4F0
 * func-address: 0x1000e4f0
 * callers: 0x10010180
 * callees: 0x1000bc90, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_1000E4F0(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1000BC90((_DWORD *)this, v14) )
