/*
 * func-name: sub_10115190
 * func-address: 0x10115190
 * callers: 0x1010bad0
 * callees: 0x1010fd40, 0x10113450
 */

int __thiscall sub_10115190(_DWORD *this, int a2)
{
  _DWORD *v3; // edi
  int v4; // ebx
  _DWORD *v5; // eax
  ...
  if ( v8 == v10 )
  {
    ...
    v12 = 0;
    v13 = 0;
    v5 = (_DWORD *)sub_10113450(this, (int)v9, (int)v11);
    v3 = (_DWORD *)*v5;
    v4 = v5[1];
    v13 = -1;
