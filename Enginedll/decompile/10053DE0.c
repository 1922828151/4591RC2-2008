/*
 * func-name: sub_10053DE0
 * func-address: 0x10053de0
 * callers: 0x10054100
 * callees: 0x10051d40, 0x100520f0, 0x10052e90, 0x10053210, 0x10053240, 0x10053490, 0x100535f0, 0x10053b70, 0x101a2500
 */

int __thiscall sub_10053DE0(int this, int a2)
{
  int v3; // eax
  unsigned int v4; // ecx
  int v6; // ebx
  ...
  if ( v4 > v7 )
  {
    ...
    if ( v4 <= v10 )
    {
      ...
      *(_DWORD *)(this + 8) = sub_10053490(v11, *(_DWORD **)(a2 + 8), *(_DWORD **)(this + 8));
      return this;
    }
    if ( v6 )
    {
    ...
    if ( sub_100520F0((_DWORD *)this, v12) )
      *(_DWORD *)(this + 8) = sub_10053490(*(_DWORD **)(a2 + 4), *(_DWORD **)(a2 + 8), *(_DWORD **)(this + 4));
    return this;
  }
