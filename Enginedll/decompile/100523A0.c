/*
 * func-name: sub_100523A0
 * func-address: 0x100523a0
 * callers: 0x10053d20
 * callees: 0x10051ef0, 0x10051fd0, 0x10052210, 0x1010fea0, 0x101a2522
 */

_DWORD *__thiscall sub_100523A0(_DWORD *this, int a2)
{
  int v2; // eax
  unsigned int v4; // esi
  char *v5; // eax
