/*
 * func-name: sub_100D36C0
 * func-address: 0x100d36c0
 * callers: 0x100c6ff0, 0x100c7520, 0x100c7850, 0x100c87e0, 0x100cb5e0, 0x100cbba0, 0x100ccaf0, 0x10156da0
 * callees: 0x100116a0, 0x100ce470, 0x100d03f0
 */

int __thiscall sub_100D36C0(
        _DWORD *this,
        int a2,
        void *a3,
        char a4,
