/*
 * func-name: sub_1006F570
 * func-address: 0x1006f570
 * callers: 0x100758f0
 * callees: 0x100521e0, 0x10052490, 0x1006bd90, 0x1006ca30, 0x1006cd30, 0x101466d0, 0x101a2500
 */

_DWORD *__thiscall sub_1006F570(_DWORD *this, int a2)
{
  char *v4; // ebp
  unsigned int v5; // ecx
  int v7; // edi
