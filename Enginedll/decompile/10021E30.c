/*
 * func-name: sub_10021E30
 * func-address: 0x10021e30
 * callers: 0x1002d2e0, 0x100306d0, 0x1005d900, 0x100efe90, 0x100f04f0, 0x10139890
 * callees: 0x1001d530, 0x1003b6b0, 0x10057ee0, 0x10108bc0, 0x101a2500
 */

int __thiscall sub_10021E30(int this, int a2)
{
  char *v3; // ebx
  unsigned int v4; // edx
  int v6; // eax
  ...
  if ( v4 > v10 )
  {
    ...
    if ( v13 )
      ...
      v14 = 0;
    if ( sub_1001D530((_DWORD *)this, v14) )
