/*
 * func-name: sub_1011F350
 * func-address: 0x1011f350
 * callers: 0x1011f640
 * callees: 0x1003b6b0, 0x100dd410, 0x1011f220, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_1011F350(int this, int a2, char *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
