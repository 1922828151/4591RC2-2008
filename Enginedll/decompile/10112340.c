/*
 * func-name: sub_10112340
 * func-address: 0x10112340
 * callers: 0x10114f50
 * callees: 0x1003b570, 0x1003b730, 0x1010ef90, 0x1010f5f0, 0x10111cb0
 */

int __thiscall sub_10112340(_DWORD *this, int a2, int a3)
{
  _DWORD *v3; // edi
  unsigned int v4; // edx
  int v5; // ecx
  ...
  if ( v4 <= this[3] >> 2 )
  {
    ...
    else
    {
      ...
      v9 = 2 * v8 - 3;
      v3[8] = v9;
      sub_10111CB0(v3 + 4, v9 + 2, (int)(v3 + 1), v3[2]);
    }
    v11 = v3[5];
    v12 = v3[9] - (v3[8] >> 1) - 1;
    v63 = v12;
...
LABEL_49:
  ...
  v55 = sub_1010F5F0((int)v52, v52[1], a3);
  sub_1010EF90(v3 + 1, 1u);
  v52[1] = v55;
  *(_DWORD *)v55[1] = v55;
  if ( !v51 )
    invalid_parameter_noinfo();
