/*
 * func-name: sub_1013F610
 * func-address: 0x1013f610
 * callers: 0x1013db50
 * callees: 0x100a1d10, 0x10117b00
 */

unsigned int __thiscall sub_1013F610(_DWORD *this, unsigned int a2, int a3)
{
  unsigned int v4; // ecx
  ...
  else
  {
    ...
    if ( v4 > (unsigned int)v7 )
      invalid_parameter_noinfo();
    return (unsigned int)sub_10117B00((int)this, (int)this, v7, a2 - v6, &a3);
  }
  return result;
}
