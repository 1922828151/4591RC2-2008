/*
 * func-name: sub_10131B30
 * func-address: 0x10131b30
 * callers: 0x101320b0, 0x101322b0
 * callees: 0x10056f00, 0x10056f50, 0x10057650, 0x101a2522
 */

_DWORD *__thiscall sub_10131B30(_DWORD *this, _DWORD *a2, char a3, _DWORD *a4, _DWORD *a5)
{
  _DWORD *v6; // ebp
  _DWORD *v7; // eax
  _DWORD *v8; // eax
  ...
  v6 = sub_10057650(this[1], (int)a4, this[1], a5, 0);
  v7 = (_DWORD *)this[1];
  ++this[2];
  if ( a4 == v7 )
  {
  ...
  v10 = v6 + 1;
  for ( i = (int)v6; !*(_BYTE *)(*(_DWORD *)(i + 4) + 52); v10 = (int *)(i + 4) )
  {
    v12 = *v10;
    v13 = *(int **)(*v10 + 4);
    if ( *v10 == *v13 )
    {
      ...
      if ( *(_BYTE *)(v14 + 52) )
      {
        ...
        {
          i = *v10;
          sub_10056F00(this, *v10);
        }
        *(_BYTE *)(*(_DWORD *)(i + 4) + 52) = 1;
        *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(i + 4) + 4) + 52) = 0;
        sub_10056F50(this, *(_DWORD **)(*(_DWORD *)(i + 4) + 4));
      }
      else
      {
        *(_BYTE *)(v12 + 52) = 1;
        *(_BYTE *)(v14 + 52) = 1;
        *(_BYTE *)(*(_DWORD *)(*v10 + 4) + 52) = 0;
        i = *(_DWORD *)(*v10 + 4);
      }
    }
    else
