/*
 * func-name: sub_100D3E00
 * func-address: 0x100d3e00
 * callers: 0x100d4e50
 * callees: 0x100cdeb0, 0x100cecd0, 0x100cf720, 0x100d1b10, 0x100d26a0, 0x100d3570, 0x101a2500
 */

int __thiscall sub_100D3E00(int this, int a2)
{
  char *v4; // ebp
  unsigned int v5; // ecx
  _DWORD *v7; // edi
  ...
  if ( v5 > v8 )
  {
    ...
    if ( v5 <= v12 )
    {
      ...
      *(_DWORD *)(this + 8) = sub_100D1B10(v14, *(_DWORD **)(a2 + 8), *(_DWORD **)(this + 8));
      return this;
    }
    if ( v7 )
    {
    ...
    if ( sub_100CECD0((_DWORD *)this, v13) )
      *(_DWORD *)(this + 8) = sub_100D1B10(*(_DWORD **)(a2 + 4), *(_DWORD **)(a2 + 8), *(_DWORD **)(this + 4));
    return this;
  }
