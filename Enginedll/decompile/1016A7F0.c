/*
 * func-name: sub_1016A7F0
 * func-address: 0x1016a7f0
 * callers: 0x1016b010, 0x1016b0d0
 * callees: 0x1003b6b0, 0x10056c80, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_1016A7F0(int this, int a2, _DWORD *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
