/*
 * func-name: ?Project@Editor@@QAE?AVVector@@V2@@Z
 * func-address: 0x1007f480
 * callers: none
 * callees: 0x101189f0, 0x101780c2
 */

float *__thiscall Editor::Project(int this, float *a2, char a3, int a4, int a5)
{
  ...
  *a2 = 0.0;
  a2[1] = 0.0;
  a2[2] = 0.0;
  D3DXVec3Project(a2, &a3, v8, v10, v9, v7);
  return a2;
}
