/*
 * func-name: sub_1016A9B0
 * func-address: 0x1016a9b0
 * callers: 0x1016b220, 0x1016b2e0
 * callees: 0x1003b6b0, 0x10056d00, 0x100dd410, 0x1012b5e0, 0x10135a20, 0x1016a4e0, 0x101a2500
 */

int *__thiscall sub_1016A9B0(int this, int a2, _DWORD *Source, unsigned int a4, int *a5)
{
  int *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
    ...
    if ( v8 >= a4 + v11 )
    {
      ...
      if ( (v21 - (char *)Source) >> 2 >= a4 )
      {
        ...
        *(_DWORD *)(this + 8) = sub_1003B6B0(&v21[-v22], (int)v21, v21);
        ...
        return sub_1016A4E0(Source, &Source[v24 / 4u], &a5);
      }
      else
      {
        sub_1003B6B0(Source, (int)v21, &Source[v22 / 4u]);
        std::vector<Model *>::_Ufill(*(_DWORD **)(this + 8), a4 - ((*(_DWORD *)(this + 8) - (int)Source) >> 2), &a5);
        *(_DWORD *)(this + 8) += v24;
        return sub_1016A4E0(Source, (_DWORD *)(*(_DWORD *)(this + 8) - v24), &a5);
      }
    }
    else
    {
      ...
      v16 = (_DWORD *)sub_1003B6B0(*(void **)(this + 4), (int)Source, v15);
      v17 = std::vector<Model *>::_Ufill(v16, a4, &a5);
