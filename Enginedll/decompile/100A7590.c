/*
 * func-name: ?setGridPic@CREListCtrl@@QAEXABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUtagRECT@@@Z
 * func-address: 0x100a7590
 * callers: none
 * callees: 0x100a5d90, 0x1017a280, 0x101a2500, 0x101a2534
 */

void __thiscall CREListCtrl::setGridPic(int this, int a2, _DWORD *a3)
{
  _BYTE *v4; // eax
  int v5; // eax
  bool v6; // cf
  ...
  int v8; // edi
  int v9; // esi
  _BYTE v10[28]; // [esp+4h] [ebp-28h] BYREF
