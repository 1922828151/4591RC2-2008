/*
 * func-name: ?TruncateCompString@CMLIMEEditBox@@IAEX_NH@Z
 * func-address: 0x100a8050
 * callers: 0x100ca110
 * callees: 0x100971c0
 */

void __thiscall CMLIMEEditBox::TruncateCompString(CMLIMEEditBox *this, bool a2, int a3)
{
  signed int v4; // edi
  int i; // ebx
  ...
  {
    v4 = wcslen(CMLIMEEditBox::s_CompString);
    for ( i = 0; i < v4 - CMLIMEEditBox::s_nCompCaret; ++i )
    {
      v6 = Engine::Instance();
